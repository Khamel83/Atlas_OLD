...
def load_categories():
    ...
    return [
        ...
        "education", "politics", "entertainment", "sports", "personal"
    ]
...
def _categorize_with_keywords(text: str, categories: List[str]) -> str:
    ...
    category_keywords = {
        "technology": ["tech", "software", "ai", "artificial intelligence", "computer", "programming", "code", "app", "digital", "internet", "web", "mobile", "startup", "silicon valley"],
        "business": ["business", "company", "corporate", "enterprise", "management", "strategy", "marketing", "sales", "revenue", "profit", "ceo", "startup", "entrepreneur"],
        "finance": ["finance", "money", "investment", "stock", "market", "trading", "cryptocurrency", "bitcoin", "banking", "economy", "economic", "financial", "portfolio"],
        "health": ["health", "medical", "doctor", "medicine", "hospital", "treatment", "wellness", "fitness", "nutrition", "mental health", "healthcare", "disease"],
        "science": ["science", "research", "study", "scientific", "discovery", "experiment", "physics", "chemistry", "biology", "climate", "environment"],
        "education": ["education", "learning", "school", "university", "college", "student", "teacher", "academic", "course", "study", "knowledge"],
        "politics": ["politics", "political", "government", "policy", "election", "vote", "democracy", "law", "legislation", "congress", "senate"],
        "entertainment": ["entertainment", "movie", "film", "music", "celebrity", "hollywood", "tv", "show", "game", "gaming", "culture", "art"],
        "sports": ["sports", "football", "basketball", "baseball", "soccer", "athletic", "team", "player", "game", "championship", "olympics"],
        "personal": ["personal", "life", "family", "relationship", "home", "lifestyle", "diary", "journal", "memoir"]
    }
...
def main(rerun_all=False, fix_missing=False, check=False, diff=False):
    """Main CLI function"""
    if not FRONTMATTER_AVAILABLE:
        print("Error: frontmatter library required. Install with: pip install python-frontmatter")
        return
