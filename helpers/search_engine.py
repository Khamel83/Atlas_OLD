...
class SearchConfig:
    ...
    DEFAULT_SETTINGS = {
        ...
        "sortableAttributes": ["created_at", "updated_at", "title", "relevance_score", "publish_date", "duration"],
        "rankingRules": [
            "words",
            "typo",
            "proximity",
...
class AtlasSearchEngine:
    ...
    def _prepare_document_for_search(self, metadata: Dict) -> Optional[Dict]:
        ...
        if content_type_str == "youtube":
            ...
            search_doc["podcast_name"] = type_specific.get("podcast_name", metadata.get("podcast_title", ""))
            search_doc["podcast_slug"] = type_specific.get("podcast_slug", "")
            search_doc["episode_title"] = type_specific.get("episode_title", metadata.get("title", ""))
            search_doc["duration"] = type_specific.get("duration", metadata.get("duration", ""))
            search_doc["publish_date"] = type_specific.get("publish_date", metadata.get("publish_date", ""))
