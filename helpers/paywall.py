...
class PaywallDetector:
    ...
    def detect(self, html: str, url: str) -> bool:
        ...
        paywall_domains = [
            ...
            'economist.com', 'washingtonpost.com', 'medium.com',
            'theathletic.com', 'stratechery.com'
        ]
        ...
        truncation_indicators = [
            '...', '(continued)', 'read more', 'full article',
            'complete story', 'entire article'
        ]
...
class PaywallBypass:
    ...
    def _extract_main_content(self, html: str) -> str:
        ...
        try:
            ...
            paywall_selectors = [
                ...
                '.premium-content', '.modal', '.overlay',
                '.subscription-required', '.register-wall'
            ]
    ...
    def _simple_paywall_strip(self, html: str) -> str:
        ...
        skip_patterns = [
            'subscribe', 'premium', 'paywall', 'sign up',
            'register', 'membership', 'subscription'
        ]
