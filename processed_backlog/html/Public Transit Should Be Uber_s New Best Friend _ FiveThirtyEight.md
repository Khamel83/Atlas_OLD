...
**Source:** inputs/New Docs/html/fivethirtyeight.com_features_public-transit-should-be-ubers-new-best-friend.html
**Processed:** 2025-08-24T19:13:41.512099

![](https://fivethirtyeight.com/wp-content/uploads/2015/08/uber0827featured-1.jpg?w=575)



An aerial view of New York City, on Jan. 29, 2014.
...
If Uber is worth its [$50 billion valuation](http://www.wsj.com/articles/uber-valued-at-more-than-50-billion-1438367457), it [will have to do more than](https://fivethirtyeight.com/features/uber-isnt-worth-17-billion/) win over the market historically occupied by the taxi and limo industry —it will have to identify [new types of customers](http://abovethecrowd.com/2014/07/11/how-to-miss-by-a-mile-an-alternative-look-at-ubers-potential-market-size/).

The biggest potential market is among people who own their own cars: The average American household [spends around $8,500 on personal vehicles per year](http://www.bls.gov/cex/22014/midyear/decile.pdf); multiply that by 125 million households, and you have a market worth in excess of $1 trillion per year. Persuading even a small fraction of households to give up their cars for Uber could be very lucrative for the company.

But if Uber is to achieve its [goal](http://www.businessinsider.com/ubers-plans-to-be-cheaper-than-owning-a-car-2015-2) of becoming cost-competitive with car ownership, it may have an unlikely ally: public transit. A combination of (mostly) public transit along with some Uber rides can be affordable for a wider range of customers than Uber alone.

New York City is the [biggest market for public transit in the country](https://fivethirtyeight.com/features/how-your-citys-public-transit-stacks-up/) — in fact, about 40 percent of all public transit trips in the United States occur in the New York metro area. And as it happens, we have some very good data on how New Yorkers are using Uber, public transit and other services. Earlier this month, we [published an analysis](https://fivethirtyeight.com/features/uber-is-serving-new-yorks-outer-boroughs-more-than-taxis-are/) based on about 93 million Uber and taxi trips in New York from April to September 2014, including information about Uber trips that we obtained via a Freedom of Information Law request. That analysis focused mostly on the differences between Uber and taxi coverage: As compared with taxis, for instance, Uber use is proportionally higher in Brooklyn.
...
![uber-feature-demobreakdown-map-1](https://fivethirtyeight.com/wp-content/uploads/2015/08/uber-feature-demobreakdown-map-1.png)

As you can see, Uber and taxi usage have a lot in common. The [correlation coefficient](http://mathworld.wolfram.com/CorrelationCoefficient.html) between per capita Uber use and per capita taxi use3 is 0.89, not that far from a perfect correlation of 1.
...
![uber-feature-demobreakdown-borough-2](https://fivethirtyeight.com/wp-content/uploads/2015/08/uber-feature-demobreakdown-borough-2.png)
...
![uber-feature-demobreakdown-income-3](https://fivethirtyeight.com/wp-content/uploads/2015/08/uber-feature-demobreakdown-income-31.png)
...
![uber-feature-demobreakdown-schematic-5](https://fivethirtyeight.com/wp-content/uploads/2015/08/uber-feature-demobreakdown-schematic-5.png)

**Group 1 — Low income, poor public transit access:** In census tracts with no nearby subway line, 66 percent of households have access to a private vehicle.13 An exception among these neighborhoods, however, is those where incomes are below $35,000 per year: Car ownership remains low there. Given the high cost of living in New York, a $35,000 income is the [equivalent of about $20,000](https://fivethirtyeight.com/features/new-york-minimum-wage-fast-food-workers/) for an average American household, making even a clunker a stretch to afford. Families like these have no great choices.
...
The most interesting case may be for customers who can conveniently make some, but not all, trips on public transit. Consider a household that makes about 2,000 vehicle trips per year, [in line with the national average](http://nhts.ornl.gov/2009/pub/stt.pdf). (If that sounds like a lot of trips, remember the figure is per household and not per person.) It can either spend $10,000 a year on car ownership,14 or it can use a combination of public transit (at a cost of $2.50 per journey15) plus Uber and taxis.
...
![uber-feature-demobreakdown-linechart-6](https://fivethirtyeight.com/wp-content/uploads/2015/08/uber-feature-demobreakdown-linechart-6.png)
...
Uber is also introducing some cheaper services, such as its carpooling service [UberPool](http://www.slate.com/blogs/moneybox/2015/08/25/uber_smart_routes_experimental_uberpool_feature_looks_a_lot_like_a_bus.html). Suppose that the price of an Uber ride could be halved, to $10 per ride. In that case, this household could take about a third of its trips by Uber, filling in the rest with public transit, and it would still be cheaper than car ownership.

But there’s a long way to go before Uber becomes cost-competitive with car ownership *without* an assist from public transit. A car ride costs an owner in the United States $4 or $5,16 including both fixed expenses (mainly, the cost of buying the car) and marginal expenses like gasoline. Even Uber’s cheapest services like UberPool aren’t yet competitive with that price.

Analyses like [this one](https://medium.com/@kaleazy/a-financial-model-comparing-car-ownership-with-uberx-los-angeles-b7becd917095) which suggest that Uber is already often cheaper than car ownership depend, in part, on accounting for opportunity costs. You can potentially use your time more productively when someone else is driving you instead of when you’re driving yourself. But those opportunity costs vary from person to person depending on how much people value their time.
...
But there’s a much wider potential audience if Uber can also reach middle-class customers who want to save money. Perhaps in the distant (or even the not-so-distant) future, Uber can [build its own version of “public” transit](http://www.theawl.com/2015/08/ubiquity), making rides so cheap that they cost less than the $4 or $5 that Americans now pay, on average, to make a trip in their personal cars. In the meantime, it might have more success among “[car-cutting](https://twitter.com/cdixon/status/635968508820615168)” customers who can use Uber along with public transit. That might mean Uber’s growth is concentrated more in cities like New York, San Francisco and Chicago — and in Europe and Asia — that already have reasonably strong public transit networks.

*Carl Bialik, Andrew Flowers and Dhrumil Mehta contributed to this article.*

---

**Read more:** [Uber Is Serving New York’s Outer Boroughs More Than Taxis Are](https://fivethirtyeight.com/features/uber-is-serving-new-yorks-outer-boroughs-more-than-taxis-are/)