# Uber Is Taking Millions Of Manhattan Rides Away From Taxis | FiveThirtyEight

**Source:** inputs/New Docs/html/fivethirtyeight.com_features_uber-is-taking-millions-of-manhattan-rides-away-from-taxis.html
**Processed:** 2025-08-24T19:14:01.863843

![](https://fivethirtyeight.com/wp-content/uploads/2015/10/gettyimages-187783458-e1444648501580.jpg?w=575)



Uber has replaced millions of Manhattan taxi pickups, according to newly released city data.

George Rose / Getty Images



Uber isn’t adding to Manhattan’s traffic congestion, according to newly released city data.

George Rose / Getty Images

New York City Mayor Bill de Blasio took aim at Uber this summer, trying ([and failing](https://fivethirtyeight.com/features/the-debate-on-ubers-impact-is-far-from-over/)) to set a cap on the number of its for-hire cars operating in the city. The ride-share service has drawn criticism on a number of issues — including its [labor practices](http://www.reuters.com/article/2015/09/01/us-uber-tech-drivers-lawsuit-idUSKCN0R14O920150901) — but the mayor said his main concern was traffic congestion. The number of yellow and green taxis on New York’s streets is carefully controlled by the city. Would additional pickups from an uncapped Uber fleet lead to urban gridlock?

![uber-seasonalchange-1](https://fivethirtyeight.com/wp-content/uploads/2015/10/uber-seasonalchange-1.png)
...
In response to a Freedom of Information Law request we made in July, the New York City Taxi and Limousine Commission last month sent us Uber pickup data from January to June of this year. The TLC had previously sent us Uber pickup data for April 2014 to September 2014 in response to the same request. With the new data, we can now compare the April-to-June period in each year. Uber pickups in New York City rose sharply over this time span — no surprise, as the company was aggressively entering the market. Green cabs (which pick up passengers in the outer boroughs and in northern Manhattan) saw an uptick, while yellow cab pickups declined, according to ride data [the TLC publishes online](http://www.nyc.gov/html/tlc/html/about/trip_record_data.shtml). All in all, total pickups for these three services (we don’t have data on location of pickups for other black-car companies for the 2015 period) increased from 48 million to 51 million.1

Three million additional pickups sounds like a substantial increase, but the big question — as The Economist [pointed out in August](http://www.economist.com/news/united-states/21661016-does-uber-substitute-cabs-or-attract-new-riders-it-depends-where-you-live-tale?frsc=dg%7Cc) — is where those trips are coming from. It would be a problem if those new trips were originating in central and lower Manhattan, the region’s congested core. That’s where de Blasio [focused his concerns about new traffic](http://www.nytimes.com/2015/07/17/nyregion/city-hall-and-uber-clash-in-struggle-over-new-york-streets.html), and it’s the area that Uber was most aggressively [targeting](http://gothamist.com/2015/07/22/uber_fight_day_5782.php) with driver incentives. On the other hand, new pickups would be less of a problem in the other boroughs and in northern Manhattan, where the city has tried to increase cab availability through [the green Boro taxi program](http://www.nyc.gov/html/tlc/html/passenger/shl_passenger.shtml). It would be harder for de Blasio to push back against Uber if it were primarily adding pickups in these areas.
...
![reubenfb-bialik-ubermap-mobile](https://fivethirtyeight.com/wp-content/uploads/2015/10/uber-seasonalchange-2-mobile.png)

![reubenfb-bialik-ubermap](https://fivethirtyeight.com/wp-content/uploads/2015/10/uber-seasonalchange-22.png?w=1024)
...
It’s worth noting that net pickups and “congestion” don’t precisely correspond to each other, as we don’t have data on dropoffs, on ride length, or on location of pickups by other services like Lyft, an Uber competitor, and established black-car companies. It’s also possible that many more empty cabs are cruising Manhattan streets than last year, although it would not be financially viable for drivers — who primarily [rent their cabs](http://www.nytimes.com/2012/05/23/nyregion/new-york-taxi-drivers-unsure-they-will-see-benefits-of-a-fare-hike.html) — to keep this up for very long.5
...
Manhattan sees an enormous volume of pickups, so Uber’s 4 million additional trips only increased its share of rides in the borough from 4 percent to 13 percent. Uber’s market share, which last year [was bigger outside Manhattan](https://fivethirtyeight.com/features/uber-is-serving-new-yorks-outer-boroughs-more-than-taxis-are/) than in it, has continued to grow more in outer boroughs, as Uber has been [happy to point out](http://www.capitalnewyork.com/article/city-hall/2015/07/8572061/shifting-tactics-uber-hits-city-race-issues):

|  | | UBER’S SHARE OF PICKUPS (APRIL-JUNE) | | |
| --- | --- | --- | --- | --- |
| BOROUGH | DISTRIBUTION OF UBER + TAXI PICKUPS (2015) | 2014 | 2015 | CHANGE |
| Staten Island |  | 26% | 78% | +53 |
| Brooklyn | 8 | 8 | 33 | +25 |
| Bronx | 1 | 3 | 26 | +24 |
| Queens | 9 | 3 | 18 | +14 |
...
*The Uber data received through our Freedom of Information Law request is [available on Github](https://github.com/fivethirtyeight/uber-tlc-foil-response).*

**Read more:**

[New York’s Green Cabs Stay Close To The City Center](https://fivethirtyeight.com/features/new-yorks-green-cabs-stay-close-to-the-city-center/)

[Public Transit Should Be Uber’s New Best Friend](https://fivethirtyeight.com/features/public-transit-should-be-ubers-new-best-friend/)
