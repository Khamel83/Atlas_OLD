...
**Source:** inputs/New Docs/html/flowingdata.com_2015_02_18_automated-tinder.html
**Processed:** 2025-08-24T19:13:45.318859

Because using Tinder takes up oh so much time swiping, swiping, and swiping, [Justin Long made a bot that swipes and starts conversations for him](http://crockpotveggies.com/2015/02/09/automating-tinder-with-eigenfaces.html). Step 1: Use his existing preferences to create two Eigenfaces, commonly used in face recognition, that represent a yes and a no. Step 2: Automate everything else with the Tinder API.
