...
**Source:** inputs/New Docs/html/www.bloomberg.com_graphics_2015-paul-ford-what-is-code.html
**Processed:** 2025-08-24T19:13:23.586173

[![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/letter.jpg) A message from Josh Tyrangiel](#)

Software has been around since the 1940s. Which means that people have been faking their way through meetings about software, and the code that builds it, for generations. Now that software lives in our pockets, runs our cars and homes, and dominates our waking lives, ignorance is no longer acceptable. The world belongs to people who code. Those who donât understand will be left behind.

This issue comprises a single story devoted to Â­demystifying code and the culture of the people who make it. Thereâs some technical language along with a few pretty basic mathematical concepts. There are also lots of solid jokes and lasting insights. It may take a few hours to read, but thatâs a small price to pay for adding decades to your career.
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_taupe.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/taupe.gif)
...
interesting,
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_interesting.jpg)

wonderful,
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_wonderful.jpg)

or disturbing way.
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_horrible.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/twitter-blk.png)
...
![Steve Ballmer](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/ballmer.gif)

Ballmer chants âDevelopers!â
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_rubegoldberg.jpg)
...
That’s in a language called, simply, K, famous for its brevity. [2](#fn.2)
...
![Excel](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_excel.jpg)
...
![Scratch](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_excel2.jpg)
...
thus turning your code into something that can be executed—software.
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_tree.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_tree2.jpg)
...
Instead of worrying about where the words are stored in memory and having to go character by character, programming languages let you think of things like strings, arrays, and trees. That’s what programming gives you. You may look over a programmer’s shoulder and think the code looks complex and boring, but it’s covering up repetitive boredom that’s unimaginably vast.[3](#fn.3)
...
![Magic](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_magic.jpg)
...
Algorithms don’t require computers any more than geometry does. An algorithm solves a problem, and a great algorithm gets a name. Dijkstra’s algorithm, after the famed computer scientist Edsger Dijkstra, finds the shortest path in a graph. By the way, “graph” here doesn’t mean ![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_graph1.jpg) but rather ![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_graph2.jpg)

Think of a map; streets connect to streets at intersections. It’s a graph! There are graphs all around you. Plumbing, electricity, code compilation, social networks, the Internet, all can be represented as graphs! (Now to monetizeâ…)

Many algorithms have their own pages on Wikipedia. You can spend days poking around them in wonder. [Euclid’s algorithm](https://web.archive.org/web/20150611164257/https://en.wikipedia.org/wiki/Euclidean_algorithm), for example, is the go-to specimen that shows up whenever anyone wants to wax on about algorithms, so why buck the trend? It’s a simple way of determining the greatest common divisor for two numbers. Take two numbers, like 16 and 12. Divide the first by the second. If there’s a remainder (in this case there is, 4), divide the first, 16, by that remainder, 4, which gives you 4 and no remainder, so we’re done—and 4 is the greatest common divisor. (Now translate that into machine code, and we can get out of here.)

There’s a site called Rosetta Code that shows you different algorithms in different languages. The [Euclid’s algorithm page](https://web.archive.org/web/20150611164257/http://rosettacode.org/wiki/Greatest_common_divisor) is great. Some of the examples are suspiciously long and laborious, and some are tiny nonsense poetry, like this one, in the language Forth:[4](#fn.4)
...
Read it out loud, preferably to friends. Forth is based on the concept of a stack, which is a special data structure. You make “words” that do things on the stack, building up a little language of your own. PostScript,[5](#fn.5) the language of laser printers, came after Forth but is much like it. Look at how similar the code is, give or take some squiggles:
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_edward.jpg)

Dijkstra distributed a remarkable and challenging set of 18 memos to the global computer science
community, starting in the 1960s and continuing up until his death in 2002, known as “EWDs,” many of them [handwritten](https://web.archive.org/web/20150611164257/http://www.cs.utexas.edu/~EWD/).

One thing that took me forever to understand is that computers aren’t actually “good at math.” They can be programmed to execute certain operations to certain degrees of precision, so much so that it looks like “doing math” to humans.[6](#fn.6) Dijkstra said: “Computer science is no more about computers than astronomy is about telescopes.”[7](#fn.7) A huge part of computer science is about understanding the efficiency of algorithms—how long they will take to run. Computers are fast, but they can get bogged down—for example, when trying to find the shortest path between two points on a large map. Companies such as Google, Facebook, and Twitter are built on top of fundamental computer science[8](#fn.8) and pay great attention to efficiency, because their users do things (searches, status updates, tweets) an extraordinary number of times. Thus it’s absolutely worth their time to find excellent computer scientists, many with doctorates, who know where all the efficiencies are buried.

It takes a good mathematician to be a computer scientist, but a middling one to be an effective programmer. Until you start dealing with millions of people on a network or you need to blur or sharpen a million photos quickly, you can just use the work of other people. When it gets real, break out the comp sci. When you’re doing anything a hundred trillion times, nanosecond delays add up. Systems slow down, users get cranky, money burns by the barrel.[9](#fn.9)
...
Some parts of the functional specification refer to “user stories,” tiny hypothetical narratives about people using the site, e.g., “As a visitor to the website, I want to search for products so I can quickly purchase what I want.” [10](#fn.10)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/swagbot.gif)

![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/conferencebot.gif)

![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/drinkbot.gif)

“I go to work and I stick out like a sore thumb. I have been mistaken for an administrative assistant more than once. I have been asked if I was physical security (despite security wearing very distinctive uniforms),” wrote a black woman on Medium.com who has worked, among other places, at Google.
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec1_demographics.jpg)
...
Programmers track the success of computer languages the way other people track sports rankings, commenting on Web forums such as Reddit (where many languages get their own “subreddit,” and [reddit.com/r/programming](https://web.archive.org/web/20150611164257/http://www.reddit.com/r/programming) currently has 620,202 readers), or [Hacker News](https://web.archive.org/web/20150611164257/https://news.ycombinator.com/), run by the venture capital firm Y Combinator (a company named after a special kind of function that operates on other functions), or [Lambda the Ultimate](https://web.archive.org/web/20150611164257/http://lambda-the-ultimate.org/) (named after a series of papers written mostly in the 1970s about the influential programming language Scheme—the more inside-baseball the name, the nerdier the subject matter).
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_fridgebike.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_gopher.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_scratch.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_lisp.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_pullup.jpg)
...
That runs the GNU C Compiler and produces a default file called `a.out`, which I ran on the command line,[17](#fn.17) to get my squared numbers, and bully for me. If I wanted to change the code, I would run the commands, and the program would update accordingly.

This isn’t great code by any stretch.[18](#fn.18) You just need to squint a little to see that there are small, repeatable units that fit together in certain ways. There’s a function called squares. That’s the important part. You feed it a number, an integer. Then it counts from 1 to that integer and with each count it prints the square of that number. Then it prints a new line. Done.
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_octopus.jpg)

Photographer: Thomas Albdorf for Bloomberg Businessweek; Prop Stylist: AmÃ©lie Chapalain
...
![Smalltalk UI](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_smalltalk2.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/angry2.gif)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/angry4.gif)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_cult.jpg)
...
Managers and old coders have fewer options. It’s often better to just keep working and shipping, even if the code starts to look ugly, even if there are nominally better solutions, even as the technical debt[23](#fn.23) accrues around you, because in a few years everything will change. Maybe you’ll get promoted and the new manager will have the will and motive to tear up everything you did, cursing, and start again (perhaps using a new language) with the goal of making something much simpler. Or the entire industry will spasm and everything you’ve done will need to be thrown away and rebuilt along new lines anyway. (From desktop to Web, from Web to mobile, from mobile toâ…âquantum? Who knows. But there’s always something.)
...
“PHP,” he says, “well—it is what it is. The team had a good time at PHP[world]. But I think the thing we might have learnedâ…”
...
“…âis that we really need to move off of PHP.”
...
“Ay, there’s the rub,” he says, and you have to remind yourself to not show him your real face right now. If he quotes *Hamlet* again, thoughâ…
...
[28](#fn.28)
The Lisp machine companies began to shut down and sell off their assets. Students were more likely to learn C or Java. Lisp became a cautionary tale, its unique, unified vision of the computer a fond memory of a better era. And yetâ…
...
Enter the remaining two programmers. Programmer A, who is senior, takes her place at the whiteboard.â…

![Programmer A](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/chatter_Orange.gif)

**Programmer A:** “Let’s just start with e-mail validation.”

**Programmer B:** “Can you define valid?”

![Programmer B](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/chatter_Blue.gif)

![Programmer B](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/chatter_Green.gif)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec2_ribbon.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/pizza.gif)
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/pizza.gif)
...
Java was supposed to supplant C and run on smart jewelry. Now it runs application servers, hosts Lisplike languages, and is the core language of the Android operating system.[33](#fn.33)
...
But as browsers proliferated and the Web grew from a document-delivery platform into a software-delivery platform, JavaScript became, arguably, the most widely deployed language runtime [34](#fn.34) in the world. If you wrote some JavaScript code, you could run it wherever the Web was—everywhere.
...
Then, about a decade ago people began to talk about Ajax[35](#fn.35)—the idea that you could build real software into a Web page, not just a document, but a program that could do real work.
...
As with any celebrity, thereâs a whole industry dedicated to spackling up its deficiencies and making it look good. There are books about the âgood partsâ of JavaScript; there are libraries that make it easier and more consistent to program, too, such as jQuery, which can turn the many lines of code necessary to make a paragraph disappear into a single `$("p.optional").hide();`.

Back in the era of the iPod and candy-colored Macintoshes, Apple took the code of an open-source Web browser called Konqueror and modified it to create Safari, its own Web browser to compete with Microsoftâs Internet Explorer. Then in 2008 Google started to make its own modifications to the Web engine underneath Safari, called Webkit, and made its own version called Chrome with a Â­spanking-fast JavaScript engine called V8. They made JavaScript fast. âDevs still approach performance of JS code as if they are riding a horse cart,â tweeted one developer, âbut the horse had long been replaced with fusion reactor.â Google does better when JavaScript is fast.

In 2008 a developer named Ryan Dahl modified the V8 engine, which was free software, and made it run outside the browser. There had been freestanding versions of JavaScript before (including some that ran inside Java, natch), but none so fast. He called this further fork Node.js, and it just took off. One day, JavaScript ran inside Web pages. Then it broke out of its browser prison. Now it could operate anywhere. It could touch your hard drive, send e-mail, erase all your files. It was a real programming language now. And the clientâ…âhad become the server.
...
NPM stands for Node Package Manager. It’s software that helps you install packages andââ¦âwell, it’s unwieldy, honestly, because many of those 150,000 packages are just not that great. It’s a lot of searching and testing and sighing. But when you have this much stuff to pick from, for free, you shouldn’t complain.[36](#fn.36) JavaScript is a hodgepodge designed in a hurry, and it runs on, well, who knows, but let’s say a billion-plus devices, so you might as well get with the program. Your customers may not have iPhones, but they probably have some way of running JavaScript.
...
[37](#fn.37) that serves up data to a “client,” and sure, that client could be a laptop Web browser. But it’s 2015, and that client is quite probably an app on a smartphone.
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_diary.jpg)
...
One of the privileges of owning a Mac is that you can download a program by Apple called Xcode. This is an IDE, an Integrated Development Environment.[38](#fn.38)

It’s an enormous download, more than 2 gigabytes, or roughly the size of an hour of DVD-quality video. Xcode is the heart of Apple. It’s not only how the company writes software, it’s the tool for everyone who wants to write software for the Mac or iPhone.[39](#fn.39)

![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_xcode.jpg)
...
Apple is really good at all of this. It publishes interface guidelines and gives people tools for arranging app interfaces in predictable ways that end users will find familiar. It sets the flow with which to go.[40](#fn.40)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_django2.jpg)

Django Reinhardt, guitar virtuoso and namesake of the Django framework

A popular Web framework is Django, which is used for coding in Python. Instagram was bootstrapped on it. When you sit down for the first time with Django, you run the command `"startproject,"` and it makes a directory with some files and configuration inside. This is your project directory. Now you have access to libraries and services that add to and enhance the Â­standard library.
[42](#fn.42)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_addbook.jpg)
...
The opinions of a framework are strong, but not as strong as an SDK. Those are tightly bundled, often commercial, and arrive with PR trumpets blasting, especially when they’re from Apple or Microsoft. Frameworks tend to be derived from frustration and on first release are bound with tape and thrust onto the Web with a blog post. From there they survive—or not. There are Web application frameworks for every major language; [one Wikipedia listing](https://web.archive.org/web/20150611164257/https://en.wikipedia.org/wiki/Comparison_of_web_application_frameworks)[43](#fn.43) shows almost 40 different frameworks for Java alone and almost 30 for PHP.
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_semicolon.jpg)

Thomas Albdorf for Bloomberg Businessweek; Prop Stylist: AmÃ©lie Chapalain

But wait, it turns out that generator-hg-poly is actually generator-ng-poly, whichâ… Oh, man. I went and looked at that tool, and it describes itself as a—brace yourself—“Yeoman generator for modular AngularJS apps with Gulp and optional Polymer support,” which, I mean, come the hell on. But you know what? In for a pound. Let’s do this.

A search for Yeoman says it’s a scaffolding tool, which means it makes little folders for your Web apps that help you get started programming. Useful.â…

We know what Angular is; it’s a framework.â…

Gulp, its website says, will “automate and enhance your workflow.” You can intuit, using context clues, that it’s a tool that helps you build software. Somehow. You’d never know this from the salmon background on its site, and sometimes you simply get so, so tired.â…
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_helpwanted.jpg)
...
![Programmer A](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/chatter_Blue.gif)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_django3.jpg)
...
This is the experience of using version control. It’s a combination news feed and backup system. GitHub didn’t invent version control. It took a program called git,[44](#fn.44) which had been developed at first by Linus Torvalds, the chief architect of Linux, and started adding tools and services around it.
...
**Github Repositories**
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_repositories.jpg)
...
Tools such as git give programmers a common language. “Did you check that in?” they ask. “Which commit was that?” “That was going to be in 2.4, but we pushed it to 2.5.” Because each commit gets a random, unique identifier, you can pinpoint that commit in space and time and feel confident in the record of code changes in a way that you can rarely feel confident about anything.
...
“I mean, this company will do everything imaginable to slow down shipping,” TMitTB says as the CTO winces. That’s fine; you expected this to be a stressful meeting. “First, I needed to pass everything through the security team, which was five months of review,” TMitTB says, “and then it took me weeks to get a working development environment, so I had my developers sneaking out to Starbucks to check in their code.â…”
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_braids.jpg)

Joanna Mcclure for bloomberg businessweek; prop stylist: Amy Henry
...
### 7.3 Managing â¨Programmers

On the Wikipedia page for “[Software development process](https://web.archive.org/web/20150611164257/https://en.wikipedia.org/wiki/Software_development_process),” there’s a list of links to pages: “TDD BDD FDD DDD MDD”—“test-driven development,” “behavior-driven development,” “feature-driven developÂ­ment,” “domain-driven design,” and “model-driven development.” Each one has its advocates and its critics. I include these only for your amusement. If you want to go deeper on management methodologies, have at it.
...
![Hello World](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_helloworld.jpg)
...
![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/certificatedemo_800.png)
![]()

![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/sec3_paul.jpg)

Photographer: Corey Olsen for Bloomberg Businessweek

**Paul Ford** is a writer and programmer who lives in Brooklyn, N.Y. He is a founding partner of Postlight, a company in New York City that builds Internet platforms and develops interactive products. He is writing a book of essays about Web pages that Farrar, Straus and Giroux will publish in 2016. His article, â[The Surprising Sophistication of Twitter](https://web.archive.org/web/20150611164257/http://www.bloomberg.com/bw/articles/2013-11-07/the-hidden-technology-that-makes-twitter-huge),â appeared in the Nov.â¯7, 2013, issue of *Bloomberg Businessweek*. E-mail: [ford@ftrain.com](https://web.archive.org/web/20150611164257/mailto:ford@ftrain). Twitter: [@ftrain](https://web.archive.org/web/20150611164257/https://twitter.com/ftrain). GitHub: [ftrain](https://web.archive.org/web/20150611164257/https://github.com/ftrain).

![](/web/20150611164257im_/http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/images/emotes/waving.gif)
