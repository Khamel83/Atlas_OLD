# Pollsters Predict Greater Polling Error In Midterm Elections | FiveThirtyEight

**Source:** inputs/New Docs/html/fivethirtyeight.com_features_pollsters-predict-greater-polling-error-in-midterm-elections.html
**Processed:** 2025-08-24T19:14:05.904674

![](https://fivethirtyeight.com/wp-content/uploads/2014/10/was6319002.jpg?w=575)



Students at the University of California, Davis line up to vote at a polling place on Nov. 6, 2012.

Autumn Payne / Getty Images



A baby peeks out of the voting booth while his mother votes March 20, 2012, at Christian Union Church in Metamora, Illinois.

DON EMMERT / AFP via Getty Images

At FiveThirtyEight, we [write about polls regularly](https://fivethirtyeight.com/tag/2014-campaign-crib-notes/), especially ahead of big elections like next month’s. We [rate pollsters](https://fivethirtyeight.com/interactives/pollster-ratings/) for their accuracy and whether they lean Republican or Democratic. And we use their work to inform our election model and [Senate forecast](https://fivethirtyeight.com/interactives/senate-forecast/).

Now we’re polling pollsters, too.

We wanted to see what the most prolific political pollsters had to say about their work, the election, their industry and where it’s headed. We reached out to 60 of the most active political pollsters in the country, and 26 took [our survey](https://docs.google.com/forms/d/15vciUokilOUBF9JDZIQQfuZh-2i_fxkmRVIX3v2xXcc/viewform?usp=send_form).1

![table.bialik.pollofpollsters.1006](https://fivethirtyeight.com/wp-content/uploads/2014/10/table-bialik-pollofpollsters-10062.png)
...
To encourage them to speak freely, we’ve granted them the choice of making some or all of their answers anonymous. That’s why some quotes below aren’t attributed. We’ve also [posted the results on GitHub](https://github.com/fivethirtyeight/data/tree/master/poll-of-pollsters), protecting anonymity where requested there, as well.

## Republicans predicted to win the Senate by a narrow margin

While pollsters are in the business of asking voters what they think, instead of predicting how voters will act, 19 answered our question about how many seats they expect Republicans will hold in the next Senate. Two-thirds think Republicans will have a majority. Just two think they’ll have fewer than 50 seats, each predicting 49. The predicted margin is slim, though: An average of just under 51 seats for Republicans. (The most common outcome in the latest run of [our model](https://fivethirtyeight.com/interactives/senate-forecast/) — occurring in about 18 percent of simulations — is [52 Republican-held seats](https://fivethirtyeight.com/features/senate-update-lots-of-polls-but-little-change/).)

Among the reasons given for expecting a Republican victory:

* “Second midterm congressional elections typically favor the party out of power.” (Brad Coker, [Mason-Dixon Polling & Research, Inc.](http://mason-dixon.com/))
* “The President’s fairly poor job approval.” (Christopher P. Borick, [Muhlenberg College](http://www.muhlenberg.edu/main/aboutus/polling/))
* “The ‘structural’ advantage they have this year with most of the contested seats in red states.”

Then there are the pollsters who say they rely on forecasts like [ours](https://fivethirtyeight.com/interactives/senate-forecast/), [The Huffington Post’s](http://elections.huffingtonpost.com/2014/senate-outlook) and others’. And one who said, “It’s a guess, like everyone else’s.”
...
These results are consistent with what pollsters have reported for years: that [people are harder to reach by phone](http://www.people-press.org/methodology/collecting-survey-data/the-problem-of-declining-response-rates/), and are less likely to want to talk to strangers when they are reached. Here, the pollsters show just how quickly response rates have fallen in only two years.
...
The [American Association for Public Opinion Research’s website](http://www.aapor.org/) provides a [downloadable calculator](http://www.aapor.org/response_rates_an_overview1.htm), which puts out four different response rates. The strictest definition counts only respondents who answer every poll question in the numerator, and counts every household contacted in the denominator. The loosest definition includes partial responses in the numerator, and adjusts the denominator downward by [estimating](http://www.aapor.org/AM/Template.cfm?Section=Standard_Definitions1&Template=/CM/ContentDisplay.cfm&ContentID=1815) how many of the people who weren’t reached at all weren’t eligible for the poll, anyway.
...
No one cited low response rates as a reason to expect poll error. Perhaps that’s because pollsters [have managed to maintain strong national-election records](https://fivethirtyeight.com/features/is-the-polling-industry-in-stasis-or-in-crisis/) despite [declining response rates](http://www.people-press.org/2012/05/15/assessing-the-representativeness-of-public-opinion-surveys/).
...
Another pollster echoed [a lament we’ve made here](https://fivethirtyeight.com/features/somebody-poll-a-senate-race/): “There are far too few quality polls in 2014 and that is saying something, given what we saw in 2012.”

One pollster who predicted lower error this time around said lower turnout makes it easier to predict the vote of those who do show up on Election Day. Another, Gregg Durham of [We Ask America](http://weaskamerica.com/), said that pollsters have gotten better at weighting the responses of the people they interview, to better represent the views of people who don’t respond.
...
We found earlier this year that [the number of political polls is declining](https://fivethirtyeight.com/features/somebody-poll-a-senate-race/). In this poll, we asked what the biggest reason was. A few respondents disagreed with the premise of the question. Of the rest, only two named the emergence of poll-based forecasts such as ours and [The Upshot’s](http://www.nytimes.com/newsgraphics/2014/senate-model/). Six cited the rising cost of polls. But 12 said the reason was media companies’ shrinking budgets.
...
Those who attributed the decline to rising costs said reaching people on their cellphones was more expensive, because they had to dial cellphones by hand. (A 1991 anti-telemarketing law [bans automatically dialed calls](http://blog.ctia.org/2012/02/08/is-it-legal-for-political-campaigns-to-call-you-on-your-cellphone/) to cellphones.) Other pollsters reach households without landlines through the Internet, which also adds to costs. We separately asked how much more it costs to include cellphones in polls. The median response was a 25 percent increase in cost. Nonetheless, many said they now include cellphones in all their election polls.
...
Our pollster ratings and our model factor in whether polling firms are members of the [National Council on Public Polls](http://www.ncpp.org/), are participants in the [American Association for Public Opinion Research’s Transparency Initiative](http://www.aapor.org/List_of_Supporters.htm#.VCDhBitdW18), or release their raw data to the [Roper Center Archive](http://www.ropercenter.uconn.edu/data_access/data/data_providers.html). As [Nate wrote](https://fivethirtyeight.com/features/how-fivethirtyeight-calculates-pollster-ratings/), there is “reasonably persuasive evidence that methodology matters.”
...
The smaller number of firms that haven’t signed on with AAPOR’s Transparency Initiative also cited the confidentiality of client data. Several of those who have signed on were big believers, with comments like Stuart Elway’s, of [Elway Research](http://www.elwayresearch.com/): “I believe it is important to protect the integrity of the profession.”
