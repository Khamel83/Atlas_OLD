# Introducing NBA Power Ratings And Playoff Odds FiveThirtyEight » DataLab | FiveThirtyEight

**Source:** inputs/New Docs/markdown/fivethirtyeight.com_datalab_introducing-nba-power-ratings-and-playoff-odds.md
**Processed:** 2025-08-24T19:49:25.063883

# Introducing NBA Power Ratings And Playoff Odds FiveThirtyEight » DataLab | FiveThirtyEight

**URL:** http://fivethirtyeight.com/datalab/introducing-nba-power-ratings-and-playoff-odds/
**Date:** 2015-01-19 12:47:36

---

# Introducing NBA Power Ratings And Playoff Odds

Neil Paine, .Wp-Block-Co-Authors-Plus-Coauthors.Is-Layout-Flow, Class, Wp-Block-Co-Authors-Plus, Display Inline, .Wp-Block-Co-Authors-Plus-Avatar, Where Img, Height Auto Max-Width, Vertical-Align Bottom .Wp-Block-Co-Authors-Plus-Coauthors.Is-Layout-Flow .Wp-Block-Co-Authors-Plus-Avatar, Vertical-Align Middle .Wp-Block-Co-Authors-Plus-Avatar Is .Alignleft .Alignright • January 19, 2015

![Introducing NBA Power Ratings And Playoff Odds](https://fivethirtyeight.com/wp-content/uploads/2015/01/ng1_7778.jpg?w=712)

Starting this week, with the help of basketball analytics experts Jeremias Engelmann and Steve Ilardi, we’re rolling out weekly NBA power rankings fueled by ESPN’s Real Plus-Minus player ratings. These power ratings predict how well each team will perform over the coming week of games; we’ll also list each team’s projected end-of-season win total and its odds of making the playoffs.

If you want to read more about how these ratings work, scroll below the rankings.

Q: What do these ratings mean?

A: They represent each team’s projected per-100 possession performance — schedule-adjusted and relative to league average — for the coming week, taking into account the quality of players on each roster, as well as injuries and expected minute allocations.
