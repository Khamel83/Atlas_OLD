# Money Stuff: The FTC Makes Merger Arb More Fun

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 26 Sep 2023 14:26:59 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff The FTC Makes Merger Arb More Fun_Tue,_26_Sep_2023_14-26-59_-0400_(EDT)_18ad2bebaaa45e2a.eml
**Processed:** 2025-08-24T19:13:10.899925
...
Obviously the actual FTC does not sue to block every deal, but it has definitely turned the dial toward blocking more deals and making more aggressive arguments, which probably annoys some merger arbs in their day-to-day lives but in the long run makes their lives better. The  Wall Street Journal reports:
...
Of course here this is silly, it’s a nothing. The SEC mentions naked short selling in the press release, but not in its order; there is no actual allegation that Citadel Securities did any naked short selling at all, and I think it probably did not.
  [2]
...
I am not sure that that’s right? Judging by actually existing large language models, I would not be stunned if it was easier to program a robot to give confident and sage-sounding strategic advice, and remember the clients’ kids’ names, than it is to program a robot to build financial models with no tolerance for error, or perform the dark arts of league-table manipulation. But broadly speaking the junior bankers do some combination of analytical and grunt work, while the senior bankers provide the strategic vision and the personal touch, and it seems like the former would be easier to automate than the latter.
Investment banking is an odd sort of apprenticeship business in that you spend a few years doing the analytical and grunt work as training to be strategic and personal. It is not obvious that preparing pitchbooks and discounted cash flow models would be good preparation for giving clients firm handshakes and nuanced negotiating advice, but that is the way it’s done.
  [3]
 Some (large) number of good junior analysts will not make it as senior investment bankers, because they are good at spreadsheets and formatting but bad at strategy and handshakes. Some (smaller) number of bad junior analysts will wash out because they are bad at spreadsheets and formatting, but if they had scraped through they would have been amazing managing directors, with an ingratiating manner and a good grasp of what clients want. You need both qualities, in sequence, for some reason.
But if you give all the analytical and grunt work to the robot then how do you mold senior investment bankers? I don’t know. Insider’s Bianca Chan and Emmalyse Brownstein reported last week:
...
"[Artificial intelligence] could be a good thing for banking if there are some parts that are more automated because it'll get rid of some of the work that takes hours and hours for some of these junior guys to go through," said a Wall Street recruiter who specializes in placements in investment banking.
"It could be good for the hours," added the first-year analyst. …
Over at Deutsche Bank, executives like [Tamara] Bitticks are seeing the benefits firsthand. The bank has been running dozens of generative AI pilots and hiring hundreds of engineers to transform how its employees work across the firm. Some of the pilots aim to improve time-consuming and mundane tasks carried out by juniors in the corporate bank, which serves Deutsche's institutional clients, financial services firms, and investors.
...
One basic idea in environmental, social and governance investing is that you should allocate much (100%?) of your investment portfolio to companies with good ESG credentials, and less (0%?) of your portfolio to companies with bad ESG credentials. You have some reason for liking ESG — the  main ones are “I think I will make the world a better place by allocating capital to green companies and withholding capital from dirty ones,” or “I think that ESG risk factors are important for long-run financial returns, so companies with good ESG credentials will outperform those with bad ESG credentials”
  [4]
 — and that reason counsels you to put more money in good ESG stocks and less (or zero) money in bad ESG stocks.
But zero is a pretty arbitrary cutoff. If it is good to put 100% of your money in good ESG stocks and 0% in bad ESG stocks, then isn’t it even better to put 120% of your money in good ESG stocks and negative 20% in bad ESG stocks? Shouldn’t you short companies with bad ESG credentials? I mean, again, your reasons for liking ESG might vary, but either way
  [5]
:
	If you think it is good for the world to give capital to good ESG companies and deny it to bad ESG companies, then shorting the stocks of bad ESG companies raises their cost of capital even more, so you should do it.	If you think that bad ESG companies face underappreciated financial risks that will drive down their stock prices, then betting against them should be lucrative.
  [6]
...
Anyway Bloomberg’s Ishika Mookerjee and Sheryl Tian Tong Lee report:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] The delay was up to several hours, which means that Citadel Securities knew its true position fairly quickly and, if it needed to borrow shares before settlement, it could. Also, the naked short selling rules include an exception from the borrowing requirement for “short sales effected by a market maker in connection with bona-fide market making activities in the security,” which I suspect would apply to most of Citadel Securities’ trading.


  [3] I realize that in 2023 the analyst program is *really* training to quit and work in private equity, but senior investment bankers have to come from *somewhere*, and it’s mostly from the ranks of junior investment bankers.


  [4] A third might be “I think that ESG funds will continue to become more popular, so more money will pile into them, so in the short term good ESG stocks will go up, so I want to buy them now for a trade.”


  [5] If you think that ESG funds will become more popular so in the short term good ESG stocks will go up and bad ESG stocks will go down (previous footnote) then, again, short the bad ones now.
