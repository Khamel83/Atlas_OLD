# Money Stuff: FTX Creates Crypto Contagion

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Wed, 16 Nov 2022 14:18:54 -0500 (EST)
**Source:** inputs/saved_emails/Money Stuff FTX Creates Crypto Contagion_Wed,_16_Nov_2022_14-18-54_-0500_(EST)_18481e2b0e346ebb.eml
**Processed:** 2025-08-24T19:13:05.954454
...
I  asked yesterday if there has ever been a liquidity crisis at a crypto firm. I didn’t really get any answers.
  [1]
 But you could imagine how it might go:
	A well capitalized conservatively managed crypto lender takes in deposits of crypto and lends them out to other crypto trading firms, against good collateral.	The firm is borrowing short to lend long: Its deposits can be recalled on demand, but its loans have longer terms and can’t be recalled immediately.	Everything is fine and great, the loans are performing, the collateral is good.	A huge huge huge huge crisis of confidence hits the world of centralized crypto firms, for reasons having nothing to do with this good upstanding crypto lender.	Everyone demands their deposits back, from this lender and from everyone else, due to the crisis of confidence.	The lender doesn’t have their deposits, because it has loaned them to good creditworthy borrowers with good collateral and can’t get them back immediately.
...
Is that this? Man,  what do I know:

The fallout from the collapse of Sam Bankman-Fried’s sprawling crypto empire spread Wednesday, with digital-asset brokerage Genesis and crypto exchange Gemini becoming the latest pain points. 
...
One solution to this problem is that the central bank of crypto could sort it out: Firms that run into trouble could go to Binance, and Binance could examine their books and decide if they’re solvent, and if they are then the industry recovery fund could lend them the money to keep their doors open. It  seems to be moving forward:

Binance Chief Executive Changpeng Zhao said on Wednesday there was significant interest from industry players in a recovery fund his company plans to launch to help crypto projects facing a liquidity squeeze following the collapse of rival FTX.
...
But isn’t that a weird solution, for crypto? That some fund run by the biggest exchange would examine each firm’s secret balance sheets and decide who is worthy of a bailout? What if … what if there was some sort of decentralized solution? For instance, what if crypto firms made their balance sheets public, perhaps with some sort of auditing from a neutral expert accountant, so that investors could decide for themselves which firms were solvent and which were in trouble?
Oh I am kidding, a little. Of course my point is that this is how normal public companies in traditional finance — including big banks — work. But it is not like the published audited quarterly balance sheets of big public traditional financial institutions actually tell you all that much about their financial health, in a crisis; they are mostly too complicated and too delayed to provide definitive answers to questions like “did this bank run out of money an hour ago?” But they help. The actual method that traditional finance has hit upon for addressing these problems is a complex combination of (1) public financial disclosure, (2) safety-and-soundness regulation to keep banks from taking too many dumb risks, (3) capital and liquidity regulation to make sure they have enough money, (4) central bank liquidity support, (5) deposit insurance for customers, etc.
Even before last week’s FTX meltdown,   I liked to say that the crypto industry managed to reinvent the 2008 financial crisis, complete with opaque leverage and financial contagion. And for ages I have been saying that crypto is in the business of re-learning all the lessons of traditional finance. This week, it is learning the lesson of “it is good to have a central bank.” But I am not sure that’s the best lesson to learn here? And it is certainly not the only one. 
 Elsewhere:
...
Sequoia was among investors that lined up only months before to pump money into Bankman-Fried's empire. But not now. Sequoia was shocked at the amount of money Bankman-Fried needed to save FTX, according to the sources, while Apollo first asked for more information, only to later decline. …
...
Anyway the proposal got a lot of attention, and a lot of people and firms from traditional finance argued both sides. Loosely speaking I would say that traditional exchange operators did not like this proposal, while electronic high-frequency-trader-type firms thought it was an improvement over the current system of exchange operators having a lot of discretion.
Last week FTX blew up. We are still learning the details of how it blew up, but the leading explanation seems to have roughly these features:
	Alameda Research, a crypto hedge fund that is affiliated with FTX (both founded by Sam Bankman-Fried, both run out of the same group apartment in the Bahamas, etc.), had huge leveraged positions on FTX and elsewhere.	FTX loaned Alameda lots of money to keep those positions going.	As Alameda’s problems got worse, FTX gave it more money, rather than shutting it down and liquidating its positions.	By delaying, the exchange caused a much bigger problem, ultimately bringing down FTX and Alameda and vaporizing customer money.

I don’t know. I am not sure that explanation is exactly right. But … doesn’t it look like LME? Doesn’t it look like “I had the keys to the castle at that point in time, and it would’ve been a very bad day”? Doesn’t it look like an exchange bending its rules to extend more credit to a well-connected insider whale? And then the whale taking everyone else down with it? Alameda was not getting blown out as soon as its positions moved against it; Alameda was accumulating more and more risk until the whole exchange came down.
This is all a bit speculative, but I think two reasonable lessons to take from FTX’s blowup might be something like:
	At the margin, you should be less persuaded by FTX’s proposal to have exchanges hold customer collateral directly: This is a reminder that exchanges can’t always be trusted with customer money, and distributing that risk to many brokers might be better.	At the margin, you should be more persuaded by FTX’s proposal to have margining be automatic and instantaneous: This is a reminder that, when exchanges have discretion about extending credit to big well-connected whales, they sometimes make disastrous decisions.

Anyway here are two Bloomberg News articles looking back at FTX’s proposal.   Annie Massa, Katherine Doherty and Isis Almeida report today about a Futures Industry Association conference this week; it was supposed to be sponsored by FTX until last week’s unpleasantness:
...
And Michael Regan   rounds up FTX’s supporters:
...
So probably not Wolf of Wall Street. Still, that’s fine. I recently re-watched Margin Call, the best finance movie, and you could see this working in that genre. The dramatic moments are not the drug-fueled orgies but the moment when the junior analyst notices the backdoor in the spreadsheet. I would watch that kind of movie.
Oh right that big Reuters report also includes this:
...
Seems bad.
Elsewhere, Bloomberg   checked in with some crypto-industry employees about how they feel these days:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] A note on entities. That balance sheet is not the audited balance sheet of a particular legal entity running the FTX exchange. It is not the audited balance sheet of anything, but as far as I can tell it is a spreadsheet of all the stuff that FTX, Alameda Research and Sam Bankman-Fried can scrape together, offset by $9 billion of FTX customer liabilities. So some things on that balance sheet — in particular a stake in Robinhood Markets Inc. — seem to belong to Bankman-Fried entities that are not part of the FTX bankruptcy, but are being thrown in here to raise cash. I am going to say “FTX” in the text but I mean more like “the FTX/Alameda/SBF consolidated group.” One thing that I do not understand is the status of FTX.us, FTX’s US entity, which is separate from FTX but also seems to have shut withdrawals.


  [3] That is: $554 million of the FTT token that provides fee discounts on FTX itself, $2,187 million of the SRM token of FTX’s Project Serum decentralized exchange, and $616 million of the MAPS token of another FTX project. I think some other assets on that balance sheet might also fall into this category, though in smaller sizes. And $982 million of Solana’s SOL token are also a risky proposition if you think that the success of the Solana blockchain depends in part on its ties to FTX.


  [4] Also it is silly to be too precise here, but the balance sheet we all saw — because the Financial Times published it — is from last Thursday. I don’t know exactly what time it took its prices from, but I conservatively estimate that FTT and MAPS are down about 40% since then, with SRM down about 14%. That puts the value of this stash at about $2.56 billion, down almost $800 million from last Thursday, almost enough to wipe out the net equity on that balance sheet.
...
<a href=""><img src="https://link.mail.bloombergbusiness.com/img/607f07ceef4b8524a319a23chozui.5xdf/5e1ebcef.gif" alt="" border="0" /></a>
