# Money Stuff: Naked Short Seller Gets in Trouble

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 13 Jun 2023 12:08:52 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Naked Short Seller Gets in Trouble_Tue,_13_Jun_2023_12-08-52_-0400_(EDT)_188b5847d9d4bb9b.eml
**Processed:** 2025-08-24T19:13:03.760059
...
The  basic rule is that if you want to sell stock short — that is, sell it without owning it, to bet on its decline — you have to borrow the stock that you sell from someone who owns it, and generally pay them a fee for the use of their stock.
  [1]
 And before you sell the stock, you need to get a “locate,” meaning that your broker checks and tells you “yeah you can probably borrow enough shares for this short.”
  [2]
 You get a locate, you sell the stock, and then you have to deliver the stock when the trade settles two days later. So, between the trade and the settlement, the broker who gave you the locate goes out and actually borrows the stock for you. If you do not borrow the stock in time to settle the transaction, that is called a “fail.”
If you do not get a locate before the trade, or if you do not manage to borrow the stock before the trade is supposed to settle (and the trade fails), that is what is sometimes called a “naked short.” (“In a ‘naked’ short sale, a seller does not borrow or arrange to borrow securitiesin time to make delivery to the buyer within the standard settlement period,”  says yesterday’s SEC complaint.) Naked short selling is somewhere between unfortunate (if, say, a market maker does a short sale and can’t find borrow in time for normal settlement) and illegal (if a hedge fund shorts a stock without bothering to get a locate).
...
There is, however, a good (illegal! but possibly lucrative) real use case for naked shorting, albeit sort of a strange and specialized one. It goes like this:
	A publicly traded company is having some tough times and is looking to raise a bit of money. Ordinary financing options like a bond deal or a public stock offering are not available for whatever reason, so the company is looking for weird trades.	You arrange to buy some stock from the company, in the future, either at a fixed price or at some floating price indexed to the market price. So you sign a contract to buy 1 million shares two weeks from now at $1 per share (a fixed price), or to buy 1 million shares two weeks from now at the volume-weighted average price
  [3]
 of the stock over next two weeks (a floating price). You are giving the company money, and you are getting back stock, and because the company is a bit desperate you get a pretty good deal.	The stock is trading at, like, $1.25 today: You are getting a discount, buying at $1, because the company needs the money. (Or if you are buying at a floating price, it might be at a discount to the average market price.)	If you could sell 1 million shares at $1.25 today, then in two weeks you will buy them at $1, and you will make a $250,000 guaranteed profit. Whereas if you wait the two weeks, buy the shares at $1, and then sell them, maybe the stock will be below $1 by then and you will lose money. This company is risky! You want to lock in the profit now. (Similarly, but slightly more complicated, with a floating price: You want to sell the stock over the two-week period so you can get the average price, rather than waiting to buy at that price and then sell at whatever the price is in two weeks.)	But, look: If you have this sort of arrangement with this sort of troubled company, there is a good chance that it is hard to borrow 1 million shares. The company is small, its stock doesn’t trade that much, probably a lot of people have already borrowed it to short it. So you have to pay a large borrow fee, or more likely you simply cannot find 1 million shares to borrow at any price.	If you just naked shorted the stock, and sort of strung your brokers along for two weeks, you’d be fine: Sell at $1.25 today, buy at $1 in two weeks, and deliver the 1 million shares you bought to close out your short position. No harm done!
...
We have talked about this idea a few times before. We have   talked, for   instance, about the PIPE (private investment in public equity) deal done by Digital World Acquisition Corp., the special purpose acquisition company that is waiting around to try to take Donald Trump’s media company public. Roughly speaking, the deal there was that the PIPE investors agreed, in December 2021, to buy DWAC stock at $33.60 per share whenever the Trump merger closed.
  [5]
 The stock was trading at about $45 at the time. The merger still has not closed and probably never will; the stock closed yesterday at $12.79. If you had shorted the stock when you signed the PIPE deal, you’d be hedged: You sell at $45, the deal closes and you buy back at $33.60, or else the deal does not close, the stock falls, and you buy back at, you know, $10. The PIPE deal specifically allowed investors to short to lock in this profit. But, I wrote:
...
If somehow you could be naked short for, like, a year and a half or so, those problems would be solved and it would be free money. I don’t think you could — I don’t think anyone did this trade — but you can see how naked shorting would be attractive here.
  [6]

Anyway that’s the sort of trade that Sabby allegedly did, though on a smaller scale and not in DWAC. (Though Sabby is an investor in the DWAC PIPE.) From  yesterday’s SEC complaint:

In April 2018, Defendants, on behalf of the Warrant Fund, entered into a securities purchase agreement with Issuer 1 through which Defendants acquired preferred securities that could be converted into Issuer 1’s common stock at a conversion price of $0.46 per share. The agreement contained a provision that, on June 25, 2018, the conversion price of the preferred securities would be adjusted to 80% of the volume-weighted average price (“VWAP”) of Issuer 1’s common stock on the preceding trading day, June 22, 2018 (“the reset provision”).
The reset provision gave Defendants a financial incentive to push down the price of Issuer 1’s common stock before June 22, 2018 in order to receive more common stock upon conversion. …
With two trading days remaining before the reset provision took effect, Defendants intentionally began naked short selling Issuer 1’s common stock, putting downward pressure on Issuer 1’s stock price. ...
Throughout the day, Defendants, on behalf of the Warrant Fund, submitted to executing brokerdealers materially false and misleading order instructions for the long sale of 1,126,033 shares of Issuer 1’s common stock that executed at prices between approximately $0.29 and $0.33 per share.
Defendants knew, or were reckless in not knowing, that the sale of all but 286 shares should have been marked as short sales because the Warrant Fund did not have a sufficient net long position in the common stock of Issuer 1 at the time Defendants submitted the orders.

Basically they did not get a locate for these short sales, and they tricked their brokers into allowing them by marking the sales as “long” rather than “short.” (A “long sale” is selling stock that you own; a “short sale” is selling stock that you borrow. Later they sold more shares marked as short, but “falsely represented to the executing broker-dealers that Defendants had obtained locates.”) This was, in a legal sense, wrong: They did not own the shares they were selling, so these were not long sales. But it was in some broad economic sense right: They owned convertible preferred shares that they could convert into the shares they were selling; they had economic exposure to the underlying shares, and could get them easily. And they did:

After the close of trading markets on June 22, 2018, Defendants calculated the adjusted conversion rate for the Warrant Fund’s Issuer 1 preferred securities – based on 80% of VWAP on June 22, 2018 – to be $0.1779 per share, down from the original rate of $0.46 per share.
At or around 5:31 PM Eastern Time on June 22, 2018, Defendants, on behalf of the Warrant Fund, submitted a conversion notice to Issuer 1 to convert $1,797,017 worth of preferred securities into 10,101,280 shares of Issuer 1 common stock at a conversion rate of $0.1779 per share.

And so they had enough shares to settle their short sales, which they did, on the normal timeline (with no fails). But the SEC doesn’t like it:
Defendants intended to use these shares to satisfy the delivery obligations for their June 21 and 22, 2018 sales of Issuer 1 common stock and to try to conceal their violative short sales for which they had failed to obtain locates. However, as Defendants knew or were reckless in not knowing all along, the use of these converted shares to cover their sales would not and did not in any way cure their violative trading. Delivery of those shares did not cure the fact that they had mismarked their trades as long sales when they were not “deemed to own” the shares or did not have a net long position in Issuer 1 at the time they submitted the mismarked orders. Similarly, delivery of those shares did not cure their violations of the locate requirements of Regulation SHO because they had placed short sales without actually having obtained a locate, and as Defendants knew or were reckless in not knowing, they could not use the fact that they held convertible securities that could be exchanged for Issuer 1 stock to satisfy the locate requirement.
And they did this because it was lucrative:
If Defendants had converted $1,797,017 worth of Issuer 1 preferred securities prior to the adjustment of the conversion rate, effective June 25, 2018, the conversion would have yielded only 3,906,560 shares of Issuer 1 common stock. Instead, by tendering the convertible securities after Issuer 1’s stock price plummeted by over 60% and the conversion rate was adjusted downward, Sabby’s conversion of $1,797,017 worth of preferred securities at the price of $0.1779 per share resulted in approximately 10.1 million shares of common stock.
If they had converted at $0.46 and then sold at about $0.19 per share (the closing price on June 22), they would have lost money. (Also, if they converted first and then sold, they would have been entirely at risk — the price could have fallen more. Instead they sold at about $0.22 per share first and then converted at about $0.18 per share, a much better trade — both more profitable and less risky — though an illegal one.
The SEC goes through another example in which Sabby allegedly (naked) shorted a bunch of another company’s stock at prices above $1 and then signed a purchase agreement with the company to buy 1 million shares at $1, locking in a profit. That is a risky trade, unless you are pretty sure you’re going to be able to buy the stock from the company.
  [7]
...
I confess that I did not really believe the last point at all, and I have over the years made a lot of jokes about this. (Disclosure, I used to work at Goldman.) People in finance have all sorts of hobbies, and being what Rusty Foster once called a “professional amateur DJ” never struck me as all that weird or challenging. Everyone wants to be the underdog, to tell a story of triumphing over adversity, and if your adversity is being an ambitious investment banker who also DJs then that is fine but I am going to make fun of it.
In recent months, though, I have begun to think that I was wrong, and that the anonymous conservative older bankers who doubted Solomon might (1) exist and (2) have been right that in fact no one man can successfully be both the CEO of Goldman Sachs and also a DJ. In February we discussed a New York Times story about, I swear this headline is real, “The Blurred Lines Between Goldman C.E.O.’s Day Job and His D.J. Gig.” Apparently it is possible to have conflicts of interest between running Goldman Sachs and DJing, and Solomon might have found some, and others at Goldman have griped about them. 
And today’s Wall Street Journal has a story with the headline “Goldman Sachs Is at War With Itself” that begins with this story:
...
And one of the conservative older bankers who advised against the DJing is actually named:
John Rogers, a Goldman partner since 2000, and the secretary to the bank’s board, expressed concerns to Solomon about his DJ side gig, according to people familiar with the matter, saying it wasn’t a good look for the CEO of one of Wall Street’s most formidable firms.
Just an absolutely Shakespearean palace coup brewing here, all these Goldman partners plotting revolt because their CEO is also a DJ. 
I am … partially … kidding? Actually the disputes seem to be more about money and strategy and, in particular, the power of the Goldman partnership:
...
Solomon’s model is that Goldman Sachs is a publicly traded corporation and he is the chief executive officer of it. That model is factually accurate, but Goldman has spent a long time sort of pretending that it is in fact a private partnership, largely for good cultural and risk-management reasons, and you can see why the partners would be attached to that model.
Meanwhile at Semafor, Liz Hoffman reports:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] You get a locate, rather than actually borrowing the shares in advance, for the same reason that you don’t put up the cash to *buy* shares the moment you submit an order. If you submit an order to buy or sell shares, the order will go to the stock exchange, and if it gets filled then you will actually deliver the money or shares (and receive the shares or money) in two business days. (This is  going down to one business day next year.) You need a locate to submit an order to short stock, but you don’t actually have to deliver the stock for two days, so your broker being reasonably confident it can line up the borrow is good enough to submit the order.


  [3] As a former equity derivatives structurer, I will tell you that the proper form of words here is “the simple average of the daily volume-weighted average prices,” but I am simplifying in the text.


  [4] I confess that *this* intuition *also* does not really depend on whether your shorting is naked or not; it just happens to work out that the borrow is tight in a lot of companies that might actually do this stuff.


  [5] The deal was better than that — the purchase price was partially floating; it could be adjusted down if the stock fell — but this is good enough for our purposes.


  [6] I’m going to leave this as an exercise for the reader, but: How would naked shorting improve the Bed Bath & Beyond Inc.   deal with Hudson Bay Capital? I think that deal was structured to limit the pressure on stock borrow by letting them exercise and sell in small bits, but it's complicated.


  [7] Were they … negotiating the purchase agreement while shorting? Is that … insider trading? The SEC does not say.
