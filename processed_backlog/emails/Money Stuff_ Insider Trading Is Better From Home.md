# Money Stuff: Insider Trading Is Better From Home

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Mon, 3 Jul 2023 12:52:54 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Insider Trading Is Better From Home_Mon,_3_Jul_2023_12-52-54_-0400_(EDT)_1891cabf9c309d53.eml
**Processed:** 2025-08-24T19:13:07.207717
...
That said, there is one classic form of financial crime that I think would have to be increased by work-from-home? That form of financial crime is “looking at your girlfriend’s computer to see what high-stakes deals she is working on,
  [1]
 and then insider trading on them.” People love that one. If your girlfriend mostly works from her law firm’s or investment bank’s office, but logs in at night or does weekend conference calls on live deals, you might pick up some information to trade on, though she might remember to use code names when you’re in earshot and lock her computer when she steps away. But if she works from home all day every day in your one-bedroom apartment, you are just far more likely to know what she is working on. And if you are inclined to trade on it,  you will:

The Securities and Exchange Commission [Thursday] announced insider trading charges against Jordan Meadow, a registered representative for a New York-based broker-dealer, and Steven Teixeira, the Chief Compliance Officer of an international payment processing company, in connection with their trading based on material nonpublic information that Teixeira obtained from his girlfriend’s laptop while she was working at home during the COVID-19 pandemic.
...
There are also  criminal charges. Always the compliance officers, always the call options. The girlfriend was an executive assistant at the investment bank (reportedly   Morgan Stanley),  where she “was responsible for, among other things, scheduling meetings of the Investment Bank’s valuation and fairness committees concerning potential transactions involving the Investment Bank’s clients”:
Deal teams working on transactions provided the Executive Assistant with scheduling request forms for valuation and fairness committee meetings. These forms included the names of the companies participating in, and the material terms relating to, the proposed deals. The Executive Assistant created and sent calendar invitations for the meetings, attaching the scheduling request forms to the invitations. 
And:
Teixeira accessed the Executive Assistant’s laptop while she was away—either out of the room or away from the apartment entirely. Using his access, Teixeira reviewed the Executive Assistant’s Outlook application to find valuation and fairness committee meetings relating to mergers and acquisitions of public companies. He then reviewed the attachment containing the party names and material terms of potential transactions involving the Investment Bank’s clients.
Sure, right, of course. The executive assistant for the fairness committee is far more useful, for insider trading, than a high-powered investment banker would be: The banker sees mostly her own deals; the committee assistant sees just enough information on every deal.
Also there is a great information-security detail here. The bank was careful about remote access to data, to prevent exactly this sort of thing:
The Investment Bank’s online portal for employees working remotely locked automatically after a period of inactivity. The system could detect that an employee was not typing or moving their mouse, for example, and would require the employee to log in again to access the Investment Bank’s files. 
This security system had a downside, though, which is that it is annoying. Nobody wants to be logged out of their remote work every time they go to the bathroom. So:
...
Oh but if you traded Royal Caribbean options! If you bought a bunch of Delta calls and hedged by selling a bunch of Zoom calls! That would be interesting:
	It would work. You could reasonably have predicted how those stocks would move on the Paxlovid news, and in fact they did move that way.	It might not be illegal? We have   talked a   lot about “shadow trading,” when employees of one company use news that they learn about that company to trade other stocks that will move in predictable ways on their company’s news. The SEC doesn’t like it, and brought   one notable shadow-trading case in 2021, but the law is less clear here than it is when you trade your own company’s stock.
  [2]
...
By the way the bull case here is that he was just early, and SoftBank really did manage to pick all the companies that will do the best job of deploying AI to redefine their industries, and in 10 years all of us will work out of WeWorks because WeWork is uniquely good at using AI models to, you know, adjust the air conditioning and dynamically price desk space and whatever. The real upshot of the computer revolution is that every company became a tech company, and I suppose the real upshot of the AI revolution might be that every company becomes an AI company, and some will get there faster than others. I don’t have any reason to think that Son did pick all the right winners, but it is perhaps too early to tell.
Elsewhere in industries getting transformed by AI:
...
Ha ha ha!  Yes! Musk is limiting access to Twitter in order to break its users’ addiction and free them to touch grass. He has correctly diagnosed the problem (Twitter users are too obsessed with it) and implemented a solution (don’t let them see too many tweets). Of course to do this he had to become completely obsessed with Twitter, devote himself full-time to running it, tweet constantly and sink tens of billions of dollars of his own money into buying Twitter and then breaking it. He has sacrificed so much himself so that people like me can spend a bit less time on Twitter; he has taken the burden of Twitter addiction from millions of users and put it all on himself. Thanks!
In other news:
