# Money Stuff: Gambling on Options Is Fun

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 12 Sep 2023 14:36:50 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Gambling on Options Is Fun_Tue,_12_Sep_2023_14-36-50_-0400_(EDT)_18a8aaea42f0ccba.eml
**Processed:** 2025-08-24T19:13:09.064479
...
Now. This analysis might be correct, and it might not be. You don’t have to believe it. For instance, Dan Och, Sculptor’s estranged founder, and Rob Shafir, its former CEO, have both put out public statements saying that they don’t support the Rithm deal. Shafir   said that “it is not credible” to think that Sculptor’s clients would not accept the Weinstein deal, and Och   has argued that the board is selling out shareholder interests in order to protect Jimmy Levin’s job. 
(Also, I   have   suggested that this analysis is easy to test: Just get, like, Levin and Weinstein and Rithm together in a room and have them call Sculptor’s biggest investors and ask what they think! If all the investors say “no, can’t stand that Weinstein guy,” then (1) the board can credibly continue to reject the Weinstein deal and (2) Weinstein won’t want to keep pursuing it, since he doesn’t want to pay for Sculptor and get no clients.)
More generally, if you are a Sculptor shareholder, you might be skeptical of the board’s analysis, just because $12.76 really is more than $11.15. There are two offers here, one for $11.15 and one for $12.76, and you would much rather get the $12.76 one. The board says that the $12.76 one is a mirage, that it won’t actually close, but wouldn’t you be pretty tempted? Shareholders are: The stock has traded above $11.15 for the last three weeks or so, and closed yesterday at $12.02, suggesting that shareholders expect to do better than Rithm’s deal.
...
We have   talked about this tension — “Still, such non-disclosure pacts are common in big US merger and acquisition agreements” — before. On the one hand, yes, it is normal in an M&A process to ask potential bidders to sign NDAs with standstill provisions that prevent them from making a public topping bid; that’s how you get the best price in your auction. On the other hand, sure, once you get a topping bid it is kind of rough to ignore it.
Here is  the lawsuit, which is pretty normal stuff. It cites a  2007 Delaware case in which Topps Co. agreed to sell itself to Michael Eisner (in a deal that would keep Topps’s management), but then Upper Deck Co. came in with a topping bid; Topps refused to negotiate with Upper Deck, arguing that its offer was too conditional. Because Upper Deck had signed a standstill agreement, it couldn’t make a public tender offer. The court found that “there is no reasonable basis for permitting the Topps board to deny its stockholders the chance to consider for themselves whether to prefer Upper Deck’s higher-priced deal, taking into account its unique risks, over Eisner’s lower-priced deal, which has its own risks.” Similarly, here, the lawsuit argues
  [3]
:

The Topps board made the same type of excuses as the Special Committee is making here as to why it would not declare the topping bid reasonably likely to lead to a Superior Proposal, including limits on liability in the event the transaction did not close and regulatory issues. The Court found the Topps board’s decision not to deem Upper Deck’s offer reasonably likely to lead to a Superior Proposal “highly questionable.”
The Topps situation similarly involved a chief executive, like Defendant Levin, who had strong interests in maintaining his current position. In Topps, the CEO Shorin “was motivated to find a buyer who was friendly to him and would guarantee that Shorin and Silverstein, his son-in-law, would continue to play leading roles at Topps.” Levin has been paid almost $200 million in the past two years and has ample incentive to resist a transaction that will eventually oust him. Rithm has promised to retain Levin while the Consortium has indicated Levin’s retention is less important. In fact, the Consortium’s recent concession to keep Levin after closing appears to have been intended to respond to the Special Committee identifying Levin’s continuation as linked to deal certainty. The Special Committee, aligning with Levin’s interests, effectively communicated that unless Levin keeps his job, the Special Committee will consider the deal subject to undue execution risk because it will risk obtaining client consents. ...
The Topps decision also discussed how a standstill can operate to unfairly prevent a bidder from communicating with stockholders. As the Topps Court noted, while they have legitimate uses, “standstills are also subject to abuse. Parties like Eisner often, as was done here, insist on a standstill as a deal protection. Furthermore, a standstill can be used by a target improperly to favor one bidder over another, not for reasons consistent with stockholder interest, but because managers prefer one bidder for their own motives.”
...
Occasionally the regulators change the rules, generally to require more capital. Conceptually, if you are a bank, there are two possible objections to the new rules:
	The new rules require more capital, and more capital is bad. Right now (before the new rules) banks have enough capital: They are safe, and if bad stuff happens the banks will all be fine. Requiring them to add more capital would be unnecessary; it would also be expensive, lowering their return on equity and making the business of banking less attractive, which will lead to less lending and economic contraction.	The new rules require too much capital for some activities (and, implicitly, too little for others). The new rules will distort banking activity, treating safe things as risky and risky things as safe; they will make banks make bad economic decisions in order to get better capital treatment.
...
Anyway the Federal Reserve   has proposed to modify US banks’ capital requirements, and big banks have raised both sorts of objections. There are nuanced technical objections about how the proposed rules  get things wrong:

Alastair Borthwick, Bank of America’s chief financial officer, added to the criticism on Monday, saying the Fed’s proposals could mean risk-weighted assets are double counted in some instances, which could again constrain bank lending.
...
And then there is Jamie Dimon complaining that   more capital is too much:
...
I love that Jamie Dimon obviously can speak in the language of sell-side stock analysts, but he finds it somewhat distasteful. “Equal weight, or whatever you call it.” Also he is skeptical about those “important points of advocacy”:

The Fed is now soliciting comments on the proposed changes in a notice of proposed rulemaking (NPR) but Dimon was sceptical that any material changes would be made.
“Do you think the NPRs are going to make a … difference?” Dimon said, in his characteristically blunt style.
  [5]
 “It’s my academics arguing with their academics. They’re going to do what they want anyway. That’s all that’s going to happen.”
...
Well, that last sentence was sarcastic. The SEC seems to me to be skeptical of all crypto; it kind of thinks that Bitcoin is just gambling, which makes a 2x Bitcoin ETF double gambling. But a reader pointed out that  Volatility Shares already did this, and the SEC approved it:
...
The SEC doesn’t want to make it too easy to invest in Bitcoin via ETFs, but, due to its own odd logic, it has made it possible to invest in double Bitcoin via ETFs. 
By the way, as part of its legal challenge to the SEC, Grayscale complained about this irony in a letter to the court:

The 2x Bitcoin Strategy ETF, which seeks to double the performance of the S&P CME Bitcoin Futures Daily Roll Index each day, is leveraged. As a result, it exposes investors to an even riskier investment product than traditional bitcoin futures exchange-traded products (“ETPs”), which encompass risks related to both the futures and spot bitcoin markets. ...
The fact that the Commission has allowed a leveraged bitcoin futures ETP to begin trading demonstrates that the Commission continues to arbitrarily treat spot bitcoin ETPs differently than bitcoin futures ETPs. … The 2x Bitcoin Strategy ETF is therefore exposed to even more risks of the bitcoin markets than Grayscale’s proposed spot bitcoin ETP.
...
a poison pill, but it would be hard to justify in the face of an unconditional higher all-cash tender offer.
  ...
  [2] There are actually two vote requirements in this deal. One (imposed by corporate law) is that a majority of shares has to vote yes; the other (imposed by Sculptor’s board) is that a majority of shares held by the “Non-Unitholder Stockholders” has to vote yes. The latter vote basically excludes insiders (like Jimmy Levin) from the vote, but it also excludes former insiders (like Dan Och); it is, roughly, a vote of the disinterested outside shareholders. My rough count is that current insiders (Levin et al.) own about 27% of the votes and disgruntled ex-insiders (Och, Shafir) own perhaps half that, so it will be a bit harder for Sculptor to win the second vote of disinterested outsiders.
