# =?utf-8?B?TW9uZXkgU3R1ZmY6IEEgSGVkZ2UgRnVu?=
 =?utf-8?B?ZCBUaGF04oCZcyBBbHNvIGEgTmV3c3BhcGVy?=

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 2 Apr 2024 14:21:17 -0400 (EDT)
**Source:** inputs/saved_emails/=utf-8BTW9uZXkgU3R1ZmY6IEEgSGVkZ2UgRnVu=
 =utf-8BZCBUaGF04oCZcyBBbHNvIGEgTmV3c3BhcGVy=_Tue,_2_Apr_2024_14-21-17_-0400_(EDT)_18ea00b5aeceb452.eml
**Processed:** 2025-08-24T19:13:11.171704
...
We know this may not be seen as traditional journalism, which is generally known for being dispassionate, reliant on inside sources, and indifferent to profitability. We are proudly passionate. We avoid talking to insiders, depending instead on publicly available information.
  [1]
 And we believe that good reporting can be good business — when you monetize insights instead of eyeballs and align profits with accuracy. 
...
There’s the only slightly less obvious “everything is securities fraud” lawsuit
  [2]
:
...
Here is an insider trading hypothetical that I have never considered before. You are a talented business executive with a high profile. A public company has publicly announced that its chief executive officer is leaving and that it is looking for a replacement.
  [3]
 You think you’d be perfect for the job. The company calls you in for an interview. The interview goes well. “We’ll let you know in a few weeks,” they say, but you have a joint good feeling that:
...
This has remained controversial for a decade: The empirical evidence for price impacts is mixed, and also it is kind of annoying to think about how you’d fix it. (“Should index funds be illegal?” is my usual shorthand for this topic, and that sounds bad!
  [4]
) But it struck a nerve, in part because it is sort of fun and counterintuitive and in part because the arguable impacts are so large. (Trillions of dollars! Every company!)
...
I think there are roughly four ways to make a stablecoin, a crypto token that has a stable value of $1:
  ...
  [5]
	...
	A stablecoin of pure will: You list a token on a crypto exchange, its name is like “Stable Value Dollar Coin,” and the marketing materials say “the point of Stable Value Dollar Coin is to always be worth a dollar.” And then you just hope that people will pay a dollar for it, because you told them to.
...
Anyway someone pointed me to a Solana memecoin called “Costco Hot Dog,” or COST, whose schtick is:
	A Costco hot dog famously costs $1.50.	This is a Costco Hot Dog. (Token.)	Therefore this should be worth $1.50.

“The greatest meme against inflation has arrived,” says its X account. Sadly it’s trading at about $0.03 but I guess that means there’s a lot of upside.
  [6]
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] Keep an eye on this one. I quoted above from the editor's letter, saying "our investigations will expose a fossil fuel conglomerate supporting a junta, an agricultural giant expanding operations in a region known for forced labor, and an energy company destroying an ecosystem" and "we believe many of the corporations we will report on are also lying." If a fossil fuel conglomerate supports a junta, and that fact comes out ... is that bad for the stock? I dunno, maybe. But if the stock drops a little bit, can you sue for securities fraud, for lying about the junta? Everything is securities fraud! That might help make the business model work.


  [3] I put this sentence in the hypothetical because arguably things are a bit different if there is a current CEO and you are secretly being considered to replace her. “The other CEO is out, and I am in” is two pieces of material news, only one of which is about you; the cleaner hypothetical is “I am getting hired into an open spot.” In fact Ajax’s former CEO  left last May, so the spot was open when Kroes was buying in July.


  [4] One thing I should point out is that it’s not really about index funds per se; giant diversified investment firms would run into these problems even if they did not track an index. If you own trillions of dollars of equities you are going to own large chunks of lots of overlapping companies. Germán Gutiérrez and Thomas Philippon use the term “
quasi-indexers” to cover investors with “diversified holdings and low portfolio turnover,” meaning both index funds but also other large diversified active funds. (It’s not the same as “shadow indexers,” meaning active funds that don’t do much active management: You can be a quasi-indexer even if you have a large active share and a lot of alpha, the point is just that you own a ton of diversified stocks.)


  [5] Arguably algorithmic stablecoins and overcollateralized stablecoins are sort of the same thing, except that algorithmic stablecoins have highly correlated collateral.
