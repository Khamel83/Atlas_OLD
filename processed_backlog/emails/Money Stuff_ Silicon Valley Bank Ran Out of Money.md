# Money Stuff: Silicon Valley Bank Ran Out of Money

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Wed, 22 Mar 2023 14:05:53 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Silicon Valley Bank Ran Out of Money_Wed,_22_Mar_2023_14-05-53_-0400_(EDT)_1870a7ff5a1164a3.eml
**Processed:** 2025-08-24T19:13:03.642040
...
There will be all sorts of proposals for changes in bank regulation and supervision and deposit insurance and Fed facilities that come out of this crisis. “Make the lender-of-last-resort process for making loans and posting collateral a bit more automated” is probably not going to be top of the list: Again, I doubt it would have saved SVB, and I do not have any great technical insights into how it should be improved.
  [1]
 But, I don’t know, wouldn’t it be a good idea? Wouldn’t you have more confidence in the banking system, if banks that had lots of assets could get money when they needed it?
Elsewhere in   SVB deposit flight:
...
Wall Street leaders and US officials discussing an intervention at First Republic Bank are exploring the possibility of government backing to encourage a deal that would shore up the lender, people with knowledge of the situation said. The shares dropped Wednesday morning.
...
Imagine putting dollar numbers on the investors’ demands. Imagine some bigger bank saying “okay we’ll buy First Republic but we want $5 billion of goodies from the government in exchange.” Goodies might include:
	The government buying or guaranteeing some of the worse assets.	The government indemnifying the buyer against some liabilities.	“Applying capital rules more flexibly.”	“Easing limits on ownership stakes.”

And the bank has some schedule of how it values each goodie and is indifferent to any package that totals $5 billion worth of goodies. It is I guess fairly straightforward to reduce Options 1 and 2 to dollars, and also pretty symmetric: A $5 billion loss-sharing deal is worth about $5 billion to the buyer and costs the government about $5 billion.
  [2]
 I bet that a bank could put a price on Option 3; that is, it could probably calculate how much more profitable it would be with lower capital requirements. Could the government put a price on it? Is that price symmetric? Does saying “sure, big bank, be undercapitalized for a while” cost the government as much as it benefits the buyer bank? More? Less? Has the value of financial stability (and thus bank capital) gone up due to this crisis, or is taking a bit of risk with capital requirements a cheap way out of it?
Meanwhile   at Signature Bank:
...
The   basic story of this month’s US bank runs seems to be that interest rates went up and the value of regional banks’ portfolios of safe held-to-maturity bonds went down. These values were not reflected in the banks’ financial statements (because accounting rules allow them to mark held-to-maturity bonds at their purchase price), but they were reflected in the footnotes to those statements, and eventually analysts and depositors read those footnotes and got nervous and took their money out. And so SVB and Signature failed and were seized by the FDIC.
But meanwhile those banks also have loans, and the loans (1) might have some credit problems and (2) probably also have some interest-rate problems, since they were mostly made in much lower-interest-rate environments. But the loans are harder to value and harder to sell; there is not some table at the back of the financial statements listing the exact market value of the loan portfolio. The loans probably did not bring down the banks. But now that the FDIC owns these banks, it can sell the bond portfolios easily enough: They’re just bonds. It turns out that no one wants some of the loans, though, so the FDIC is stuck with them.
And   at PacWest:
...
There is a tension here. If you seize the riskiest bank and give its shareholders nothing, to make an example of them, then the second-riskiest bank is going to have a hard time raising equity, which means it is more likely to fail and need rescuing itself. If you bail out the riskiest bank in a way that preserves a lot of value for shareholders, then (1) the second-riskiest bank is going to be a bit more sanguine about its own risks and (2) the equity didn’t do much good, did it?
...
Elsewhere in the Asian AT1 market:
...
If you lower the cost of capital for already-green companies, they can’t generally get much greener.
  [4]
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] I mean, presumably it would be a guarantee against a risk of loss, not just a cash payment, so it's some fraction of $5 billion depending on how likely the losses are, but the point is it's symmetric; eventually the government writes a check and the buyer cashes it.


  [3] If you are an AT1 holder and your reply is "same goes for the common stock," I mean, fair, I don't disagree. But each of these decisions is a rough balancing act and the Swiss went one way with the common and another way with the AT1s, and giving *something* to the common seems defensible to me.
