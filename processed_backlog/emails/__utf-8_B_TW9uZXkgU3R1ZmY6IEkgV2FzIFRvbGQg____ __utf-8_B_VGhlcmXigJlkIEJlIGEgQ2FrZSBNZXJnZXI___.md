# =?utf-8?B?TW9uZXkgU3R1ZmY6IEkgV2FzIFRvbGQg?=
 =?utf-8?B?VGhlcmXigJlkIEJlIGEgQ2FrZSBNZXJnZXI=?=

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 12 Jul 2022 13:33:55 -0400 (EDT)
**Source:** inputs/saved_emails/=utf-8BTW9uZXkgU3R1ZmY6IEkgV2FzIFRvbGQg=
 =utf-8BVGhlcmXigJlkIEJlIGEgQ2FrZSBNZXJnZXI==_Tue,_12_Jul_2022_13-33-55_-0400_(EDT)_181f37a343ef4cde.eml
**Processed:** 2025-08-24T19:13:05.606490
...
Twitter’s lawyers are Wachtell, Lipton, Rosen & Katz; disclosure, I worked there a long time ago. If you’re following along at home, when Wachtell says “Mr. Musk … breached … Sections 6.3, 6.8, and 6.10,” that is a shorthand way of saying that Musk has not been using his reasonable best efforts to get the deal closed (section 6.3), has not been doing his best to get his financing finalized (section 6.10), and has been making all sorts of disparaging public announcements without consulting with Twitter (section 6.8). None of this is exactly surprising. I have nothing really to say about this letter that I did not say  yesterday or  Saturday — this letter is just a placeholder until Twitter can sue — but I guess I have to mention it.
In other news, we talked a bit yesterday about how Musk’s banks will be relieved if he gets out of the deal, because their $13 billion debt financing commitment is pretty underwater. Paula Seligson and Davide Scigliuzzo at Bloomberg News  have more on that:
...
Davenport finds “that a standard off-the-shelf algorithm can strongly discern between startups that are more or less likely to have exits.” He then trains another machine-learning algorithm to predict “a different outcome: will the startup receive an early-stage investment.” Actually he builds two of those: one to predict, effectively, if a bad startup (one that won’t have a profitable exit) will receive an early-stage investment, and another to predict if a good startup will get investors. Those models turn out to look for different things:

The model trained on the worst firms appears to prioritize founder details, whereas the model trained on the best firms appears to prioritize product details. When making good investments, investors appear to bet on the horse, but when making bad investments they appear to be betting on the jockey. ...
Hit TV shows such as ”Shark Tank” and industry norms around ”Pitch Day” events suggest an ethos built around founder charisma and personal persuasion. In his best-selling book ”Good to Great”, Collins (2009) asserts “First Who, Then What” and the idea has been absorbed into the zeitgeist. The ubiquity of this perspective is a true success story of “model persuasion” (Schwartzstein and Sunderam 2021). Investors seem convinced that the founder-first model of the world is the correct one. This likely facilitates investors neglecting to notice features that are predictive and a feedback loop of never noticing or learning persists, consistent with the model and evidence presented in Hanna et al. (2014).

Let me make a general point here. Let’s say that you are a budding finance academic working on a Ph.D. at the University of Chicago. As part of your thesis, you build an algorithm for evaluating companies, you run it on the companies in the S&P 500 Index, and you realize that if you used the algorithm you could outperform the market by 10%. What do you do? I think the obvious answer is that you go to your professors, you show them the research, they seed your fund, you delete your thesis, you drop out and run your strategy and make yourself and your professors rich. You use your algorithm to buy the good stocks and avoid the bad stocks and outperform the market by 10%. I assume that if you go to Chicago and you find a way to beat the market by 10% and you publish it, they will not give you your Ph.D. This is Chicago! They have standards to uphold. They’re not gonna let you go out and put $10 bills on the sidewalk.
...
<a href=""><img src="https://link.mail.bloombergbusiness.com/img/607f07ceef4b8524a319a23cgvo69.60i6/af4cb0d4.gif" alt="" border="0" /></a>
