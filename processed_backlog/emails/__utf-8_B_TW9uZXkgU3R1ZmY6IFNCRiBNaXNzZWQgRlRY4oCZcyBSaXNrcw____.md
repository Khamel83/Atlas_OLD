# =?utf-8?B?TW9uZXkgU3R1ZmY6IFNCRiBNaXNzZWQgRlRY4oCZcyBSaXNrcw==?=

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Thu, 1 Dec 2022 14:46:55 -0500 (EST)
**Source:** inputs/saved_emails/=utf-8BTW9uZXkgU3R1ZmY6IFNCRiBNaXNzZWQgRlRY4oCZcyBSaXNrcw===_Thu,_1_Dec_2022_14-46-55_-0500_(EST)_184cf3c3c52f39ff.eml
**Processed:** 2025-08-24T19:13:11.453033
...
Here are the  video and  transcript of Bankman-Fried’s interview with Sorkin at the DealBook conference yesterday. Here is an  interview with Jen Wieczner in New York magazine, which was published today though conducted on Nov. 17. Here is an interview with  George Stephanopoulos on “Good Morning America”. 
I want to give a stylized version of Bankman-Fried’s account of what went wrong at FTX and Alameda. It goes something like this:
	FTX International was a crypto exchange for sophisticated margin traders.
  [1]
 A “crypto exchange” is both an exchange — a place where people can meet to buy and sell crypto — but also a broker-dealer, a firm that holds its customers’ crypto for them and gives them financing.	Everyone trading on FTX was basically borrowing money from FTX to put on leveraged crypto trades, or lending out the crypto in their FTX accounts to earn interest, or both. This necessarily means that the customers’ crypto was not segregated: If you’re lending out your crypto to earn interest, or borrowing crypto to make bigger trades, you can’t expect your crypto to all sit in a segregated account doing nothing. If you are trading via leveraged perpetual futures, a big FTX product, you certainly can’t expect your crypto to all be sitting there waiting for you: You don’t own any crypto; you just have a derivative trade with FTX.	One very important trader on FTX was Alameda Research, which had huge leveraged positions on FTX.	Alameda’s position was overcollateralized, but FTX had a little bit of an $8 billion accounting boo-boo, so it thought Alameda’s position was less leveraged than it actually was.	Then there was a huge sudden correlated drop in the prices of crypto assets, which left Alameda undercollateralized, and FTX — due to the accounting boo-boo — was surprised to find out how undercollateralized it was.	Other traders noticed this and withdrew money from FTX, creating a “run on the bank.”	The run on the bank also led to further declines in the prices of crypto assets, particularly the ones that Alameda held, leaving FTX without enough collateral to pay out all of its customers.
...
But the other part of this story that I find frustrating is the “oops we forgot to keep track of Alameda’s margin position” bit.
  [2]
 Bankman-Fried said to Sorkin:
...
A minimal but still pretty bad form of fraud at FTX would be:
	In fact FTX lost its customers’ money through well-intentioned but incompetent bumbling; it just didn’t keep very good track of customer money or risk or anything else.	It lied, constantly, about how carefully it was keeping track of risk and customer money.
...
Maybe this is fine, no problem, just margin lending.
  [4]
...
<a href=""><img src="https://link.mail.bloombergbusiness.com/img/607f07ceef4b8524a319a23chs0f5.5v2f/a17f3182.gif" alt="" border="0" /></a>
