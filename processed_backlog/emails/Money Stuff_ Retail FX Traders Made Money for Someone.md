# Money Stuff: Retail FX Traders Made Money for Someone

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 5 Sep 2023 14:11:24 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Retail FX Traders Made Money for Someone_Tue,_5_Sep_2023_14-11-24_-0400_(EDT)_18a668ad967b93c4.eml
**Processed:** 2025-08-24T19:13:09.553422
...
All the good stuff. I guess one question is how much of this is illegal. The bones of it — “we will trade futures clients with our customers, charge them commissions, close their contracts when their equity gets too low, and route orders we don’t want to other deals” — seems kind of fine? As long as you don’t lie about it?
  [4]
 But the combination, plus the alleged lying, is quite lucrative:
...
Grayscale has bigger plans, though. Specifically it wants to convert GBTC into an exchange-traded fund. If GBTC were an ETF, then it is plausible that:
	People would be able to take Bitcoins out. 	This would collapse the discount, and GBTC would trade more or less in line with its net asset value.	Therefore people wouldn’t take their Bitcoins out, but in fact would put more in, and the GBTC ETF would use its brand name and first-mover advantage to become even bigger. It would become the main way for ordinary investors to own Bitcoin.
...
We  talked about the court case last week, and several readers emailed me to ask: Did Grayscale want to win this case? The math is kind of:
	If GBTC is not an ETF, then it has a perpetually locked-up pot of $16 billion of Bitcoins, paying it 2% per year forever.	If GBTC becomes an ETF, then (1) everyone can take their money out, (2) other Bitcoin ETFs will start to compete with it, (3) ETFs compete largely on fees and (4) come on, no other passive ETF charges anywhere close to 2%.
...
We have   talked about these incentives before. I think that this view is somewhat too cynical, and that Grayscale probably expects to benefit by becoming an ETF (by growing assets under management, by expanding into other related crypto-ETF-y businesses, by saving on legal fees) and wanted to win. (That’s why it did win!) But I take the point. Bloomberg’s Katie Greifeld and Vildana Hajric   reported last week:
...
Grayscale’s Chief Executive Officer Michael Sonnenshein reiterated on Bloomberg Television Wednesday that the firm is “committed to lowering fees when GBTC converts to an ETF,” but declined to specify by how much. 
...
Last Thursday, Sculptor’s former CEO Rob Shafir — who ran the firm for a while between its founder Dan Och and its current CEO Levin —  sent the board an open letter supporting Weinstein:
...
Shafir presumably knows Sculptor’s business and clients better than, you know, I do, and he thinks that at least 50.1% of them would be happy with Weinstein and friends. Still seems like best practices to ask them but what do I know.
Another open question is: What happens next? Sculptor’s stock was trading at about $11.75 as of noon today, and it has been above the $11.15 Rithm deal price for the last two weeks or so. Sculptor has a contract to sell itself to Rithm, contingent on a vote of Sculptor’s shareholders, and as far as the board is concerned I guess it is moving ahead with that vote. There is no date set yet for the vote, but there is a  preliminary proxy statement, and the board has consistently said that it has no reason to engage with Weinstein and that the Rithm deal is still on.
But if Sculptor does hold the vote, will it win? Will the Rithm deal go through? Levin and a few other current Sculptor executives  have agreed to vote their shares in favor of the deal, and  they own about a quarter of the votes, but the rest are up for grabs, and Och and Shafir, who own about 16% between them, are opposed. Meanwhile if you are a disinterested public shareholder just looking for the best price, you get to decide:
	If you vote yes, and everyone else does, then you get $11.15 in cash right away.	If you vote no, and everyone else does, then you don’t get $11.15 in cash, the Rithm deal fails, and maybe the board has to negotiate with Weinstein?

The fact that the stock is at like $11.75 suggests that most shareholders think they can do much better than $11.15, and will vote no on the $11.15 Rithm deal to try to get the $12.76 Weinstein deal, but it is not exactly a straightforward choice between those two deals. Also of course Rithm could agree to pay more — more than $11.15, not necessarily more than $12.76 — to help get the votes.
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] Bucketing stock trades is, in the US, mostly illegal, though elsewhere contracts for differences are pretty common. Trading FX futures is generally fine in the US, though doing it with retail customers is pretty regulated due to, you know, all the fraud. In the complaint I quote below, the CFTC notes that "by acting as counterparty to its customers’ trades, Traders Global is violating Regulation 5.3(a)(6)(i), 17 C.F.R. § 5.3(a)(6)(i) (2022), which requires registration by dealers of retail leveraged forex contracts." The regulation is here.
