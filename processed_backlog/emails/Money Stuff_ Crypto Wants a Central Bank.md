# Money Stuff: Crypto Wants a Central Bank

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 15 Nov 2022 13:03:11 -0500 (EST)
**Source:** inputs/saved_emails/Money Stuff Crypto Wants a Central Bank_Tue,_15_Nov_2022_13-03-11_-0500_(EST)_1847c7960b5b2713.eml
**Processed:** 2025-08-24T19:13:03.936192
...
Several of the other most notable liquidity crises in crypto this year were at firms that were themselves bailed out by FTX and Alameda Research, a hedge fund that was also founded by Bankman-Fried and that was closely associated with FTX. For whatever reason, FTX and Alameda do not seem to have   concerned themselves too much with whether the firms they were rescuing were solvent.
  [2]
 
...
We   talked extensively yesterday about the crisis at FTX. The basic situation is:
	FTX owes customers something like $9 billion.	Its balance sheet — really the combined balance sheet of FTX, Alameda and various affiliates — consists mostly of cobwebs and magic beans.	Where did the money go?
...
Basically if you read these accounts, not necessarily focusing too much on specific hard-to-verify claims, the sense you will get is something like:
	Alameda Research did a ton of trading on FTX. If you — a regular person or a crypto hedge fund — came to FTX to trade, there’s a good chance you were trading against Alameda.	Alameda was not very good at trading. If you traded against Alameda on FTX, there’s a good chance you made money.
...
So he was planning a series of cryptic tweets? “Something like that.”But why? “I don’t know,” he said. “I’m improvising. I think it’s time.”
...
We then examine why fund managers tend to overweight companies whose products they consume and find satisfactory in their portfolio. Among retail investors, a leading explanation that has been proposed in  the literature is behavioral biases related to familiarity or preferences. … Among professional investors, however, it would be surprising if this investment pattern is driven by the familiarity/preference bias, since these investors face higher costs from poor portfolio performance due, for example, to career concerns (Chevalier and Ellison, 1999b). As an alternative, we propose that consumption experiences contain value-relevant information, which may serve as the basis for consumption-induced portfolio choices among investment fiduciaries. … Fortunately, these two channels (familiarity vs. informational advantage) can be empirically disentangled by examining the performance of post-consumption positions, as the two channels lead to different performance implications. The familiarity/preference bias explanation predicts that consumption-induced positions should perform similarly to, if not worse than, other positions; the information-based explanation, on the other hand, predicts that these positions should have superior performance.
Consistent with the information-based explanation, we find that after an automobile purchase, fund-managers’ positions in companies manufacturing the purchased automobiles can better predict these manufacturers’ future stock returns.
...
<a href=""><img src="https://link.mail.bloombergbusiness.com/img/607f07ceef4b8524a319a23choqiu.5v1z/cc111673.gif" alt="" border="0" /></a>
