...
**Date:** Wed, 3 May 2023 15:13:47 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Is ChatGPT Securities Fraud_Wed,_3_May_2023_15-13-47_-0400_(EDT)_187e30916a80c120.eml
**Processed:** 2025-08-24T19:13:03.707907
...
Lots of fun possibilities. But the most immediate way in which ChatGPT is going to be securities fraud is the usual “everything is securities fraud” way:
	ChatGPT is going to be disruptive to some number of businesses and industries.	Some companies will lose money because ChatGPT disrupts their business.	This will be bad, for them, and their stocks will drop.	Every bad thing that happens to a public company can be characterized as securities fraud: “You didn’t sufficiently warn us about the bad thing, so we bought the stock thinking it was good, but then the bad thing happened and the stock dropped, so we were defrauded.”
...
AMC did this, it worked — it got, by its own count, a majority of its shares to vote for the charter amendment — but some shareholders sued and AMC is stuck in a bit of a limbo. (It reached a settlement in the lawsuit, but some shareholders objected to the settlement, and a Delaware judge is  going to hear arguments next month.) The claim in the lawsuit is basically that the APEs are a complicated trick to get around the voting requirements of Delaware law (which is true), and that this should not be allowed (which is debatable).
...
There is an obvious, popular but not particularly good reason to be worried about stock buybacks, which is something like “companies should not spend their money on buying back their own stock, but on building factories and paying higher salaries and researching new products and paying down debt and building up a cash reserve in case of disaster.”
  [6]
 This reason is probably true about some companies at some times, but as a general theory it sort of misunderstands corporate finance. The point of a company is to do some things that (1) it can do and (2) have positive expected value. Some companies — often in the early stages of their lives — have a lot of opportunities and not much cash, so they sell shares to investors to raise cash to pursue opportunities. Many other companies — often in the later stages of their lives — have a lot of cash (from previous successes) and dwindling opportunities, so they give money back to the investors who funded them earlier. It is implausible that a company would always have just enough cash from its previous operations to invest in valuable future projects. Sometimes they have less money than opportunity and sell stock to raise money; other times they have less opportunity than money and use money to buy back stock.
From the investor’s perspective, they buy stock from a company to bet that it will do good business, and then the company buys it back when the bet pays off. If companies could never buy back stock, then the bets could never pay off.
  [7]
 Why would you put money into a company if you could never get it back?
  [8]
...
Today the SEC  adopted new rules on stock buybacks. The rules do three main things. One is that they will require companies to disclose, at the end of each quarter, daily information about how many shares they bought each day of that quarter and at what prices. I suspect that most of the time this will be sort of voluminous and boring, but every so often it will be revealing. (If a company announced bad news one day in the middle of a quarter, did it stop its stock buyback the day before the announcement? A week before? If it did, that seems almost insider-trader-y; the company acted on the news before it announced it. If it didn’t, that seems dumb.)
Another thing that the rules will do is require companies to disclose, each quarter, “the objectives or rationales for its share repurchases and the process or criteria used to determine the amount of repurchases.” This seems like a nod to the theory that stock buybacks are bad because companies should be using the money for better purposes instead: Companies will have to say something like “we decided that a stock buyback is a better use of our cash than other possible uses of cash,” which is clarifying and perhaps embarrassing. Also, in US securities disclosure, it’s something to sue about. When these rules were first proposed in 2021,   I wrote:

“The objective or rationale for its share repurchases” is going to get real formulaic real quick? Part of the point here is just to make it a tiny bit more annoying for companies to buy back stock by making them type this somewhat embarrassing formulaic declaration.
...
Or, I mean, you write in the disclosure “we decided to buy back stock at $50 because we thought the stock was undervalued,” and then something bad happens and the stock falls to $40, and you get sued for saying it was undervalued at $50?
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] Everyone can elect stock, and some outside investors do, though most don’t.


  [3] From Icahn Enterprises’ filings: “Depositary unitholders who elect to receive (or who are deemed to have elected to receive) additional depositary units will receive units valued at the volume weighted average trading price of the units during the five consecutive trading days ending” shortly before the dividend payment date.


  [4] Again using the math from footnote 1. Say that the main shareholder owns 85 shares and everyone else owns 15. Net asset value is $100 ($1 per share) and the market cap is $50 ($0.50 per share) because the stock price has fallen. The company declares a dividend of $45 again, for a whopping 90% dividend yield. The main shareholder takes his dividend in shares ($38.25 of shares); everyone else gets it in cash ($6.75 of cash). The main shareholder gets an extra 76.5 shares ($38.25 divided by $0.50 share price), giving him a total of 161.5 shares; the other shareholders keep their 15 shares. No new shares are sold. The main shareholder now owns 91.5% of the pot, which has a value of $93.25 ($100 minus the $6.75 cash dividend); this makes his stake worth $85.33, up from $85 before the dividend. (This does not always work; if the shares are only slightly undervalued he ends up a net loser.)


  [5] Ann Lipton  gave it this name on Twitter.


  [6] This sentence is implicitly about spending internal cash flow, but there’s a variant on it that is about debt financing, “companies should not borrow money just to buy back stock.” The problem with the one in the text is that it assumes unlimited positive-net-present-value projects that the company can spend money on; the problem with the debt one is that it assumes that the capital structure of every company is already optimal.


  [7] I mean, there could be dividends, but dividends to me are kind of the same thing as buybacks? Except for tax? Others disagree. Still others think that dividends are also bad.
