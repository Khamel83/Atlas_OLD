# =?utf-8?B?TW9uZXkgU3R1ZmY6IEFJIEZ1bmRzIERvbuKAmXQgTGlrZSBBSSBTdG9ja3M=?=

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 22 Aug 2023 14:03:57 -0400 (EDT)
**Source:** inputs/saved_emails/=utf-8BTW9uZXkgU3R1ZmY6IEFJIEZ1bmRzIERvbuKAmXQgTGlrZSBBSSBTdG9ja3M==_Tue,_22_Aug_2023_14-03-57_-0400_(EDT)_18a1e6b0398d0b38.eml
**Processed:** 2025-08-24T19:13:06.507628
...
Take the WisdomTree U.S. AI Enhanced Value Fund, ticker AIVL. … The biggest reason for AIVL’s underperformance? Its AI’s refusal to buy Facebook parent and AI stalwart Meta Platforms — whose shares have soared more than 140% since December, in part driven by the firm’s investment in AI-related technologies.
...
The AI stock picker is skeptical about AI hype. To be fair, the AI stock picker is underperforming the market, which I guess is a reason to be skeptical? “Ehh, I’m an artificial intelligence and I’m not that great, I’m gonna fade this trend,” the very self-aware AI might be saying.
“Since AI models are trained on historical data, one thing they're uniquely bad at is assessing businesses that are changing rapidly — such as, to take a random example, AI itself,”  notes Byrne Hobart. My   general view of this is that human asset managers are also trained on historical data — what other data is there? — and much of finance is about pattern matching, so an AI that is good at pattern matching could be a promising investment manager. But that view is incomplete: Investing is partly about remembering and understanding how this thing is like previous things, but it is also about noticing when this thing is different from all the previous things. Investing is pattern matching and imaginative leaps, and the AI is bad at imagination.
Or maybe another way to think about it is that human investors have two things:
	The ability to learn from past data, and	A tendency to emotionally overreact to new data.
...
Elsewhere in AI, here is a story about how AI, while it might be bad at picking stocks, is   really good at committing fraud:
...
I guess if I were a malevolent AI model plotting to get funding to take over the world, deepfake frauds would be an easier way to get it than picking stocks? Investing requires understanding patterns of human behavior but also, to some extent, avoiding them yourself; fraud is about understanding patterns of human behavior and then mimicking them precisely. Apparently — somewhat counterintuitively — that’s easier for a robot.
Also elsewhere in AI, here is a story about how companies talk a lot about their use of AI in earnings calls but  not in financial reports:
...
If you buy a stock on Monday morning for $100 and it closes that afternoon at $101, then you have a one-day return of 1%, which is an annualized return of roughly 1,100%.
  [2]
 On Tuesday, you can go out to potential investors and say “hello I am an incredibly skilled investment manager, I have achieved an 1,100% annualized return so far this year, invest with me,” and maybe they will. If the stock keeps going up 1% every day, then in a year it will be worth $1,227.40 and your investors will be thrilled. What are the chances of that? Not zero, I guess. But pretty low.
Oh, I’m kidding, you can’t do this:
	People are not that dumb, and no one is going to “annualize” a one-day return, get a huge number, and believe it. Stocks go up, and they go down. If your investments go up 1% in a day, that doesn’t mean that they will go up 1,100% in a year. They’ll only go up 1,100% in a year if they go up 1% every day, and that’s a hard streak to maintain.	Whether or not anyone believes you, you will get in trouble with the regulators if you market your fund this way.
...
Titan settled for about $1 million. It is not clear how much, if any, money Titan actually raised from these advertisements. But really if you were advertising 2,700% annual returns on a crypto investing product in 2021, that looked pretty conservative? Here is a November 2021 Medium article titled “How to Stake TIME on Wonderland.Money for  83,190% APY,” and people absolutely did that, and that annual percentage yield absolutely did not last for a year.
  [3]
...
My basic answer, and I think the traditional answer, is that everything is securities fraud: If a public company, or its CEO, makes a public statement about the company, and that statement is not true, then shareholders are going to sue for securities fraud. I should qualify that a little: If the stock goes up when the CEO makes the statement, and then it goes down when the statement turns out to be false, then that is probably securities fraud; if the market doesn’t react either way then it’s not. I just think that in 2023, there are some CEOs who are pretty active on social media, who communicate material news there first, and so shareholders tend to follow them on social media and react to what they post. And if what they post is lies, then the shareholders will be angry, I think justifiably.
On the other hand, for many people, social media is a place to blow off steam and exaggerate and communicate spontaneously and carelessly. And some CEOs are in both categories: They post material news about their companies on social media, and they also tweet spontaneously and carelessly. They understand that an earnings release needs to be carefully reviewed by lawyers and accountants to make sure it is correct, but they just kind of tweet whatever.
This strikes me as a genuine problem! Elon Musk is of course the main example of this: He has often announced material news on Twitter/X, including the news that he was planning to buy Twitter. But he also regularly trolls and makes jokes and is sarcastic and gets in hyperbolic late-night fights on Twitter/X. And these things overlap: He has often   tweeted things about Tesla Inc. that aren’t true; sometimes this gets him in trouble with the US Securities and Exchange Commission (because the SEC thinks these tweets are material and misleading), but sometimes it doesn’t. When Musk   tweeted that a new Tesla model would fly, the SEC did not sue him for fraud, because I guess the SEC figured it was a joke. But Musk also periodically tweets that Teslas will soon be fully self-driving, and it keeps not being true, and the SEC has apparently considered taking action over those claims, because I guess the SEC thinks they might be misleading. There is no really bright line.
Or   last month we talked about a weird decision in a securities fraud lawsuit against Bed Bath & Beyond Inc. and Ryan Cohen, who was for a while a big shareholder of the company. At some point Cohen tweeted a moon emoji; shortly thereafter, he dumped all his stock. Shareholders sued claiming that the moon emoji was fraud, Cohen moved to dismiss the lawsuit, and a judge ruled against him, finding that the plaintiffs had “plausibly alleged that Cohen’s tweet was … an expert insider’s direction to buy or hold.” I do not think that’s right, though a federal judge did. But I could imagine contexts in which it would be right, in which tweeting a moon emoji really would be securities fraud. No really bright line.
Anyway here are an  article and related  blog post by law professor Christine Hurt about “socially acceptable securities fraud”:
...
I sympathize. I once   wrote about Musk:
The argument here is that Musk should be free to tweet anything “aspirational and forward-looking” that pops into his head about Tesla, and investors should be trusted to “use caution in evaluating” those tweets and to give them “a strong presumption of immateriality.” And … shouldn’t they? Isn’t that the right answer? Shouldn’t Musk just keep tweeting, and shouldn’t investors ignore him and get their financial data only from earnings calls and press releases and securities filings? I realize that it’s not that simple: Modern markets just inevitably react to information, and if you want to be an informed trader of Tesla stock you really don’t have much choice but to parse Musk’s statements for their likely truth. Still it does feel like it would be the right outcome. Reasonable investors, in a reasonable world, really would ignore the tweets. Or they’d like to, anyway.
I am just not sure how it could work. You can’t actually ignore Musk’s tweets, or Cohen’s, because sometimes they contain true material information that is not yet published anywhere else. Other times, they don’t. The traditional solution is not to say “well, if you lie about it in a tweet, that’s fine.” The traditional solution is for CEOs to be very buttoned-up and only disclose material information about their companies in carefully lawyered public statements, and then blow off steam, like, in person, at the golf club, with their friends.
  [5]
