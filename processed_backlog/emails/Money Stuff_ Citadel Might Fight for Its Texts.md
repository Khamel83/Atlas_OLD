# Money Stuff: Citadel Might Fight for Its Texts

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Wed, 27 Sep 2023 14:39:50 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Citadel Might Fight for Its Texts_Wed,_27_Sep_2023_14-39-50_-0400_(EDT)_18ad7f0c86406c75.eml
**Processed:** 2025-08-24T19:13:13.422653
...
But you can see why the SEC loves its current rule, Gensler’s rule, the one about all communications being on preserved official channels. There are two reasons:
	This rule is really good for regulation and enforcement. If all business communications have to occur on official channels and be preserved, then the SEC will have an easy time investigating misbehavior: If it has any suspicions about anything, it can call a firm and say “give me all the messages that Employee X sent about Topic Y last year,” and the firm will run a search and hand over the messages. It can call every firm and ask them that. The firms themselves will do it voluntarily: Their compliance people will constantly run searches on their internal messages, looking for keywords like “fraud” or whatever, and then hand anything bad over to the SEC. There are not a lot of areas where every crime is meticulously documented in written electronic messages that are preserved and handed over to regulators. Obviously the coverage is not perfect, and there will still be golf courses and in-person meetings, but I suppose in the long run technology (goggles, etc.) might stamp those out too and the SEC will achieve a perfect panopticon.	This rule is new, so it is lucrative. Financial firms and their employees really did not know about the SEC rule that nobody could use WhatsApp to message their colleagues, because, again, that’s a somewhat novel interpretation of the actual rules. And so when the SEC decided, in about 2021 — when everyone was working from home due to Covid and sending lots of text messages — that texting about work was illegal, every single bank was doing illegal things. And so the SEC could just kind of go down the line and extract a $125 million fine from each of them. It didn’t have to prove any bad behavior: It got samples of the bankers’ text and WhatsApp messages and, as far as I can tell, never found a single text message relating to any sort of misconduct. It just had to prove that there were text messages about business and, boom, $125 million. “It is not literally the case that the US Securities and Exchange Commission is a for-profit business whose goal is to maximize its revenue,”  I once wrote, about this business, but, man. This is a profitable business.

The SEC extracted all of those fines through settlements with the banks. I suppose the banks could say “no, see you in court,” but I don’t think any have. The SEC’s interpretation of the rule is aggressive, but it’s logical, and it is pretty risky for the banks to fight the SEC on this.
Anyway this rule is so good that, after fining the banks $125 million each for violating it, the SEC has moved on to other financial firms. It has long  been reported that hedge funds, private equity firms and other investment managers  are next: There are a lot of them, they have deep pockets, surely they’ve sent some text messages. It would be good, for the SEC, to extract money out of them, and it would be good to apply Gensler’s rule to them going forward, so that if they do any crimes in the future they will have meticulous records of those crimes to hand over to the SEC.
There is a bit of a problem with moving on to investment managers, which is that Rule 17-4(b)(4) — the rule that requires broker-dealers to preserve their communications, and that the SEC uses as the basis for its “only official channels” rule — does not apply to investment managers. Investment managers do have a communications-preservation rule, Rule 204-2(a)(7), but it is narrower, covering external communications about specific topics (investment recommendations and advice, trade orders, etc.), not the manager’s “business as such.” In January a bunch of asset-management trade associations sent a letter to the SEC arguing “that the SEC is attempting to exceed its authority under the Advisers Act andengaging in rulemaking by enforcement through its current sweep regarding off-channel communications,” and that Rule 204-2(a)(7) does not cover the sort of intra-desk text messaging that the SEC has been going after at the banks.
Still I basically assume that the SEC will just go down the line extracting flat but lower-than-$125-million fines from all the hedge funds, private equity firms, etc. But maybe not? Bloomberg’s  Austin Weinstein reports:
...
The schematic math of the Sculptor Capital Management Inc. situation is:
  ...
  [1]
	...
	A bit less than $0 per year goes to Sculptor’s shareholders: The firm reported net losses in each of the last two years.	Being a Sculptor hedge fund manager is quite lucrative, but being a Sculptor shareholder is not particularly.	This is not a weird anomaly! Being a hedge fund manager is lucrative, and Sculptor is a hedge fund management firm that employs hedge fund managers. Most hedge fund management firms are privately held, and roughly all of the money goes to the managers. To compete for talent, Sculptor also pays roughly all of its money to its managers. The shareholders get squeezed. Jimmy Levin did not invent this or anything. Dan Och, Sculptor’s founder and former CEO/CIO, “took home $3.3 billion since 2007 as Sculptor’s stock price tanked by 96%.” That’s just how it works!	The result is that Sculptor’s stock price is fairly cheap, since the cash flows to shareholders are a bit less than zero.	But if you buy all of Sculptor, you can make yourself the CEO, and pay yourself all the fees.
...
But why would the clients want to own the firm? I feel like the lesson of Sculptor is:
	A well-run hedge fund probably makes money for its clients. (Though Sculptor’s “main fund has annualized at about 6% since 2018, and its returns more closely track the S&P 500 than other multi-strategy firms,” report Burton and Parmar.)	It definitely makes money for its managers.	The shareholders of the management company, not necessarily?
...
This year US   regulators have brought   cases against Binance, the world’s biggest crypto exchange. When the SEC sued Binance,   I wrote that Binance’s somewhat cynical attitude to US regulation seemed smart:
Binance noticed that it's illegal to run a crypto exchange in the US, and did it anyway, but minimized and compartmentalized its US exposure: It has relatively few US customers and seems to keep most of its business out of the US.
Well. You can keep your business out of the US, but you can’t keep the US out of your business. Today the Wall Street Journal has a report on how things are going at Binance. “The World’s Biggest Crypto Firm Is Melting Down,” is the headline:
...
Pressure from the DOJ was partly responsible for [Binance co-founder Changpeng] Zhao’s decision to begin winding down Binance’s business in Russia, once one of its most important markets, the person said. Over the following two weeks, Binance barred customers from using the sanctioned banks and forced out the executives managing its Russia business. It said it was considering a full withdrawal from Russia.
...
How about that! There’s a list of names. Do you know who is not on it? Last year, Elon Musk  bought $2.6 billion worth of stock in Twitter Inc., as the first step in ultimately buying the company. This triggered a requirement that he file a disclosure form, which he did 11 days late, buying more stock in the meantime. When he did file the form, the stock went up a lot, because the market correctly assumed it meant he would buy the rest of Twitter. By waiting to disclose his purchases until he was done, Musk personally  saved about $143 million. And today the SEC brought cases against six other people for late filings on transactions that totaled $90 million. Okay! 
At this point I should submit a whistleblower claim.
  [2]
...
Man, crypto in 2021 was just wild. For one thing, people would make stuff up — new cryptocurrencies, new JPEGs — and sell them for millions of dollars. But also, like, math became kind of woozy, and you could take a crypto thing with a market value of $75 and wave your hands around for a bit and sell it for $100. There were perpetual motion machines everywhere.
Or not. El Salvador tried it, but they never actually sold the bonds, and now it is 2023 and Frank Muci reports:

The proposal to tokenize a sovereign bond on a blockchain is now officially dead. This summer, Forbes contributor and Tether/Bitfinex spokesperson Javier Bastardo wrote that El Salvador will “tweak the investment scheme from issuing public debt [the volcano bond] to private equity funding rounds by the Volcano Energy initiative [a joint venture with the government, private firms and crypto companies]”. 
In other words, some joint venture will raise equity to fund wind and solar energy capacity, but there won’t be debt or a bond. There won’t be geothermal energy from the volcano as originally advertised either, oh well. This post is an obituary, a requiem for the volcano bond and the insanity that was crypto just two years ago. 
