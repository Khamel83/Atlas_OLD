# Money Stuff: Sculptor Sticks With the Deal It Knows

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Mon, 18 Sep 2023 14:46:53 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Sculptor Sticks With the Deal It Knows_Mon,_18_Sep_2023_14-46-53_-0400_(EDT)_18aa99e04680427e.eml
**Processed:** 2025-08-24T19:13:05.611981
...
The shareholders of publicly traded hedge fund management firm Sculptor Capital Management Inc. have a choice between two options:
  ...
  [1]
	...
	Somebody else has offered to buy Sculptor for $12.76 per share. Sculptor’s board of directors says that this offer is too risky: Its financing is uncertain, and this offer (like Rithm’s) is conditional on at least a majority of Sculptor’s hedge fund clients approving the new owner. Sculptor’s board says that the clients might not approve the new owner, in which case the $12.76 deal would fall apart and shareholders would be left with nothing.
  [2]
...
We have   talked   about this   deal a   lot around   here. I am being cute, saying that “somebody else” is bidding $12.76. I know who it is, and so do you probably. It has been   widely reported in the media. It’s a group led by Boaz Weinstein of Saba Capital Management and including his buddies Bill Ackman (Pershing Square Capital Management), Marc Lasry (Avenue Capital Management) and Jeff Yass (Susquehanna International Group).
But Sculptor is also being cute. Its revised  proxy statement on Thursday does not name Weinstein, Ackman, Lasry, Yass or their firms. It calls them “a consortium of bidders led by the founder of Bidder J,” and a footnote to that description explains:
The Company is party to a customary NDA [nondisclosure agreement] with Bidder J, entered into on December 21, 2022, that prohibits the Company from publicly disclosing the identity of Bidder J or any members of the Consortium. All NDAs entered into by the Company with other potential acquirers include a similar prohibition.
I mean, sure. There is an NDA, which prohibits Weinstein from making a public bid for Sculptor, and which technically does prohibit Sculptor from identifying Weinstein. But either side can waive the NDA. Actually Sculptor can’t waive Weinstein’s NDA; the merger agreement with Rithm   prohibits it from waiving Weinstein’s NDA.
  [3]
 But Weinstein can waive Rithm’s obligations, and presumably wants to: He wants his bid for Sculptor to be public, he can't make it public, but Sculptor can, in its proxy statement. If Sculptor asked Weinstein “hey I know we have an NDA but can we mention your name in our proxy so that shareholders can be fully informed about the situation,” presumably he would say yes.
That is what is weird here. Sculptor’s shareholders have to vote on the future of the company; in some loose sense, they have to choose between a safe deal at $11.15 and a riskier one at $12.76. Strictly speaking, that’s not quite true: Their actual choice — the thing they are actually voting on — is between accepting the $11.15 deal and not accepting it. If they vote down the Rithm deal then the board might go back and get them Weinstein’s $12.76 deal, or a different deal with Weinstein, or a different deal with Rithm, or a different deal with a third bidder, or no deal at all.
But their rough practical choice is between taking Rithm’s safe deal and chasing Weinstein’s risky deal. And Sculptor has sent them a proxy statement to inform their vote, which lays out all of the details of Rithm’s safe deal. But it is weirdly coy about Weinstein’s riskier deal. It summarizes Weinstein’s proposals and the board’s concerns, but it does not actually quote Weinstein’s bid or give any details. It doesn’t even name Weinstein or his friends. It is hard for shareholders to make an informed choice if you don't tell them their options.
Also, I mean. Sculptor’s stock closed at $12.02 on Friday. That suggests that shareholders are not choosing the Rithm deal
  [4]
:
	If you paid $12.02 for Sculptor stock last week, you are not hoping to sell it for $11.15.	If you think that $11.15 is a good price for Sculptor stock and Weinstein’s bid is hopeless, you should not hold on to your stock and vote for the $11.15 Rithm deal. You should sell the stock now for $12.02! 

If I were Sculptor’s board of directors, this would worry me. If I really thought that the Weinstein deal was too risky and that Rithm was the way to go, I would be concerned that the shareholders don’t seem to believe that. I’d want the proxy to be really clear about the problems with Weinstein’s bid, and about why it would never work. I’d want to at least name him!
Anyway, as we have discussed a lot, Sculptor's board sees two main problems with Weinstein’s bid. One is about the financing. The board has raised various complaints about the contingency and inadequacy of the financing, and Weinstein and friends have kept answering those complaints by putting up more money, and Sculptor has kept finding new complaints. The latest proposal from Weinstein, on Aug. 31, provides “that the $743 million of financial obligations of its newly-formed shell entity would be guaranteed by a single member of the Consortium,” but Sculptor objects that “the proposed form of guarantee was not a standard unconditional guarantee to fund all obligations of the Consortium buyer when and as required under the definitive transaction documentation.” This strikes me as a strange objection: At this point Weinstein’s deal is fully financed by one member of his consortium, presumably one that is at least as creditworthy as Rithm,
  [5]
 so this just does not seem like a thing shareholders should worry about.
The other, more serious objection is about client consents. Weinstein’s deal would require 50.1% of Sculptor’s hedge-fund clients to consent to the deal; if a majority of clients say no, then Weinstein can walk. Meanwhile the Rithm deal requires 85% of clients to consent, which is more, but the board argues that it is more likely to get 85% with Rithm than 50.1% with Weinstein. The reason for this is pretty straightforward: If Sculptor sells to Weinstein,   he will be in charge, whereas if it sells to Rithm, Sculptor’s current boss, Jimmy Levin, will remain in charge of its hedge funds. Sculptor’s board thinks that its clients are happy with Levin and will consent to a deal that leaves him in charge of their money, but that they will not consent to a deal that puts someone else — Weinstein and friends — in charge of their money.
A couple of points here. First, this is pretty reasonable? Like, just, intuitively, it does make sense that the clients of a hedge fund firm would want their money to be managed by that firm’s manager, and not by some other hedge fund manager. Hostile takeovers of hedge funds are rare. Presumably investors who want Boaz Weinstein to manage their money, and not Jimmy Levin, would have just invested with Saba instead of Sculptor. The ones who are still invested with Sculptor probably prefer Levin. But “probably prefer Levin” is not quite the same as “would not consent to Weinstein.”
Second, Sculptor’s board proposed a way for Weinstein to solve this issue, which is not to make the deal conditional on consents. It  told Weinstein:

If [the Consortium] believe[s] that [its] members’ reputation and experience are such that clients would in fact grant their consent, then [the Consortium], and not the Company’s stockholders, should bear the risk of obtaining the client [run-rate] consents. …
In order for the Special Committee to be able to determine that a transaction with [the Consortium] would have a high likelihood of being consummated, all client [run-rate] consent conditions to be removed from the merger agreement in their entirety and the draft merger agreement should clearly place the risk of business deterioration due to the announcement of the transaction (including the risk of adverse client and employee reactions) on the [Consortium].

That is a bit harsh for Weinstein and friends, since it might require them to pay $700 million to buy a hedge fund with no clients. It is also not at all customary in asset-management deals; in fact, when Sculptor put itself up for auction, “the auction draft merger agreement” — the terms that Sculptor proposed to every potential buyer — included a client consent condition with an 80% threshold.
  [6]
 It is odd for Sculptor to now say that the terms that it proposed are unacceptable. Still, though, it’s a plausible proposal: If the board really thinks that clients won’t consent, and Weinstein thinks that they will, then Weinstein could take that risk on himself.
Third, though, I have said this before, but if I were Sculptor’s board I would really want to find out. I would be very nervous, if I were the board, about turning down Weinstein’s offer. For one thing, it’s higher: $12.76 is more than $11.15, and my job as a director is to get the highest price for shareholders.
For another thing, it looks really bad: The board isn’t just turning down a higher offer for a lower one; it’s turning down a higher offer for a lower one that preserves Jimmy Levin’s job. That is a classic conflict of interest; Sculptor's estranged founder Dan Och  has said that the board “remains beholden to management and is failing to act in the best interests of shareholders,” and the board is already   getting sued. From the beginning, the board took pains to say that it was selling the company to the highest bidder, without caring at all about Jimmy Levin’s future employment: It ran an auction process with dozens of potential bidders, and told them all “that interested parties would not be required to retain any Company personnel following the closing of the potential transaction” and “to refrain from discussions or negotiations with the Company’s management regarding go-forward employment terms and/or management rollover.”
But now, faced with the choice between a lower bid that keeps Levin and a higher bid that doesn’t, it turns out that Levin is essential. In August, Sculptor sent Weinstein a letter saying
  [7]
:
[The Special Committee and its advisors] have consistently communicated that retaining the Company’s management is not a condition to acquiring the Company. However, deal certainty is. As [the Consortium] know[s] well from running [its] own asset management business, clients care about who is managing their money. 
So you might think that the board would try very hard to find out if the clients would be okay with Weinstein running their money. “Given the large concentration of revenue run rate in a small number of clients, a small number of clients failing to provide consent could result in a failure to satisfy the Consortium Client Consent Condition,” says Sculptor, but that also makes the problem kind of easy: Just ask the small number of big clients “hey would you be okay with the Weinstein deal?” (Maybe ask Weinstein to waive the NDA first!) If they all say “yes” then you take the Weinstein deal. If they all say “no” then (1) you stick with the Rithm deal and (2) you call Weinstein up and tell him that. Presumably he doesn’t want to buy Sculptor if there are no clients left. He thinks he can keep the clients, but most hedge fund managers are pretty confident. Maybe he’s wrong. But if he’s wrong you can find out and tell him!
The weirdest thing about this deal is that Sculptor does not seem to be doing that. It is sort of … hinting at that? In a Sept. 5 meeting, the board “discussed with its advisors that … based on feedback from clients to the client relations team, a number of clients of the Company had already raised concerns about the potential for changes to the Investment Function” from the Weinstein deal. But “a number of clients raised concerns” is not the same as “clients responsible for most of the assets said no.” Sculptor does not seem to have systematically polled its clients, or gotten any definitive answers — just unspecified concerns from an unspecified number of clients. 
The board, though, is not relying solely on anecdotal feedback from the client relations team. It also hired a consultant to assess the risk of not getting client consents:
...
What did the consultant come up with? Something very odd:
The Asset Management Consultant noted that typical drivers of client loss following a change of control include (i) departures of key persons and/or destabilization of an investment team, (ii) material changes to the Investment Function and (iii) concerns about overall firm governance and ownership.
What? “Typical drivers of client loss”? Like, if I were on the board, here is the conversation I would want to have:

Board: How many of our clients will leave if we sell to Boaz Weinstein?
Consultant: Like 60%.
Board: How do you know?
Consultant: We asked them.
  [8]

Board: Okay fine we’re sticking with $11.15.

Here is the conversation they apparently had instead:

Board: How many of our clients will leave if we sell to Boaz Weinstein?
Consultant: Typically when a hedge fund has a change of control, some number of clients leave due to diverse reasons including but not limited to departures of key persons, destabilization of investment teams, material changes to the investment function and concerns about overall governance and ownership.
Board: I’m satisfied, no further questions from me, let’s stick with $11.15.

The consultant didn’t answer the question! Or, I mean, maybe it did, but Sculptor won’t say so in the proxy. I don’t understand it. Surely the whole ballgame here is:
	Figure out how many of your clients would leave if you agreed to sell to Boaz Weinstein.	Tell shareholders the answer.
...
But it is a very Elon Musk financing mechanism. Two essential tenets of the Elon Musk approach are:
	Be super, super, super, super confident in yourself, and	Always be about to run out of cash.
...
The result of this is that the PE fund is a series of somewhat independent bets on different businesses, and each bet has high variance: There is some chance that the bet will go to zero (the company is very levered, it fails, and the PE fund loses its entire investment), and some chance that the bet will return 1,000% (the company is very levered, it succeeds, and the PE fund gets back 10x its equity investment). Whereas in a traditional conglomerate the bets have less variance and are more likely to cancel each other out: Losses at one business are a drag on the other businesses in a way that isn’t exactly true for a PE fund full of independent bankruptcy-remote companies.
  [10]
 “A basket of options is worth more than an option on a basket,”   I sometimes say; a PE fund is more like a basket of options, while a conglomerate where all the businesses support one another is more like an option on a basket.
On the other hand, once you own a bunch of companies you don’t actually want to give up on the ones that are struggling. The  Financial Times reported last week:
...
Limited liability at the company level is an essential part of the private equity model
  [11]
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] I mean? They’d be left owning shares of Sculptor, which is maybe valuable even without a deal, though nobody seems super confident in that. Also they might be able to try Rithm again. But the point is that if Sculptor signed the consortium deal and clients fled, then (1) the consortium deal would fall apart and (2) so would Sculptor probably.


  [3] Actually Sculptor *can* waive Weinstein’s NDA; it just has to get permission from Rithm first. Presumably Rithm would say no, but Sculptor doesn't say if it has asked.


  [4] Now the stock has only traded like 7 million shares since Weinstein’s bid became public and it jumped above the Rithm deal price; if you wanted to get out of a big position at above $11.15 it would take you some time.
