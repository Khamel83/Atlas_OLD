# Money Stuff: AMC Goes APE

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Tue, 23 Aug 2022 13:38:35 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff AMC Goes APE_Tue,_23_Aug_2022_13-38-35_-0400_(EDT)_182cbca1c1a3cd73.eml
**Processed:** 2025-08-24T19:13:10.355429
...
My basic meme-stock corporate finance advice is that, if you are a public company, and people want to pay a lot of money for your stock for no real reason, you should sell it to them.
  [1]
 If your stock is overpriced, you should sell it. This is good for your existing shareholders, because you are selling shares for more than they are worth, which is accretive. It is bad for the people buying the shares from you, because they are overpaying, but on the other hand they were going to buy the shares anyway from someone else on the stock exchange, so they might as well buy them from you instead.
...
AMC sensibly tried to address this problem by  asking shareholders to authorize 500 million new shares, but shareholders objected
  [3]
 and AMC ultimately withdrew the proposal. So it is stuck with the shares it has. (I   once proposed that it should issue its last available share for millions of dollars, because there is a ton of meme value to owning the last AMC share, but I guess I was kidding?)
On the other hand, AMC has preferred shares. Its  certificate of incorporation authorizes it to issue up to 50 million shares of preferred stock, and like most companies it hadn’t issued any.
  [4]
 As is typical for public companies, this is what is called “blank-check preferred”: The board of directors can decide how much to issue, what its rights are, how much to sell it for, etc., without shareholder approval. This is a pretty significant loophole. What the board can do is issue preferred stock that looks like common stock. Specifically:
...
This all sounds weird, when I write it down like that. But it is actually a pretty well-known technology, in the niche world of companies without enough authorized shares.
  [5]
 Surely lots of bankers and lawyers pitched it to AMC. Yesterday   AMC did it:
...
Specifically, the trade was to (1) authorize 1 billion new APE units, each of which is equivalent to one common share and (2) issue about 516.8 million of them to holders of existing AMC common shares as a dividend. So if you owned an AMC common share on Friday, on Monday you owned an AMC common share plus an APE unit. That is “in effect” a 2-for-1 stock split: Each APE unit has the same economic and voting rights as a common share, so you went from owning one common share to owning two-ish common-ish shares.
  [6]
 
In practice, this is all a bit strange, and the APE units trade at a discount. AMC’s common stock closed at $10.46 yesterday; the APEs closed at $6.00. (AMC closed at $18.02 on Friday, before the split, so the total package was down about 8.7%.) As of 11 a.m. today the APEs were up (to about $6.53) and the AMCs were down (to about $9.91), and you might expect to see a certain amount of convergence if AMC’s shareholders agree that the APEs are equivalent to the common stock.
  [7]

But the point isn’t really the stock split. The point is that now AMC has 483 million APE units that it hasn’t issued. At yesterday’s APE closing price, that’s $2.9 billion worth of stock to play with.
  [8]
 In its  Frequently Asked Questions about the APE dividend, AMC does some foreshadowing:
...
A few other points. First, the ordinary approach with this sort of thing would be to try to convert the APEs into AMC common shares as soon as possible. AMC has in the past tried to get shareholder approval to issue new shares, but it has been rebuffed. Now, though, it has a fait accompli: It can go to shareholders and say “look, these APEs are already trading, but they are trading at a discount in annoying ways, so you might as well give us permission to issue more common shares so we can go back to having a single share class.” Maybe that will work.
  [9]

But AMC doesn’t have to do that, and it has no immediate plans to. From the FAQ:
...
AMC is a meme stock, and APE is — potentially — a very meme-y security indeed. Why not see what happens? Maybe AMC can extract more value from APE by leaving it as its own separate class of stock. The business of being a meme stock is largely about getting attention, and having a weird APE unit might be more attention-getting than having one class of stock would.
Second, is there an AMC/APE arbitrage trade? You might take a view like: “APE shares have the same economic and voting rights as AMC common shares, and will eventually be convertible into common shares, but they trade at a big discount. I should short AMC shares, buy the same number of APE shares, and profit when the gap closes.” Good luck to you with that one! I will not comment on it as a thesis except to say that AMC’s retail shareholders seem to be endlessly angry about short sellers, so if you short AMC stock as part of an arbitrage trade they will probably be endlessly angry at you.
  [10]

Third, speaking of being endlessly angry at short sellers: One tactic that we have talked about from time to time around here is that a company with a lot of short sellers can issue an inconvenient weird dividend to make life difficult for the short sellers. The way short selling works is that, to short stock, you have to borrow it, and when you return it you have to give your lender back whatever they would have gotten from holding the stock. So if a stock pays a $1 cash dividend, then short sellers need to pay $1 to their share lenders. If a stock does a 2-for-1 split, short sellers need to return twice as many shares as they borrowed to close out their shorts.
And if a stock pays a dividend of, say, seven magic beans per share, then the short sellers need to go out and find seven magic beans to deliver to their share lenders. For instance, in 2019, Overstock.com Inc. tried to do a special dividend of preferred stock that traded only on its own blockchain platform, and that was not tradeable at all for six months. A short seller would need to go buy shares of that stock to deliver to her share lenders, but she couldn’t, because it didn’t trade. “Aha, got you,” Overstock more or less cackled, and the shorts were squeezed, though eventually this plan collapsed under the weight of   general Overstock insanity.
This is not that at all! APE trades liquidly on the New York Stock Exchange, this is more or less a stock split, and it will be very easy for short sellers to deliver APE to their lenders. Instead of buying back a share of AMC, they’ll just have to buy back a share of AMC plus an APE unit. An AMC share plus an APE unit this week cost less than an AMC share did last week, so this is good for the shorts, so far. Still I am mentioning it here because there are various incomprehensible conspiracy theories about AMC short sellers, “phantom shares,” etc., and so it is just about possible to say “aha, issuing an APE dividend will flush out all the phantom shares and catch the nefarious short sellers!” I don’t know. Here’s  the Wall Street Journal:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] Would it want to? One rough analysis of a meme stock is that retail investors enthusiastically buy it at prices disconnected from fundamentals. But if you are trying to, say,   lure Amazon executives to senior leadership roles at your meme-stock company, they might *not* want to be paid in meme stock. They might think it is overvalued. Arguably people who want to be paid in meme stock are not the people you want to hire? I could see the argument the other way. Meanwhile owners of small gold mining companies might want to be paid in meme stock, who knows. But surely the *main* use of meme stock, for the issuer, is selling it for cash to retail investors in at-the-market offerings. That’s where you get the most bang for your meme buck.


  [3] Why? I don’t know. It is conventional to say that shareholders don’t want to be diluted, and I guess that is right, but it’s kind of weird: If the stock is soaring for no reason, it is accretive for existing shareholders to issue more stock. (I suppose if you’re an existing shareholder you might disagree that the stock is soaring for no reason?) The other thing that is going on here is that this amendment requires approval of a majority of the *outstanding shares*, so any shares that don’t vote are effectively counted as votes against the amendment. AMC stock is mostly held by retail investors, and it is widely assumed that retail shareholders mostly don’t vote their stock. And in fact if you look at the results of AMC’s shareholder voting this year — on routine matters like electing directors and approving executive pay — only about 145 million shares (out of 516 million) were actually voted. So it might just be impossible for AMC to get a majority of its shares to vote for *anything*.


  [4] There are also 75.8 million authorized shares of Class B common stock, none of which are outstanding: They were owned by Dalian Wanda Group Co., which converted and sold them in May 2021. I suppose AMC could re-use those shares, but they have super-voting rights so that is not really ideal.


  [5] When I was an investment banker, I advised companies on issuing convertible bonds and other equity derivatives. Surprisingly often — not a lot, but more than once — we would run into companies without enough authorized shares to fully convert their convertibles. “Have them convert into common-equivalent preferred stock, then get shareholder approval for more shares” was kind of the go-to advice there, sometimes with a penalty interest rate on the preferred (or the convertibles) if you don’t get the shareholder approval soon enough. This is not a thing that companies do every day, but in the world of arcane equity financing it is not *that* arcane.


  [6] The legal terms of the APE units are in the certificate of designations for the preferred stock and the deposit agreement for the units. Here are the Aug. 4  press release announcing the APEs, and the  Form 8-K with more details.


  [7] Often when a company has two share classes, one will trade at a premium for liquidity reasons. Intuitively you might expect a common stock to be more normal and more liquid than a weird preferred stock: If someone wakes up one day and says “I’d like to buy AMC,” they’ll buy AMC common, not APEs. And so the APEs trade at a discount. But the APEs are listed on the New York Stock Exchange, just like the common stock, and they have a fun name and a fun ticker and a lot of hype, so you never know. Yesterday about 151 million AMC shares traded, versus about 123 million APEs, so it’s not that far off.


  [8] As a corporate finance matter I would never, ever, ever want to go around saying that a company’s authorized but unissued stock is “worth” the market price times the number of unissued shares. It does not work that way at all! If a company issued hundreds of millions more shares, the price would go down. Still in the limited meme-y case of AMC, where they had tons of demand for their stock and no supply, creating supply does seem like it could lead straightforwardly to selling that supply for money.


  [9] But probably it won’t — see footnote 3.
...
<a href=""><img src="https://link.mail.bloombergbusiness.com/img/607f07ceef4b8524a319a23ch5rk8.5yyb/0c029cfe.gif" alt="" border="0" /></a>
