# =?utf-8?B?TW9uZXkgU3R1ZmY6IEEgU3RvY2sgRg==?=
 =?utf-8?B?dW5kIFRoYXQgQ2Fu4oCZdCBHbyBEb3du?=

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Wed, 19 Jul 2023 13:47:54 -0400 (EDT)
**Source:** inputs/saved_emails/=utf-8BTW9uZXkgU3R1ZmY6IEEgU3RvY2sgRg===
 =utf-8BdW5kIFRoYXQgQ2Fu4oCZdCBHbyBEb3du=_Wed,_19_Jul_2023_13-47-54_-0400_(EDT)_1896f44106123793.eml
**Processed:** 2025-08-24T19:13:13.217680
...
A well-known bit of derivatives magic — a great, simple party trick that derivatives structurers can use to impress their friends — is that if you give me $100 today, I can invest $91 of it in two-year Treasury notes paying 4.75% interest, and in two years I will have $100.
  [1]
 And I can invest the other $9 in two-year at-the-money
  [2]
 call options on the S&P 500 stock index, options that gain value if the S&P goes up over those two years. Those options cost, let’s say, 13% of the price of the S&P today,
  [3]
 so spending $9 on options will get me an option on about $70 worth of the index. And so I can offer you the following trade:
...
Of course as interest rates have gone up, products like this are in some sense less attractive: Putting up $100 and getting back $100 in two years is worse if I missed out on 4.75% interest than it would be if interest rates were zero.
  [6]
...
People love electric-vehicle stocks, or at least they used to, so Fisker tops up its cash by selling stock. Last year it announced an  at-the-market offering in which it would sell up to $350 million of stock, on the stock exchange, at market prices; it  terminated that offering last week after selling about $327 million of stock. It replaced that plan with a new, far more complicated plan to sell between $340 million and $680 million worth of stock. (Here is  the 8-K announcing this plan, and here is  the prospectus.) It goes something like this:
	Fisker sold “senior convertible notes due 2025” to a single investor, who is not identified. These notes have a face value of $340 million, but the investor got them at a discount, paying Fisker $300 million.	The investor can convert the notes to stock, any time it wants, at a price of $7.80 per share, a 30% premium to the $6 stock price just before the notes offering.	Also, though, “the Notes amortize in nine equal [quarterly] installments starting on July 11, 2023” (that is, the day after they were issued). Each quarter, $37,777,777 worth of notes come due, and Fisker can elect to pay them off (1) in cash at 103% of face value (i.e. $38.9 million per quarter) or (2) in stock, at a special conversion price.	The special conversion price is (1) floored at about $1.16 per share,
  [7]
 (2) capped at $7.80 per share (the conversion price), and (3) otherwise 93% of the volume-weighted average price of Fisker’s stock on either the day before conversion or the five days before conversion (whichever is lower).	Starting next July, the investor can choose to buy another $226.7 million of notes on the same terms, and if it does the company can choose to sell it another $113.3 million of notes, for a maximum of $340 million more ($680 million total).

The result is that, if the stock stays roughly where it is today, each quarter Fisker delivers about $40.6 million worth of stock to the investor, which the investor can immediately sell into the market.
  [8]
 In total, Fisker gives the investor about $365.6 million worth of stock in nine quarterly installments, and the investor gives Fisker $300 million now. Fisker has the option to pay the investor back in cash instead of stock if it wants (paying back a total of $350 million in cash
  [9]
), and the investor has the option of converting all of its bonds into stock worth even more than $365 million if the stock goes above $7.80 per share.
  [10]
 
...
In other words, this is kind of an at-the-market stock offering, except that Fisker gets the money upfront,
  [11]
...
I hate to be like “I agree with the thing that 80% of people agree with,” because that isn’t very interesting, is it, but I think I agree? If you own individual stocks then:
	You might get inside information, through your government job, and trade on it;	You might make decisions, at your government job, that favor the companies whose stocks you own; and	You might be distracted from your government job by day-trading all your stocks.
...
And FTX keeps talking about  restarting its crypto exchange even as its founder, Sam Bankman-Fried, is, uh, facing his own legal challenges. And the Three Arrows Capital guys — who are not facing legal challenges,   which a lot of people find surprising — have  their own new crypto exchange. What if it all works? What if in 10 years the big respectable crypto incumbents are New FTX and New Terra, while their founders are in prison? 
That would be funny? I think a lot about a dynamic among startup founders: High-profile founders tend to make grandiose promises and claims that do not quite match reality, and then either (1) it works out and they are hailed as visionary geniuses or (2) it doesn’t and they are arrested. It would be odd if crypto found a third option, where the founders are arrested but it all ultimately works out.
Of course FTX and Terra manifestly did not work out, in that they collapsed and cost their investors a lot of money. If you are an ambitious crypto person and you want to build the world’s leading crypto exchange or whatever-Terra-is, if you want to “provide real utility” and attract a lot of users and investors … wouldn’t it be better to start from zero? Instead of starting way in the hole, like Terra and FTX are?
Part of the issue is that both FTX and Terra issued tokens, and the best way to recover value for their customers is to make those tokens valuable again. If FTX restarts successfully, then its FTT tokens will be valuable again, and FTX has tons of those tokens and can use them to pay back its customers. There is some built-in base of investors who (1) were (allegedly) defrauded by the company but (2) are incentivized to root for its success. Still it feels like a weird marketing pitch.
 Elsewhere:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] By “at-the-money” I mean that the S&P 500 is at about 4,570 this morning, so I would buy an option struck at 4,570; I am looking at the 4,550 and 4,600 strikes on June 2025 call options (on Bloomberg page SPX Index CALL). Derivatives people sometimes use “at-the-money” more technically to mean the option struck at the forward price (higher than today’s price due to interest rates), but that is not the intuitive use that gets you the nice product here.
  ...
  [8] “Immediately” understates it: The rational move for the investor is to sell the stock into the market *before* each amortization date, over the one- or five-day VWAP period. You sell the stock short, trying to match the VWAP; you realize exactly $40.6 million on your sales; you exercise and get exactly enough stock to close out your short. The choice of one- or five-day VWAP gives you some flexibility to sell quickly (if the volume supports it) or slowly (if it doesn’t). These days Fisker’s stock trades about $48 million per day, so you’d want at least five days to sell your $40.6 million of stock, and it might take you a bit longer (that is, you might not plan to perfectly hedge before converting). The choice also gives you some extra optionality: If you sell over five days and the one-day VWAP is lower, you get some bonus stock.
