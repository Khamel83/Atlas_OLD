# =?utf-8?B?TW9uZXkgU3R1ZmY6IEpQTW9yZ2FuwqBTYXlzIEZyYW5rIFdhcyBGcmF1ZA==?=

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Thu, 12 Jan 2023 13:57:54 -0500 (EST)
**Source:** inputs/saved_emails/=utf-8BTW9uZXkgU3R1ZmY6IEpQTW9yZ2FuwqBTYXlzIEZyYW5rIFdhcyBGcmF1ZA===_Thu,_12_Jan_2023_13-57-54_-0500_(EST)_185a75989da10559.eml
**Processed:** 2025-08-24T19:13:06.555755
...
JPMorgan’s story is considerably more interesting. In its story, the 0.026% click rate on the test email was evidence that Javice’s email list was not what JPMorgan had hoped for. So it “initiated a comprehensive investigation into Frank and the Merger,” mostly by reading through Javice’s old emails, which are now on JPMorgan’s servers.
  [1]
 Oh boy did that turn up some good stuff!
...
This basically worked: Frank sent its list of 4,265,085 customers to JPMorgan’s third-party due diligence consultant,
  [3]
 the consultant okayed it, JPMorgan was satisfied and they signed the merger agreement. But you can see how this would be a problem for Frank in the medium term: It had a list of 4 million customers with fake email addresses, and JPMorgan was basically buying it so it could send emails to that list. If the email addresses were all fake, JPMorgan would notice immediately. So Frank allegedly went out and bought an email list:
...
Frank paid Enformion $70,000 for this. So, in essence, it paid a total of $175,000 for a list of email addresses, and then sold that list to JPMorgan for $175 million, for a perfect 99,900% return on its investment. What an arbitrage! The intuition is that a list of 4 million email addresses with whom you have a warm customer relationship is worth roughly 1,000 times as much as a list of 4 million random email addresses that you scraped up from the dregs of the internet. Javice allegedly scraped up these addresses from the dregs of the internet, dressed them up in Frank’s warm customer relationships, and sold them to JPMorgan at a 1,000x markup. Incredible stuff.
  [4]
...
Here is the first post on his Substack, “FTX Pre-Mortem Overview.” I   said yesterday that I have never seen a real balance sheet of FTX, and I still haven’t, but this post does include a balance sheet of sorts for FTX US, FTX’s more-regulated, less-leveraged US subsidiary.
  [6]
 This balance sheet represents that, when Bankman-Fried stepped down from FTX, FTX US was fully solvent. This is an important point, for a couple of reasons. For one thing, while FTX’s main exchange is in the Bahamas, FTX US is in the US, and Bankman-Fried is being prosecuted in the US. If the basic story here is “FTX US was fine, all of its US customers will get back 100 cents on the dollar, and only foreigners were harmed by this foreign company that I ran from the Bahamas,” then he has a bit of an argument that the US has no jurisdiction to prosecute him. I would not bet on that — the general sense of US prosecutors and courts is that they have jurisdiction to prosecute financial crime anywhere in the world — but it’s worth a shot.
The other reason FTX US matters is that FTX US was not a futures exchange, and FTX International was. The two possible stories of FTX are:
	Bankman-Fried argues that FTX was a leveraged financial institution, like MF Global or Lehman Brothers or the London Metals Exchange, that owed clients lots of money and was owed lots of money by clients. It   did not keep customer assets in a box, and no customer could have expected that it would: The customers were leveraged futures traders; if you buy Bitcoin futures you can’t seriously think that you own Bitcoins or that the exchange is holding onto those Bitcoins for you. And, in Bankman-Fried’s telling, FTX got into trouble in much the same way that   the LME did: The market moved, a big leveraged customer went bust and couldn’t pay FTX what it owed, so FTX had to shut down. As it happens, in FTX’s case, the big leveraged customer was Alameda Research, the affiliated trading firm that was also started (and mostly owned) by Bankman-Fried, but that by last year was being run independently by Caroline Ellison. Alameda had lots of assets, it owed FTX lots of money, and one day its assets lost most of their value and it couldn’t pay back the money it owed. When you run a futures exchange, and someone on one side of all the trades doesn’t pay, the people on the other side don’t get paid. 	Basically everyone else on earth is like “no I mean FTX just stole the customers’ money and gave it to Alameda.”
...
But the fact that FTX US also shut down customer withdrawals, and that FTX’s current management seems to think it is insolvent, is very bad for Bankman-Fried’s story. FTX US is not a futures exchange, it more or less did (or at least, was supposed to) keep its customers’ crypto safe in a box, and there is no innocent story of how it could have lost customer money. There are different ways to characterize how FTX International could have lost its customers’ money, but if the money is gone at FTX US, it was straightforwardly stolen. 
So this first Substack post “is about FTX Intenational’s (in)solvency. It’s not about FTX US,” but it starts with a claim that FTX US “is fully solvent and always has been,” because if that’s not true then the rest of it is kind of irrelevant.
Actually, though, this first Substack post mostly isn’t about FTX International’s insolvency. It’s mostly about Alameda. Those topics are, of course, related: The problem at FTX, in Bankman-Fried’s story and also really in the other story, is that it loaned a lot of money to Alameda and Alameda lost it. So you might ask questions like “why on earth did FTX loan Alameda all that money,” and again the two possible answers would be (1) because FTX thought it was a good idea at the time and (2) to steal it.
...
That is: At the beginning of 2022, lending money to Alameda was sensible; by the end of 2022, that money was gone. “As Alameda became illiquid, FTX International did as well, because Alameda had a margin position open on FTX; and the run on the bank turned that illiquidity into insolvency.”
Now, this is not a great defense, because at some point between $100 billion of net asset value and zero of net asset value, you might want to stop lending to Alameda. And in fact the core of the case against Bankman-Fried is pretty much that, when the value of Alameda’s investments collapsed in the summer of 2022, other lenders did stop lending to it, so FTX increased its lending to Alameda to keep it afloat. But here is Bankman-Fried’s take:
...
That is: Even in late summer and fall of 2022, FTX’s lending to Alameda was sensible, Bankman-Fried says, because Alameda had billions of dollars of value “and it was finally hedged,” so FTX’s money should have been pretty safe with Alameda.
Of course you can object to that too. For one thing, that $10 billion of value includes “SRM and tokens like it,” that is, tokens (FTT, SRM, MAPS)   that were created by FTX/Alameda, that were owned almost entirely by Alameda, and that represented essentially bets on the continuing success of FTX. For FTX to lend Alameda real money against those tokens is a   terrible wrong-way risk and at least suggestive of fraud. Bankman-Fried says that Alameda “was positive even if you excluded” those tokens. “Positive” is not great, but it’s something.
Also, though, the hedges. Alameda owned a collection of “altcoins, crypto companies, public equities, and venture investments,” which seems to have included a lot of FTT, SRM, MAPS, and SOL, the token of the Solana blockchain. And to hedge the market risk that that stuff would lose value, it shorted “some combination of BTC, ETH, and QQQ,” that is, an exchange-traded fund of Nasdaq stocks. If the market — Solana and FTT and Bitcoin and the Nasdaq — went up, Alameda would make money on its positions but lose money on its hedges. If the market — all that stuff — went down, Alameda would lose money on its positions but be cushioned by its hedges.
If Solana and FTT went down a ton, but Bitcoin and the Nasdaq did not, Alameda would get vaporized and the hedges wouldn’t help. The hedges were only as good as their correlation to Alameda’s assets. I suppose there was a time when Solana and FTT and Bitcoin and the Nasdaq were all more or less correlated to each other, when every crypto altcoin was sort of a generic bet on “people love tech and crypto is tech and everything goes up.” But in the fall of 2022, that was not how things worked. The Nasdaq is, like, Microsoft, and Apple. In the fall of 2022, it was very very very easy to have a thesis like “well Microsoft and Apple are fine but Solana is toast.” The Nasdaq is up about 4% since the end of September. Solana is down about 50%. FTT is down almost 95%. 
Here’s Bankman-Fried’s take on that:
...
That is, Changpeng Zhao, the head of rival exchange Binance, tweeted mean stuff about FTX’s FTT token, which collapsed the value of that token. There was “a targeted attack on assets held by Alameda,” in which its stuff collapsed — due to an “attack” — while Bitcoin and the Nasdaq held up fine. 
At some level this is crazy. FTX loaned billions of dollars of money — of real money, of customer money — to Alameda against a pile of assets with billions of dollar of nominal value, but those assets were mostly altcoins, mostly incredibly risky bets on the future of crypto. They could all go to zero in the blink of an eye, and some of them did. FTX loaned billions of dollars to Alameda against assets that could, and did, evaporate because CZ tweeted mean things about them. Oh but Alameda was hedged! It hedged by shorting Apple. It could only go bankrupt if its assets lost their value — because of a mean tweet — but Apple did not. What were the chances of that? Incredibly high! Come on.
Still I guess it is sort of a defense? The defense is: “Alameda had assets, those assets had market values, I thought those values were real, I thought they were hedged, and the market moved against them. Sure you might think that Alameda’s assets were worthless magic beans, and that’s how it turned out, but at the time I was a naive believer, so I thought it was fine to lend money against them.” This is not a great story,
  [8]
...
But in fact the tax treatment is basically sensible: The tax code lets you  deduct the premium that you paid from your taxes. If you pay $200 for a $100 bond, you paid $100 of premium, which you can amortize and deduct from your taxable income over the life of the bond. Oversimplifying , you deduct $10 per year for 10 years, so your taxable interest income is $15.60 minus $10 equals $5.60 per year, more or less the right amount.
  [9]
 There are some  elections to make, and I am certainly not giving you tax advice, and this is probably a bit more annoying than just getting normal interest payments. But, no, the premium bond is not dramatically more tax-inefficient than a normal bond.
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [4] This is probably boring to most people, but there is a strange interlude on pages 30 to 34 of JPMorgan’s complaint where they discuss the merger agreement in great detail. Specifically, they discuss a number of representations and covenants that Frank made in the merger agreement — things like it “has conducted its business and operated its properties in the ordinary course of business consistent with past practice” and will “use commercially reasonable efforts to maintain and preserve the … goodwill of the business” and “there has not been a … misuse or misappropriation of any Trade Secrets” — and argue that this alleged fraud breached those provisions of the merger agreement. This is kind of weird! The most natural way to describe the alleged fraud here is not that it was a *misuse of trade secrets*. The implication that you have to take from it is that the merger agreement did *not* say things like “the information Frank provided in due diligence is substantially correct” or “Frank has 4.25 million customers” or whatever. (A further implication is that the merger agreement probably had an “entire agreement” clause saying that JPMorgan did not rely on anything outside of the agreement in signing the deal.) And so JPMorgan has to assert that Javice breached the merger agreement in some weird indirect way, that inventing a customer list was a misuse of trade secrets or not in the ordinary course or whatever. Oddly it is a little reminiscent of   Elon Musk’s efforts last year to get out of his deal with Twitter Inc.: Musk claimed that Twitter was lying about how many bot accounts there were, but in fact Twitter never made any representations at all about the number of bots, so Musk had to make weird indirect claims about how the bot stuff somehow violated the merger agreement. There, too, though, he also made separate claims of *fraud*; the intuition is that even if he couldn’t get out of the merger agreement due to a breach of the contract, maybe he could because Twitter had pulled an enormous con to trick him into signing. This did not work for him, because it was just obviously untrue. Here, uh … I mean I would think JPMorgan could argue the same sort of thing? Possibly with more success?
  ...
  [8] I am sorry to   keep bringing it up, but this story is particularly undermined by the time, last April, when Bankman-Fried   described yield farming to me on the Odd Lots podcast. He said: “If everyone kind of now thinks that this box token is worth about a billion dollar market cap, that's what people are pricing it at and sort of has that market cap. Everyone's gonna mark to market. In fact, you can even finance this, right? You put X token in a borrow lending protocol and borrow dollars with it. If you think it's worth like less than two thirds of that, you could even just like put some in there, take the dollars out. Never, you know, give the dollars back.” And I said: “You're just like, well, I'm in the Ponzi business and it's pretty good.” My point here is just that he didn’t *sound* like a naive true believer in the robust long-term value of FTT or Solana or whatever, or in the wisdom of lending against it.


  [9] In fact the amortization is constant interest rate amortization rather than straight-line, meaning that you deduct less in early years and more in later years, but it adds up to the same thing (you deduct $100 over 10 years). The $5.60 per year of taxable income is an average: You pay more than that in earlier years (when you have gotten back less of your money and so really are getting 3.6% interest on $200ish of investment) and less in later years (when you have gotten back much of your money and are getting 3.6% interest on $100ish of remaining principal).
...
<a href=""><img src="https://link.mail.bloombergbusiness.com/img/607f07ceef4b8524a319a23chzzoa.5r6u/5fd2eec6.gif" alt="" border="0" /></a>
