# Money Stuff: Crypto Had Its Bank Runs Too

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Mon, 15 May 2023 14:34:53 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Crypto Had Its Bank Runs Too_Mon,_15_May_2023_14-34-53_-0400_(EDT)_18820b218b315e22.eml
**Processed:** 2025-08-24T19:13:13.523396
...
In some sense you know that crypto has made it because Gary Gorton wrote a paper about runs on crypto shadow banks. Here is “Bank Runs During Crypto Winter,” by Gorton and Jeffery Zhang:
...
“Crypto space was largely circular”: Whereas traditional banking borrows short to lend long to people who want to build houses or start businesses, crypto shadow banking borrows crypto short to lend crypto long to people who want to speculate on cryptocurrencies. In some sense you’d expect this to create less of a maturity mismatch — how long does anyone really need to borrow for to day-trade cryptocurrencies? — but on the other hand the collateral is much riskier. If you borrow to buy a house and default, the bank gets the house. If you borrow to buy some magic beans and default, the bank gets some beans.
One point that Gorton and Zhang make is that, in the US, efforts at crypto regulation are largely about either securities law or commodities regulation, but the actual problem of 2022 was banking. Securities regulation is about giving investors full information so they can make informed decisions about what companies to invest in. Bank regulation is the opposite; it assumes that bank depositors should not have to care much about what their banks are up to; bankers and regulators and supervisors worry about a bank’s asset quality and liquidity and capital ratios so that   depositors can be information-insensitive. To the extent crypto is re-creating banking, regulators should respond by re-creating bank regulation. And a cornerstone of modern bank regulation is deposit insurance. Gorton and Zhang write:
In all likelihood, applying banking law to crypto banks would require an act of Congress. Doing so would subject crypto banks to rigorous regulation but would also provide crypto banks with deposit insurance paired with enhanced supervision.
I mean! That is one approach. My impression is that most people running crypto exchanges really would not like US banking regulators to tell them where to invest their money (“not crypto”?), and also that most US regulators really would not like to guarantee the liabilities of crypto exchanges? US regulators are   not all that sure that crypto exchanges are legal. If your concern is that crypto shadow banks are becoming more interconnected with the real economy, and that therefore future runs on those shadow banks might be more destructive, there are two ways to go:
	Protect crypto shadow banks from runs, with deposit insurance and regulation; or	Protect the real economy from crypto shadow banks, by making it really hard for the traditional financial system to connect with crypto firms.
...
Meanwhile here is a Chicago Fed Letter by Radhika Patel and Jonathan Rose titled “A Retrospective on the Crypto Runs of 2022”:
...
One finding here is that the crypto shadow banks had very fast runs; crypto shadow banking sort of necessarily takes place online, “with customers withdrawing funds through apps or web portals with ease.” When there were runs on US regional banks this spring, it seems that bankers and regulators were surprised by the speed of the bank runs in an era of largely app- and web-based banking. I suppose the crypto bank runs foreshadowed that a bit.
Another finding is that, “while the platforms had many retail clients, the runs were spearheaded by customers with large holdings, some of which were sophisticated institutional customers.” This is related to the circularity of crypto that Gorton and Zhang write about: Crypto shadow banks were borrowing from and lending to each other, crypto hedge funds were borrowing from one platform to lend on another platform, and so they were particularly attuned to the risks of those platforms. In a sense crypto shadow banks were trying to provide information-insensitive deposits, but in another sense nothing in crypto is really information-insensitive: Everyone’s account on every crypto platform is a gambling account; nobody has their money at Celsius just because that’s where their employer direct deposited their paycheck and that’s where their automatic bill-pay is set up.
  [1]
 Crypto depositors are just naturally going to be more risk-aware than bank depositors, which makes crypto shadow banks more run-prone.
Another finding is that the crypto shadow banks were pretty bad banks:
Efforts to generate high returns caused these platforms to hold insufficient liquidity buffers. At FTX, Bankman-Fried stated that FTX had held enough liquidity to meet 24 times average daily withdrawals, which he stated turned out to be 80% of what was withdrawn in one day at the height of the run. Celsius used an internal stress scenario that assumed a 20% outflow of customer funds in response to 40%–50% price drops, which would appear to be a conservative scenario; however, in 2022, when Celsius’s liquidity buffer became insufficient according to that stress scenario, the company adopted a weaker scenario involving smaller price drops. BlockFi’s liquidity strategy aimed to hold 10% of customer funds in assets that can be immediately liquidated and 50% in assets that could be liquidated within seven calendar days. All of these liquidity buffers were evidently insufficient, and it is hard to verify whether they ever existed.
What conclusion do you draw about bank regulation here? Like:
	Crypto shadow banks had inadequate liquidity buffers, so they should have been regulated, because US banking regulators would have made them have higher liquidity buffers; or	Crypto shadow banks had inadequate liquidity buffers, because their business of lending against volatile collateral was incredibly risky and run-prone, and if US banking regulators had supervised these platforms they probably still would have had runs and gone bust (like several actual banks did recently!), but it would be the government’s fault?

Meanwhile at Bloomberg,  Emily Nicolle reports that many big crypto companies do not have audited financial statements or independent — or, often, any — boards of directors:
...
Oh and here is “Bitcoin Bulls Trip on a Frog as  Pepe Memecoin Frenzy Signals Market Top”:
...
Just a smart approach to a certain moment in the venture capital marketplace. On the other hand that moment is over and now here’s this:
...
Bankruptcy documents detailing the $20.4 billion claim against Alameda Research LLC reveal the IRS is claiming about $20 billion in partnership taxes. 
