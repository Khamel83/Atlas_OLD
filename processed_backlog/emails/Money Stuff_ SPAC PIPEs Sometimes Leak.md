# Money Stuff: SPAC PIPEs Sometimes Leak

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Wed, 12 Apr 2023 13:59:52 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff SPAC PIPEs Sometimes Leak_Wed,_12_Apr_2023_13-59-52_-0400_(EDT)_18776a03134bbe32.eml
**Processed:** 2025-08-24T19:13:04.211856
...
There is a standard way to address this problem.
  [1]
...
Not everyone in and around the SPAC business is entirely committed to following the letter and the spirit of the law, though, and you’d kind of expect there to be a lot of insider trading around SPAC deals, as investors get wall-crossed on the PIPEs and then put on their own bets. And late last month the US Securities and Exchange Commission and federal prosecutors brought a case:
...
Wygovsky worked at Polar Asset Management Partners, which would take wall-crosses on SPAC PIPEs and put the relevant SPACs on its restricted list, forbidding employees from trading on them. This let Wygovsky know what SPAC deals were coming, so he allegedly found out more about them and tipped Matthaei, who then allegedly traded in his personal account and paid Wygovsky back with luxury vacations:

On May 28, 2020, at 4:08 p.m., a colleague at the Asset Manager sent Wygovsky an email stating: “We are over the wall on a SPAC deal. … The SPAC is SHLL, and is contemplating a merger with Hyliion – it has a lot of similarities to the Nikola deal (VTIQ).” The colleague provided additional nonpublic details concerning Hyliion and the proposed merger and PIPE terms, noting that the parties planned to announce the merger during the week of June 15, 2020.
...
On May 29, 2020, at 7:09 a.m., based on the material nonpublic information Wygovsky provided, Matthaei began entering multiple buy orders for Tortoise common stock and warrants in his brokerage accounts with Broker 1 and Broker 2. …
On June 19, 2020, Tortoise and Hyliion announced a merger agreement, and the prices of Tortoise common stock and warrants closed up 37.4% and 181.3%, respectively, from the previous day’s closing price.
...
Bed Bath started on this plan in February, and by the end of March (1) it had sold about 311 million shares (almost three times as many as it had outstanding in January), (2) it had raised about $360 million and (3) it had driven its stock price down to $0.80. Fine, good, great work. Bad for the share price ($0.80 is less than $3), in a sense, but better than the alternative of bankruptcy ($0.80 is more than $0). We talked about this in March because Bed Bath was slightly shifting the form of this plan — it had been selling the stock in a   complicated expensive way to an investor called Hudson Bay Capital, which then sold it to Bed Bath’s retail investors, and in March it stopped that and started selling the stock to those retail investors in a more straightforward way
  [4]
 — but it was carrying on with the plan. It was hoping to raise another $300 million, and warned that, if it couldn’t, “we expect that we will likely file for bankruptcy protection, in which case holders of our common stock will likely receive no recovery at all for the securities offered by this registration statement.” 
How are things going? Well, the stock closed yesterday at $0.3138, which is lower than $0.80 and higher than zero and feels about right. The Wall Street Journal checked in with the people buying the shares: 

Kais Maalej, a 49-year-old Uber driver and amateur investor active on social media, is a proponent of the theory on Reddit forums that distressed retailer Bed Bath & Beyond Inc. will soon be acquired by a holding company associated with billionaire Ryan Cohen.
...
Ahh. Yeesh. The Journal also checks in with the people who are effectively getting Maalej’s money: Bed Bath’s creditors.
...
I guess? When Hertz Global Holdings Inc. sold stock to meme-driven retail investors while it was in bankruptcy in 2020, it very much disclosed that it was in bankruptcy,  and even said that “we expect that common stock holders would not receive a recovery through any plan” in bankruptcy. The US Securities and Exchange Commission quickly shut down the offering anyway. “Fraud in plain sight,” one lawyer called it: Hertz disclosed, in its SEC filings, that the stock was probably worthless, but its retail investors weren’t reading those filings or taking those warnings seriously, and the SEC stepped in to stop them from hurting themselves.
In the event, Hertz’s business recovered, the equity had value,  the retail investors were right and the SEC was wrong. I wrote:
...
It would be very funny if Twitter’s lawyers were responding to lawsuits against Twitter by saying “ah sorry, Twitter doesn’t exist anymore, you can’t sue us,” but of course that’s not what’s happening; they’re  saying more like “we’ve changed our name to X so now you are suing X.” One possible reading of this, which I guess Musk has encouraged, is that X is to Twitter what Alphabet is to Google, a sign that Musk’s intentions for the company go far beyond the existing social media site and extend to, uh, payments mostly:
...
Another possible reading is that Musk owns Twitter and likes the name X — he also  gave it to his son! — and can call his corporate entities whatever he wants. If you want to put a payments feature into Twitter, you can do that without changing the name, and if you want to call your company X you can do that without changing what it does.
Anyway United States Steel Corp. is a publicly traded steel company with an  illustrious history (built by J.P. Morgan and Andrew Carnegie, in the Dow from 1901 until 1991) and a $6 billion equity market capitalization. It is enough of a classic old-school industrial company that it glories in the single-letter stock-exchange ticker symbol X, but it is also small enough now that I look forward to writing about Musk doing something with X Corp. and US Steel’s stock price jumping in response. “Elon Musk’s X files to go public again,” US Steel’s stock goes up. Or: “Elon Musk’s X files for bankruptcy,” US Steel’s stock goes down. Stocks regularly trade on news about other companies with similar names or tickers, and   Elon Musk in particular can move stocks for mistaken-identity reasons. “If you are a smallish company and Elon Musk whispers your name, or a word that sounds a little bit like your name, your stock will double,” I   have written, and US Steel is smallish enough, and “X” enough, to probably qualify.
Elsewhere  in X news:
...
Bloomberg’s Yueqi Yang   reports on the legal bills that Sullivan & Cromwell LLP has put in for the FTX bankruptcy:
...
According to a fee statement in February, Sullivan & Cromwell lawyers worked on a variety of issues related to the effort. One note mentions analyzing “potential security concerns re: potential FTX exchange reboot.” Another mentions corresponding with Sygnia Inc., the cybersecurity firm that advised FTX after the platform was hit by a post-bankruptcy hack in November, on potential reboot issues.
...
Using a "clean account with a character with a little history," [Flam_Hill] and an unnamed partner applied for membership in the EHEXP corporation. After the account was accepted, [Flam_Hill] transferred enough of his shares in the corporation to the infiltrator to enable a call for a vote for a new CEO. The conspirators both voted yes, while nobody else in the corporation voted at all.
This was vital, because after 72 hours the two "yes" votes carried the day. The infiltrating agent was very suddenly made CEO, which was in turn used to make [Flam_Hill] an Event Horizon Expeditionaries director, at which point they removed all the other corporate directors and set to emptying the coffers.
They stripped 130 billion ISK from the corporate wallet, but that was only a small part of the haul: Counting all stolen assets, including multiple large ships, Flam_Hill estimated the total value of the heist at 2.23 trillion ISK.

I don’t know what “ISK” stands for, but the article goes on that it “works out to more than $22,300 in real money,” which makes this maybe the lowest-dollar-value heist I’ve ever mentioned in this column. And:
ISK can't be legally cashed out of EVE Online, but it can be used to buy Plex, an in-game currency used to upgrade accounts, purchase virtual goods, and activate other services.
Not that long ago, if you wanted to exploit the under-thought-out voting mechanics of a distributed online community that held imaginary assets, this was pretty much the best you could do: Trick people in a video game into giving you trillions of imaginary currency units worth thousands of dollars, and then spend them on account upgrades and virtual goods. Now, of course, we have crypto, and tricking people online into giving you control of their electronic assets can be  very lucrative in the real world. Not sure why you’d bother stealing ISK, unless you really want those upgrades.
