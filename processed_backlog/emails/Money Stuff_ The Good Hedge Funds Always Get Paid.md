# Money Stuff: The Good Hedge Funds Always Get Paid

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Wed, 8 Mar 2023 13:28:52 -0500 (EST)
**Source:** inputs/saved_emails/Money Stuff The Good Hedge Funds Always Get Paid_Wed,_8_Mar_2023_13-28-52_-0500_(EST)_186c27bdd6f92b33.eml
**Processed:** 2025-08-24T19:13:08.033735
...
My crude model of hedge fund management is:
  ...
  [1]
	...
	In the good times, investors will rush to put their money into your fund, and will do anything to get you to take their money. In the bad times, they’ll rush to get out, and they’ll do anything to get their money back.	You should spend the good times preparing for the bad times: In the good times, when investors say “we’ll do anything to get you to take our money,” you reply “okay sure no problem here’s a contract locking your money up for 10 years.” And then in the bad times, when investors say “we want our money back,” you reply “hahahaha nice try, remember that lockup?”

Obviously your investors will grumble, when you hand them that 10-year lockup in the good times, but if your investors aren’t grumbling in the good times then you are leaving money on the table. Similarly your investors will grumble, in the bad times, when they are stuck with that lockup, but you would much rather have them grumbling than taking their money back. “If your investors are complaining to the press about how onerous your liquidity terms are,” I once wrote, “you made the right call on the liquidity terms.”
...
Yes reliable capital is extremely good for a hedge fund! The time to make it reliable is when it wants in.
...
The bet here is basically that all that institutional structure is valuable, that it provides something that investors want.
  [2]
...
In December, the SEC  amended Rule 10b5-1 to address this concern by requiring a “cooling-off period”: If a director or officer of a company signs a 10b5-1 plan, it can’t actually trade any stock for 90 days.
  [5]
 The idea is that whether or not you know anything material now, it will probably be public or stale in three months, so you definitely won’t be insider trading when your automatic trades start in three months.
...
This is also probably not allowed: Rule 10b5-1 says that you have to have entered into your plan “in good faith and not as part of a plan or scheme to evade the prohibitions of this section,” and this scheme pretty clearly looks like bad faith. In practice it is not clear how you get caught, though: If you end up doing the trade, then it looks like you were acting in good faith (you signed a plan, and then followed it); if you end up not doing the trade, then you didn’t do any trades, so they can’t really get you for insider trading.
  [6]
 (Not legal advice!)
But last week the SEC did bring an insider trading case about alleged 10b5-1 abuse. Terren Peizer was the executive chairman of Ontrak Inc., a behavioral-health-care company whose main customers are a handful of big health insurance companies. In March 2021, Ontrak announced that its largest customer (called “Customer B” in  the SEC complaint) was terminating its contract; the stock fell 46% on the day, and “Peizer lost over $265 million in the value of his shares in a single day when Ontrak announced the loss of Customer B.”
By late March, Ontrak’s next-largest customer (called “Customer A” in the complaint) was also “not satisfied with Ontrak’s services and considering terminating its contract.” Ontrak’s chief executive officer and its president tried to salvage the relationship, and they kept Peizer — the executive chairman — up to speed:

Throughout April 2021, Peizer communicated with numerous individuals at Ontrak about the importance of saving the Customer A relationship. For example, on April 3, 2021, Peizer texted an Ontrak consultant and close confidant: “We just need to save [Customer A] and we are on our way.”
On April 14, 2021, Peizer again texted the consultant that Ontrak’s CEO “needs to still save [Customer A]!”
The next day, Peizer texted Ontrak’s CEO: “Please just save [Customer A]…then we will get back ‘Ontrak.’”

I wonder how often he used that line. Anyway:
At the same time that Peizer was communicating with others at Ontrak about saving the relationship with Customer A, he was pursuing a plan to sell shares of Ontrak securities. On May 3, 2021, Peizer contacted one of his brokerage firms (“Broker 1”) to set up a purported Rule 10b5-1 plan. Peizer explained in an email: “I have 685,929 . . . warrants that expire August 15th-30th. I want to do a plan to sells 10,000 shares a day (~68 trading days). We report our Q1 numbers Thursday after the close and our window opens up Friday after the close. My intent is to exercise the warrants, and file the plan.”
This was before the SEC amended Rule 10b5-1, so there was no SEC-required cooling-off period. Peizer could have signed the plan and started trading immediately, but his brokerage had its own 30-day cooling-off period to avoid any risk of impropriety. They offered to go down to 14 days, “but having no cooling off is not negotiable.” So he found another broker:

On May 4, 2021, Peizer texted a brokerage employee at Broker 2, “When you execute 10b5-1 plans, once the plan is filed, does [your brokerage firm] have a cooling off period?” The employee responded, “It has been our experience that the cooling off period is dictated by the company.” Peizer replied, “agreed.”
Upon determining that Broker 2 did not require a cooling off period, but would allow him to start selling stock immediately after establishing a Rule 10b5-1 plan, Peizer moved forward in setting up a purported Rule 10b5-1 plan at Broker 2. …
Specifically, the May Trading Plan instructed Broker 2 to sell 11,000 shares of Ontrak common stock per day at the volume weighted average price (“VWAP”) (or more shares per day at specified limit prices), starting on May 11, 2021—the first business day after the May Trading Plan was established. 

The timing was pretty good:

On a May 18, 2021 call, Customer A notified Ontrak’s CEO of its intention to terminate its contract effective December 31, 2021.
That same day, Ontrak’s CEO notified Peizer via text message: “Customer A is intending to end relationship at the end of the year 12-31-21….They are really firm with me. Decision has been made.”

Nonetheless, Ontrak kept trying to save the relationship, and did not announce Customer A’s termination, so the stock stayed up while Peizer’s 10b5-1 plan was selling. On Aug. 13, he did a new 10b5-1 plan:

Specifically, the August Trading Plan instructed Broker 2 to sell 11,000 shares of Ontrak common stock per day at the VWAP (or more shares per day at specified limit prices), starting the next trading day, August 16, 2021.
In an internal email between Broker 2 employees, one stated that he “always recommend[s] 30 day cooling off, but for Terren [Peizer] that won’t work.”

Meanwhile:
On August 13, 2021—the same day that Peizer set up a second Rule 10b5-1 trading plan to sell Ontrak stock, as discussed below—Peizer called the Ontrak Sales Employee and asked if Customer A was going to terminate the contract. The Ontrak Sales Employee indicated to Peizer that he thought Customer A would terminate.
The timing here was less good: On Aug. 18, Customer A sent Ontrak a formal termination, and on Aug. 19 Ontrak  announced the termination publicly. The stock traded down 44% that day, closing at $11.68. Ontrak closed yesterday at $0.56, for a market capitalization of about $15 million. Turns out losing all your biggest customers is bad. Peizer sold $19.2 million of stock under his first plan and $1.9 million under his second (in the couple of days before the termination was announced); the SEC says that was insider trading.
There are, I think, three ways to tell this story:
...
Elsewhere in Musk, he may have  fired too many people:
...
When Musk was first musing about buying Twitter last April,   I wrote that (1) there would be no real regulatory review of any deal and (2) that was kinda weird:
...
If Musk had been trying to buy, like, a bank, or a casino, some regulator would probably have asked him questions like “do you plan to fire all your compliance staff,” and if he had said “sure do,” the regulator would have blocked the deal. Social media, for all of its social and political importance, mostly isn’t an industry like that; there is no powerful social-media regulator who gets to review deals and reject unsuitable owners. But it is not unregulated, there are touch points for regulators, and if you do fire all the compliance people you will eventually get in trouble.
Still elsewhere in the Musk roundup:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] Byrne Hobart has recently written a couple of good posts about the business model of multi-manager, multi-strategy, “pod shop” hedge fund platforms.


  [3] This of course isn’t really true: The earnings release won’t generally contain everything that the executives know about the long-term future of the company, and sometimes analysts will ask questions on an earnings call that the executives will decline to answer. But it’s sort of a polite legal fiction to assume that the earnings release cleanses the executives of any MNPI.


  [4] Presumably because she is in an open window, etc.


  [5] Actually the later of 90 days or the next release of quarterly financial results. It’s 30 days for non-officers or directors. There are other requirements, including certifying that you don’t have any MNPI; the rule is on  pages 241 to 244 here.
...
<a href=""><img src="https://link.mail.bloombergbusiness.com/img/607f07ceef4b8524a319a23cibjyo.5mh3/516f2752.gif" alt="" border="0" /></a>
