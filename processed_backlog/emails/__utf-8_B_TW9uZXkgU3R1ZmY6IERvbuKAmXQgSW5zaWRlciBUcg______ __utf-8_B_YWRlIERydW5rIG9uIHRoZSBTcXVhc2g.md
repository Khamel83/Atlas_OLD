# =?utf-8?B?TW9uZXkgU3R1ZmY6IERvbuKAmXQgSW5zaWRlciBUcg==?=
 =?utf-8?B?YWRlIERydW5rIG9uIHRoZSBTcXVhc2ggQ291cnQ=?=

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Fri, 16 Jun 2023 12:48:52 -0400 (EDT)
**Source:** inputs/saved_emails/=utf-8BTW9uZXkgU3R1ZmY6IERvbuKAmXQgSW5zaWRlciBUcg===
 =utf-8BYWRlIERydW5rIG9uIHRoZSBTcXVhc2ggQ291cnQ==_Fri,_16_Jun_2023_12-48-52_-0400_(EDT)_188c51c2d326eb5a.eml
**Processed:** 2025-08-24T19:13:04.330049
...
The next theme might be robots trying to trick robots? Generative artificial intelligence “will pile pressure on the labor force, especially for higher-wage knowledge workers whose activities ‘were previously considered to be relatively immune from automation,’”   says a McKinsey report; it would be funny if McKinsey had a large language model write the report.
  [1]
 Surely one type of knowledge work that would be particularly susceptible to AI automation would be the business of tricking robots? The robots, after all, know how to think like robots.
  [2]

And so at the market-microstructure level, it is easy to imagine letting an artificial intelligence model loose on the stock market and telling it “learn how to trade profitably,” and the model coming back and saying “it seems like the stock market is dominated by simple market-making algorithms that respond to order-book information, and actually the way to trade profitably is to do a lot of spoofing and market manipulation to trick them.” (This is more or less a plot point in Andrew Lipstein’s upcoming hedge-fund novel The Vegan.)
And at the level of writing fake press releases, generative AI is probably better at writing fake press releases (and illustrating them with convincing fake photos) than, you know, the average market manipulator is. The  Financial Times reports:
...
I do think this would be strange? Much of the activity by developers and investors and venture capitalists in crypto in recent years has been about, in some way, improving on the ideas of Bitcoin (and Ethereum); it would be kind of weird for the base layer of crypto to be legal and mainstream and for everything built on top of it to be illegal. Also my general sense of crypto ethos is that Bitcoin has traditionally been pretty correlated with, like, “anarchist online drug market,” while more recent crypto projects have been more like “venture capitalists, tech founders and financial companies building new financial technology businesses”; it’s weird that the former would go mainstream and the latter would be banned.
And yet it makes a certain sense: Bitcoin is not a fundraising tool for building a new tech platform, so it’s not a security under US law, so the US Securities and Exchange Commission can’t crack down on it. Everything else is in some loose sense “quasi-stock in a quasi-company building a tech business,” so selling or trading it risks violating US securities laws.
...
I have no idea if the SEC will approve this, given that it didn’t approve the other 32, but on the other hand BlackRock is pretty smart and well-connected, and why would they try it if they didn’t think it would work? There are already US Bitcoin ETFs, but  they use Bitcoin futures and so are kind of strange; there are other exchange-traded securities that sort of track Bitcoin (Grayscale, MicroStrategy) but they are not particularly close substitutes. This is different: It would just be a pot of Bitcoins, managed by BlackRock, that you could buy into on the stock exchange. It is hard to get more institutional and mainstream and respectable these days than BlackRock’s iShares brand.
Also it is fun that Coinbase is the custodian: If you are a US institutional investor looking for a respectable, trustworthy, upstanding Bitcoin company, Coinbase is probably at the top of the list; it is an established US public company that has audited financial statements and bothers to think about compliance. It is also in an existential legal struggle with the SEC, which accuses it of operating an unregulated securities exchange for all the other crypto assets it lists. Bitcoin: respectable; other crypto: apparently not.
Anyway here is BlackRock’s registration statement for this product. There are some delightful risk factors about the state of crypto in 2023; here are two fun ones:
...
A funny business model for a crypto exchange
  [3]
 would be:
	Open a crypto exchange that has, and develops a reputation for having, rather lax know-your-customer and anti-money-laundering controls.	Attract a clientele that is heavily weighted toward customers who could not pass KYC checks at other, more conservative crypto exchanges.	Steal all the money.	File for bankruptcy.	Announce “hey good news, we found a bidder who will pay back every customer at 100 cents on the dollar.” (The bidder is you, in a fake mustache, using the money you stole.)	Say to customers “okay great, so, all we need is for you to fill out these forms and pass standard KYC checks, and we’ll send the money right over.”	Have an extremely strict KYC process for paying back the customers.	Keep whatever you don’t give back.

There are various problems here. (For one thing, Steps 1 and 2 could get you in very bad trouble with the authorities even before you get to Step 3. For another thing, this plan entails stealing from people who can’t pass KYC checks, and some people can’t pass KYC checks because they are very bad people indeed, and do you really want to steal from them?) Also I do not think that FTX Trading Ltd. followed this plan, because (1) it wasn’t known for being particularly lax about KYC and (2) it’s not like anyone is going around saying that FTX is going to pay anyone back at 100 cents on the dollar or anything like that.
...
No, you need a systemic fix. Here are some free business ideas:
	...
	An online payments platform that has a memo field, and after you type the memo there is a pop-up that is like “are you confessing to, or making jokes about, a crime in this field? Don’t do that,” and gives you a chance to reconsider.	An online payments platform that has a memo field, so you can type your little jokes about your crimes, but it doesn’t actually record or store or transmit the memo field; the memo field lets you blow off steam without creating evidence.
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] This is not really right: The robots don’t know how to think like anything at all, and there is an argument that, like, humans have a better theory-of-mind for robots than robots do. Still there is some reason to think that robots might be better at spotting robots’ robotic blind spots than humans are. (Here is a good story about how a human go player  beat the best go AI by exploiting its blind spots — but with the help of another computer.)
