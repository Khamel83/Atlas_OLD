# Money Stuff: Branches Make Bank Runs Harder

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Mon, 17 Jul 2023 12:23:55 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Branches Make Bank Runs Harder_Mon,_17_Jul_2023_12-23-55_-0400_(EDT)_18964aa7b9e9a3ea.eml
**Processed:** 2025-08-24T19:13:08.223748
...
Fine. But my contention is that these sales did not consist of (1) XRP plus (2) some set of contracts promising that Ripple would use the money to increase the value of XRP. They consisted only of XRP.
  [2]
 Institutions did not enter into a contract — like the contract in Howey — in which Ripple promised to manage a grove of XRP for them and give them the proceeds of their success. They just bought XRP. The XRP, and the way in which Ripple advertised it, was itself a bet on Ripple’s entrepreneurial efforts.
...
And my third contention is that they bought them for the same reasons. Sure sure sure: Some retail investors who bought XRP on the exchange from Ripple did not actually see Ripple’s advertisements, its website, its white paper, its Reddit posts, its YouTube videos, or the other public statements in which Ripple said that it would work to increase the value of XRP, the public statements that Judge Torres thought made XRP a security with respect to the institutional investors. But it would be very strange indeed if nobody did, if everybody bought XRP solely because they liked alphanumeric sequences. Surely Ripple’s widespread advertising of XRP as an investment in its business is what caused people generally to want to buy XRP; it’s what created the market for XRP.
And so if you bought XRP without ever seeing any of those advertisements, just because you logged onto a crypto exchange and saw the price of XRP going up and thought “okay I’ll buy that,” I would argue that you were buying a security just like those institutional investors. Meta Platforms Inc. stock does not become any less stock because you don’t buy it directly from Meta, or because you have not read Meta’s securities filings. The statements that a company makes to a buyer of its securities create the market for those securities, and if you are buying the securities in the aftermarket it is ultimately because of those statements.
...
The implications of this decision are very strange. Here is one:
	A company can create a crypto token, declare that there are 100 billion tokens, and issue all of them to itself. No mining, no decentralization, just 100% owned by one company.	The token can have no use: It can’t be used to run smart contracts or pay for services on a network or even to make international payments; it can only be traded on exchanges for dollars.	The company can go around advertising, publicly, in every venue, to every retail and institutional investor, that the token will be incredibly valuable due to the company’s efforts to create an ecosystem and build its network.	The company can even explicitly say that it will share the profits of its business with token holders, by using profits to do buybacks.	Then it can sell the token to public investors on crypto exchanges to raise money to build the business.	This is not a security, because no one can prove that the anonymous buyers on the exchange saw the advertisements, and so not subject to securities laws.

I am not saying that this is actually what Ripple did, though it is close. (Ripple does not do No. 4, and arguably No. 2 isn’t quite true of XRP.) I am saying: Look at that list and tell me that the token is not a speculative investment in a business, tell me that it is not, in the Supreme Court’s words in Howey, one of “the countless and variable schemes devised by those who seek the use of the money of others on the promise of profits.” Tell me that this is not what the securities laws were meant to regulate.
Now, I should say, a reasonable answer to all of this might be “sure, there should be a disclosure and regulatory regime for crypto offerings that is roughly parallel to the one for securities, but that addresses the unique features of crypto.” And I   agree with the crypto industry that the SEC’s approach to crypto is not so much about crafting appropriate disclosure rules as it is about shutting down crypto.   I have suggested that, after last year’s crypto winter and the collapse of FTX Trading Ltd., the SEC’s crackdown is politically well-timed: It is hard for politicians to tell the SEC “no, you can’t hold back the innovations of crypto” when so many crypto projects have collapsed and left investors with huge losses. 
But this Ripple decision changes that calculation a bit: A legislative approach that involves (1) regulating crypto, by writing clear new rules that are adapted to the realities of the crypto market, but (2) not shutting it down by leaving it in the hands of a hostile SEC, might make more sense now that the SEC’s hands are a bit tied.  Politico reports today:
...
It is a standard story: You start a small fund, you put up some good performance, everyone buys the fund after the good performance, you put up some bad performance, and even though your overall returns look good almost all of your investors have lost money.
Elsewhere:
...
That is from Bloomberg’s Katia Porzecanski, who solved this mystery on Friday. Disclosure, I used to write for Dealbreaker, though not in 2008, and it warms my heart that, in the depths of the financial crisis, their first thought was “let’s get into Dealbreaker.” The traditional way to do that was with a  vending-machine challenge, but this approach is both healthier and more permanent.
  [3]
 Also what a great use of the “stack of eighteen $2 bills that he’d been gifted for his bar mitzvah.” Also there is this follow-up:
...
BridgeBio said it would share data on a critical Phase III trial on Monday morning, in what’s expected to be a make-or-break moment for the biotech.
A few hours before the company announced the news, BridgeBio’s CEO Neil Kumar made a mysterious post on LinkedIn, sharing part of a translation of Homer’s Odyssey in which Odysseus, lost at sea for days and afraid he will die, finally reaches land. In the portion shared by Kumar, Odysseus swims and finally finds a peaceful river, then pulls himself ashore.
“I now come to your stream, here at your knees, after enduring so many struggles. Have pity on me, Lord. I declare myself your suppliant,” the passage reads in part. …
Kumar said that he had not seen the trial results when he made the post, and only saw it much later in the day Friday. …
“It has nothing to do with whether it’s positive or negative results,” Kumar told Endpoints. “It has everything to do with the concept of wandering, and the pain and the suffering that’s required to go on one of these epic journeys.”

The stock was up 5.3% on Friday. Here is the  announcement of the investor call from Friday morning. Here is  today’s announcement of the results. “BridgeBio announces consistently positive results from phase 3 attribute-cm study of acoramidis for patients with transthyretin amyloid cardiomyopathy (attr-cm),” says the headline. Imagine if it didn’t! Imagine if it was like “BridgeBio announces completely negative results and is filing for bankruptcy”! That passage of the Odyssey would look real weird, wouldn’t it?
Well, I do think this would be a fun strategy:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] There were “sales contracts,” some of which contained resale restrictions, but these governed the terms of the purchase — delivery, lockup, etc. — not Ripple’s obligations to grow the value of XRP or whatever. Companies often issue stock in private placements where the buyer signs an investment agreement covering delivery, lockups, etc., but everyone understands that the security is the *stock*, not the investment agreement. Similarly in modern crypto there is a norm of a “simple agreement for future tokens,” where a company issues a SAFT to institutional buyers to raise money to build a network, and then delivers the tokens later once the network is operational and the tokens are utility tokens (and, thus, not securities). Or that’s the argument. But there are apparently no SAFTs here, just tokens for immediate delivery.
