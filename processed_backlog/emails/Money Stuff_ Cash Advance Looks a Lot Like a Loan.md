# Money Stuff: Cash Advance Looks a Lot Like a Loan

**From:** Matt Levine <noreply@mail.bloombergview.com>
**Date:** Mon, 11 Mar 2024 13:45:58 -0400 (EDT)
**Source:** inputs/saved_emails/Money Stuff Cash Advance Looks a Lot Like a Loan_Mon,_11_Mar_2024_13-45-58_-0400_(EDT)_18e2e9f1fd24dc97.eml
**Processed:** 2025-08-24T19:13:04.526936
...
New York usury law makes it illegal to charge very high interest rates on loans. If you charge more than 16% on a loan in New York, the borrower might not have to pay you back; if you charge more than 25%, you might be committing a crime.
  [1]
 Some people want to charge higher rates on loans, and so they want to structure loans that don’t look like loans to avoid usury rules.
...
Lots of quite normal high-finance lending works this way — “structuring a loan as a sale” roughly characterizes things like the repo market, asset-backed securities or receivables factoring — but, also, lots of shady usurious low-finance lending works this way.
  [2]
 Or doesn’t work. We talked a few years ago about a usury enforcement action against a company that bought legal settlements (from 9/11 first responders and football concussion victims); the company argued that it wasn’t making loans, but the regulators disagreed.
...
 The shape of the problem is:
	You think that tomorrow will look roughly the same as today.	You make a bet of the form “tomorrow will be roughly the same as today.”	If tomorrow is roughly the same as today, you make a small amount of money.	If tomorrow is very different from today, you lose a ton of money.
...
But there is another possible answer, which is “gambling.” Some people sell options, betting that volatility will stay low, and the buyers of those options are gamblers hoping for a big lottery-like payout on a small investment.
  [7]
 In some sense, casinos and actual lottery operators are in the business of selling volatility, and those are good businesses.
...
That is the headline of this Wall Street Journal article, and I assumed that the entire body of the article would be “you can charge 25 basis points on $13 billion of passively managed assets,” but I guess that would be boring. That is the answer, though? BlackRock is a gigantic asset manager that caters to every reasonable investing taste. It spends a lot of time talking about the importance of environmental sustainability, but if you want to buy coal stocks, BlackRock is happy to help with that, which is why it is one of the world’s largest owners of coal stocks. Similarly, if you want to buy Bitcoin, Bitcoin is now mainstream and respectable enough that BlackRock probably won’t get in trouble for helping with that, so, sure, why shouldn’t it collect $27 million a year for holding Bitcoins for you?
  [8]
 Customers want it, they will pay for it, BlackRock runs a business, this is straightforward stuff:
...
If you'd like to get Money Stuff in handy email form, right in your inbox, please subscribe at this link. Or you can subscribe to Money Stuff and other great Bloomberg newsletters here. Thanks!
  ...
  [2] Here’s Patrick McKenzie on “the business of check cashing,” which at the low end is a mix of credit extension and just buying the check at a discount with no recourse to the payee: “The check casher assumes that, as a first approximation, if a check bounces, they are going to lose money. Any other result is a windfall.”


  [3] If the customer’s sales fall by more than 80% you don’t get your $60,000, but if the sales fall by 80% then it’s probably bankrupt anyway, so your loan would be in trouble even if you had called it a loan.


  [4] Incidentally, the normal mechanism for paying you back will involve taking back some money every day, or every week or month, rather than getting all of your money back at the end of the year. This creates a problem if you are supposedly taking 50% of revenue: It’s not really a good structure for you to get half of revenue the first month, half the second month, and then hit the cap in the third month and end the loan early. So instead what you do is you set a fixed daily/weekly/monthly repayment, something like “I have bought 50% of your revenue each month, capped at $60,000, but you’ll make estimated payments of $5,000 per month and then we can true things up later if revenue increases or decreases.” And then you never need any true-ups, because the monthly payments exactly equal the cap and are much less than the stated percentage of revenue.


  [5] Citations omitted in this and other quotations from the complaint.
  ...
  [7] The “buying insurance” answer sounds like they are buying put options, while the “gambling” answer sounds like they are buying call options, but it could go either way and, through the magic of put-call parity, you can kind of manufacture one out of the other.
