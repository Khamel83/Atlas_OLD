...
class TestAtlasSearchEngine:
    ...
    def search_engine(self, mock_config, mock_meilisearch_client):
        ...
        with patch('helpers.search_engine.Client', return_value=client), \
             patch('helpers.search_engine.MetadataManager') as mock_mm, \
             patch('helpers.search_engine.PathManager') as mock_pm:
    ...
    def test_init(self, mock_config):
        ...
        with patch('helpers.search_engine.Client') as mock_client, \
             patch('helpers.search_engine.MetadataManager') as mock_mm, \
             patch('helpers.search_engine.PathManager') as mock_pm:
    ...
    def test_init_with_defaults(self):
        ...
        with patch('helpers.search_engine.load_config') as mock_load_config, \
             patch('helpers.search_engine.Client') as mock_client, \
             patch('helpers.search_engine.MetadataManager') as mock_mm, \
             patch('helpers.search_engine.PathManager') as mock_pm:
    ...
    def test_calculate_relevance_score(self, search_engine):
        ...
        good_content = "This is a long piece of content that exceeds 500 characters. " * 10
        ...
        basic_score = search_engine._calculate_relevance_score(basic_metadata, basic_content)
