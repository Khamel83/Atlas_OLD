# Most Police Don’t Live In The Cities They Serve | FiveThirtyEight

**Source**: inputs/New Docs/html/fivethirtyeight.com_datalab_most-police-dont-live-in-the-cities-they-serve.html
**Type**: article
**Created**: 2025-08-25T02:53:55.436127

---

![](https://fivethirtyeight.com/wp-content/uploads/2014/08/507805315jr00094_national_g.jpg?w=575)



Police officers charge into a group of demonstrators to make an arrest Tuesday in Ferguson, Missouri.
...
This data comes from the U.S. Equal Employment Opportunity Commission (EEOC) and the Census Bureau, which together provide detail on the racial composition of government workers in large American cities. We were alerted to the data set by a [Washington Post analysis](http://www.washingtonpost.com/blogs/wonkblog/wp/2014/08/14/where-minority-communities-still-have-overwhelmingly-white-police/) of the racial demographics of each city’s police force. The census data [also includes detail](http://factfinder2.census.gov/faces/tableservices/jsf/pages/productview.xhtml?pid=EEO_10_5YR_EEOALL1W&prodType=table) on how many police officers live in the cities where they serve.
...
Cities may also vary in their residency requirements — for example, Los Angeles doesn’t require police to live in the city; Philadelphia used to [require that its officers live within the city boundaries](http://www.seattlemet.com/news-and-profiles/publicola/articles/do-other-police-departments-require-officers-to-live-in-city). Furthermore, such regulations are enforced to varying degrees. Whereas Boston ostensibly has a residency requirement for police, for example, it’s [routinely flouted](http://www.bostonglobe.com/metro/2014/07/05/boston-residency-rule-for-city-workers-frequently-ignored-and-weakly-enforced/jBqf3ST8Pqkpsr5IDjSCZL/story.html) — and the Census Bureau data suggests that about half of Boston’s police officers live outside the city.
...
![silver-police-force-race](https://fivethirtyeight.com/wp-content/uploads/2014/08/silver-police-force-race1.png)

The city of St. Louis, near Ferguson, has a [residency requirement with an out clause](https://www.stlbeacon.org/#!/content/28043/mosup_firefighters_residency_111312). There, police are allowed to move outside the city after seven years on the force. White police officers have been more likely to take advantage of the provision; 46 percent of them live outside St. Louis, whereas 32 percent of its black ones do.
...
Further details on these 75 cities are included in the searchable table below (asterisks mean there were fewer than 100 officers in the category) and can be [found on GitHub](https://github.com/fivethirtyeight/data/tree/master/police-locals).
