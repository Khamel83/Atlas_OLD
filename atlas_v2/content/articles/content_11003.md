...
Of the 201,000 protein structures in the PDB, 72% come from x-ray synchrotrons. Of those, 30,466 come from the APS—51% of the yield from U.S. synchrotrons. Data from the APS helped win two Nobel Prizes in Chemistry—in 2009, for studies of the [function and structure of the ribosome](https://www.science.org/content/article/2009-chemistry-nobel-honors-work-ribosomes), the cell’s proteinmaking machinery; and in 2012, for studies of [cell membrane proteins called G protein-coupled receptors](https://www.science.org/content/article/receptor-scientists-nab-chemistry-nobel). The APS helped determine [the structure of the SARS-CoV-2 virus](https://www.anl.gov/article/using-the-advanced-photon-source-researchers-advance-battle-against-covid19), which causes COVID-19, and [develop Paxlovid](https://www.anl.gov/article/advanced-photon-source-helps-pfizer-create-covid19-antiviral-treatment), a drug used to treat it.
...
![](https://www.science.org/do/10.1126/science.adi5755/files/_20230503_on_argonne_national_laboratory_groundbreaking.jpg)

Yanglai Cho (right) helps break ground for construction of the Advanced Photon Source in June 1990.Argonne National Laboratory
...
![](https://www.science.org/do/10.1126/science.adi5755/files/_20230503_on_argonne_national_laboratory_original_magnets.jpg)

The original accelerator in the Advanced Photon Source (above) ran from 1995 until last month.Argonne National Laboratory
...
That subtle shrinking depends on a key difference between the two machines, Kerby says. In the old APS, the beam always bent inward, to the right. In the new design, it will occasionally bend outward, to the left. These kinks give rise to new dynamics that shrink the beam—an approach pioneered at the MAX IV facility in Sweden and deployed in [a rebuild of the ESRF](https://www.science.org/content/article/rebirth-leading-european-facility-promises-revolutionary-advances-x-ray-science) completed in 2020.
...
But my father himself was thinking of new machines even before the APS turned on. In the late 1990s, Oak Ridge National Laboratory began building the Spallation Neutron Source (SNS), which slams a proton beam into a mercury target to generate neutrons for studying materials. The project struggled and DOE nearly canceled it, says Thom Mason, director of Los Alamos National Laboratory, who was SNS project director from 2001 to 2008. Moncton, White, my father, and others [went to Oak Ridge to help](https://www.science.org/doi/10.1126/science.283.5407.1425a).

![](https://www.science.org/do/10.1126/science.adi5755/files/_20230503_on_argonne_national_laboratory_new_magnets.jpg)

Technicians prepare a section of the new accelerator, which builders plan to complete within 1 year.Argonne National Laboratory
