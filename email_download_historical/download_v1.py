...
LABEL_NAME = os.environ.get("GMAIL_LABEL", "YourLabelName")  # Replace with your Gmail label
SAVE_FOLDER = os.environ.get("SAVE_FOLDER", "/path/to/save/folder")  # e.g., ~/Documents/Emails
