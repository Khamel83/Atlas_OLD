...
try:
    ...
    print(f"Failed to import required modules: {e}. Please ensure you have installed the required packages. You can install them by running: pip install google-api-python-client google-auth-httplib2 google-auth-oauthlib beautifulsoup4")
    exit()

# Configuration
SCOPES = ['https://www.googleapis.com/auth/gmail.readonly']
LABEL_NAME = "Newsletter"
SAVE_FOLDER = os.environ.get("SAVE_FOLDER", "/Users/macmini/Library/Mobile Documents/com~apple~CloudDocs/Code/email downloads/saved_emails")
    ...
    while True:
        ...
        for msg in messages:
            ...
            try:
                ...
                date = email_msg.get("Date", "NoDate").replace(" ", "_").replace(":", "-")
                ...
                if "access_denied" in str(e):
                    logging.error("Access blocked: Gmail downloads has not completed the Google verification process. Please add zoheri@gmail.com as a test user in the Google Cloud Console.")
                else:
