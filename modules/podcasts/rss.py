...
class RSSParser:
    ...
    def _parse_entry(self, entry, base_url: str) -> Optional[RSSEpisode]:
        ...
        try:
            ...
            transcript_links = self._extract_transcript_links(entry, description, base_url)
    ...
    def _extract_transcript_links(self, entry, description: str, base_url: str) -> List[str]:
        """Extract potential transcript links from RSS entry"""
        transcript_links = []
        
        # Common transcript link patterns
        transcript_keywords = [
            'transcript', 'transcription', 'full text', 'show notes',
            'read the transcript', 'episode transcript'
        ]
