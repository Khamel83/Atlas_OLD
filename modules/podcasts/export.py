...
class TranscriptExporter:
    ...
    def export_transcript(self, podcast: Podcast, episode: Episode, 
                         transcript_content: str, source_url: str = "",
    ...
    def _create_markdown(self, podcast: Podcast, episode: Episode, 
                        transcript_content: str, source_url: str,
    ...
    def _create_episode_metadata(self, podcast: Podcast, episode: Episode,
                                source_url: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _update_episodes_jsonl(self, podcast_dir: Path, episode: Episode, transcript_path: str):
